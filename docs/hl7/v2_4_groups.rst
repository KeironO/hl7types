...
.. list-table::
   ...
   * - ``CONTAINER_2``
     ...
     - optional
     - 
     - CONTAINER_2: Optional, repeating
   * - ``TCD``
     - 
     - Optional[:ref:`TCD <hl7-v2_4-TCD>`]
     - optional
...
.. list-table::
   ...
   * - ``GENERAL_ORDER``
     ...
     - required
     - 
     - GENERAL_ORDER: Required, repeating
...
.. py:class:: hl7types.hl7.v2_4.groups.RSP_Z82_PATIENT_VISIT.RSP_Z82_PATIENT_VISIT
   ...
   HL7 v2 RSP_Z82.PATIENT_VISIT group.

RSP_Z82_PATIENT_VISIT
~~~~~~~~~~~~~~~~~~~~~
