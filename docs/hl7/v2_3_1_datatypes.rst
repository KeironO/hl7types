...
.. list-table::
   ...
   * - ``cd_1``
     - CD.1
     - Optional[:ref:`WVI <hl7-v2_3_1-WVI>`]
     - optional
     - channel identifier
   * - ``cd_2``
     - CD.2
     - Optional[:ref:`WVS <hl7-v2_3_1-WVS>`]
     - optional
     - electrode names
   * - ``cd_3``
     - CD.3
     - Optional[:ref:`CSU <hl7-v2_3_1-CSU>`]
     - optional
     - channel sensitivity/units
   * - ``cd_4``
     - CD.4
     - Optional[:ref:`CCP <hl7-v2_3_1-CCP>`]
     - optional
...
CF Coded element with formatted values (S2.8.4).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
CK Composite id with check digit (S2.8.5).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
CN Composite id number and name (S2.8.7).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
CNE Coded with no exceptions (S2.8.8).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
CQ Composite quantity with units (S2.8.10).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
CWE Coded with exceptions (S2.8.11).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
CX Extended composite id with check digit (S2.8.12).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
DLN Driver's license number (S2.8.13).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
FN Family + last name prefix (S2.8.30).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
HD Hierarchic designator (S2.8.20).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
PLN Practitioner id numbers (S8).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
PPN Performing person time stamp (S2.8.30).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
QIP Query input parameter list (S2.8.32).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
QSC Query selection criteria (S2.8.33).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
RCD Row column definition (S2.8.34).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
SCV Scheduling class value pair (S2.8.37).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. list-table::
   ...
   * - ``tq_10``
     - TQ.10
     - Optional[:ref:`OSD <hl7-v2_3_1-OSD>`]
     - optional
     - order sequencing
   * - ``tq_11``
     - TQ.11
...
VID Version identifier (S2.8.47).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
XCN Extended composite id number and name for persons (S2.8.49).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
XON Extended composite name and identification number for organizations (S2.8.50).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
XPN Extended person name (S2.8.51).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
XTN Extended telecommunication number (S2.8.52).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
