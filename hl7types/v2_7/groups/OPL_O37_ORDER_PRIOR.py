...
from .OPL_O37_TIMING2 import OPL_O37_TIMING2

_OBR = OBR
_OPL_O37_OBSERVATION_RESULT_GROUP = OPL_O37_OBSERVATION_RESULT_GROUP
_OPL_O37_TIMING2 = OPL_O37_TIMING2
_ORC = ORC
_PRT = PRT
...
class OPL_O37_ORDER_PRIOR(BaseModel):
    ...
    Attributes:
        ...
        TIMING2 (Optional[OPL_O37_TIMING2]): optional
    ...
    TIMING2: Optional[_OPL_O37_TIMING2] = Field(
        default=None,
        title="TIMING2",
        description="Optional",
    )
