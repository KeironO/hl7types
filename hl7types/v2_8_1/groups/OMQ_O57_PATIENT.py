...
_NK1 = NK1
_NTE = NTE
_OMQ_O57_INSURANCE = OMQ_O57_INSURANCE
_OMQ_O57_PATIENT_VISIT = OMQ_O57_PATIENT_VISIT
_PD1 = PD1
_PID = PID
_PRT = PRT


class OMQ_O57_PATIENT(BaseModel):
    ...
    Attributes:
        ...
        PATIENT_VISIT (Optional[OMQ_O57_PATIENT_VISIT]): optional
        INSURANCE (Optional[List[OMQ_O57_INSURANCE]]): optional
