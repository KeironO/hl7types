...
from .OPL_O37_OBSERVATION_RESULT import OPL_O37_OBSERVATION_RESULT
from .OPL_O37_TIMING import OPL_O37_TIMING

_OBR = OBR
_OPL_O37_OBSERVATION_RESULT = OPL_O37_OBSERVATION_RESULT
...
class OPL_O37_ORDER_PRIOR(BaseModel):
    ...
    Attributes:
        ...
        OBSERVATION_RESULT (List[OPL_O37_OBSERVATION_RESULT]): required
    """
