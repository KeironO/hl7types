...
class PPT_PCL_PROBLEM(HL7Model):
    ...
    PROBLEM_ROLE: Optional[List[_PPT_PCL_PROBLEM_ROLE]] = Field(
        default=None,
        title="PROBLEM_ROLE",
        description="Optional, repeating",
    )

    PROBLEM_OBSERVATION: Optional[List[_PPT_PCL_PROBLEM_OBSERVATION]] = Field(
        default=None,
