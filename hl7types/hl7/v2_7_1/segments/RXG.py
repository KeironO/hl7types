...
class RXG(HL7Model):
    ...
    rxg_11 : LA2 | None
        RXG.11 - Dispense-to Location (LA2) O S4.A.5.13

    rxg_12 : str | None
        RXG.12 - Needs Human Review (ID) O S4.A.1.16 | 0136 - Yes/no Indicator

    rxg_13 : list[CWE] | None
        RXG.13 - Pharmacy/Treatment Supplier's Special Administration Instructions (CWE) O rep S4.A.6.13 | 9999 - no table for CE
    ...
    rxg_21 : list[CWE] | None
        RXG.21 - Substance Manufacturer Name (CWE) O rep S4.A.1.17 | 0227 - Manufacturers of Vaccines (code=MVX)
