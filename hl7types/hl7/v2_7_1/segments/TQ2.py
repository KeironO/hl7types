...
class TQ2(HL7Model):
    ...
    ----------
    tq2_1 : str | None
        TQ2.1 - Set ID - TQ2 (SI) O S4.4.5.1

    tq2_2 : str | None
        TQ2.2 - Sequence/Results Flag (ID) O S4.4.5.2 | 0503 - Sequence/Results Flag

    tq2_3 : list[EI] | None
        TQ2.3 - Related Placer Number (EI) C rep S4.4.5.3

    tq2_4 : list[EI] | None
        TQ2.4 - Related Filler Number (EI) C rep S4.4.5.4

    tq2_5 : list[EI] | None
        TQ2.5 - Related Placer Group Number (EI) C rep S4.4.5.5

    tq2_6 : str | None
        TQ2.6 - Sequence Condition Code (ID) C S4.4.5.6 | 0504 - Sequence Condition Code

    tq2_7 : str | None
        TQ2.7 - Cyclic Entry/Exit Indicator (ID) C S4.4.5.7 | 0505 - Cyclic Entry/Exit Indicator

    tq2_8 : CQ | None
        TQ2.8 - Sequence Condition Time Interval (CQ) O S4.4.5.8

    tq2_9 : str | None
        TQ2.9 - Cyclic Group Maximum Number of Repeats (NM) O S4.4.5.9

    tq2_10 : str | None
        TQ2.10 - Special Service Request Relationship (ID) C S4.4.5.10 | 0506 - Service Request Relationship
    """
