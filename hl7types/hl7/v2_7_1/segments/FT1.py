...
class FT1(HL7Model):
    ...
    ft1_27 : CWE | None
        FT1.27 - Advanced Beneficiary Notice Code (CWE) O S4.4.1.20 | 0339 - Advanced Beneficiary Notice Code

    ft1_28 : CWE | None
        FT1.28 - Medically Necessary Duplicate Procedure Reason (CWE) O S4.4.3.48 | 0476 - Medically Necessary Duplicate Procedure Reason
