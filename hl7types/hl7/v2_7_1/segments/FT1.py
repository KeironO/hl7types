...
class FT1(HL7Model):
    ...
    ft1_27 : CWE | None
        FT1.27 (opt) - Advanced Beneficiary Notice Code (CWE) S4.4.1.20 | 0339 - Advanced Beneficiary Notice Code

    ft1_28 : CWE | None
        FT1.28 (opt) - Medically Necessary Duplicate Procedure Reason (CWE) S4.4.3.48 | 0476 - Medically Necessary Duplicate Procedure Reason
