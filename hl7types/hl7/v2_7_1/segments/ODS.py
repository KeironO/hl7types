...
class ODS(HL7Model):
    ...
    ----------
    ods_1 : str
        ODS.1 - Type (ID) R S4.7.1.1 | 0159 - Diet Code Specification Type

    ods_2 : list[CWE] | None
        ODS.2 - Service Period (CWE) O rep S4.7.1.2 | 9999 - no table for CE

    ods_3 : list[CWE]
        ODS.3 - Diet, Supplement, or Preference Code (CWE) R rep S4.7.1.3 | 9999 - no table for CE

    ods_4 : list[str] | None
        ODS.4 - Text Instruction (ST) O rep S4.7.1.4
    """
