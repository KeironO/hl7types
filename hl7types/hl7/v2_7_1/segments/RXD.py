...
class RXD(HL7Model):
    ...
    rxd_13 : LA2 | None
        RXD.13 - Dispense-to Location (LA2) O S4.A.5.13

    rxd_14 : str | None
        RXD.14 - Needs Human Review (ID) O S4.A.1.16 | 0136 - Yes/no Indicator

    rxd_15 : list[CWE] | None
        RXD.15 - Pharmacy/Treatment Supplier's Special Dispensing Instructions (CWE) O rep S4.A.4.21 | 9999 - no table for CE
    ...
    rxd_20 : list[CWE] | None
        RXD.20 - Substance Manufacturer Name (CWE) O rep S4.A.1.17 | 0227 - Manufacturers of Vaccines (code=MVX)
