...
class BPO(HL7Model):
    ...
    ----------
    bpo_1 : str
        BPO.1 - Set ID - BPO (SI) R S4.13.1.1

    bpo_2 : CWE
        BPO.2 - BP Universal Service Identifier (CWE) R S4.13.1.2 | 9999 - no table for CE

    bpo_3 : list[CWE] | None
        BPO.3 - BP  Processing Requirements (CWE) O rep S4.13.1.3 | 0508 - Blood Product Processing Requirements

    bpo_4 : str
        BPO.4 - BP Quantity (NM) R S4.13.1.4

    bpo_5 : str | None
        BPO.5 - BP Amount (NM) O S4.13.1.5

    bpo_6 : CWE | None
        BPO.6 - BP Units (CWE) O S4.13.1.6 | 9999 - no table for CE

    bpo_7 : str | None
        BPO.7 - BP Intended Use Date/Time (DTM) O S4.13.1.7

    bpo_8 : PL | None
        BPO.8 - BP Intended Dispense From Location (PL) O S4.13.1.8

    bpo_9 : XAD | None
        BPO.9 - BP Intended Dispense From Address (XAD) O S4.13.1.9

    bpo_10 : str | None
        BPO.10 - BP Requested Dispense Date/Time (DTM) O S4.13.1.10

    bpo_11 : PL | None
        BPO.11 - BP Requested Dispense To Location (PL) O S4.13.1.11

    bpo_12 : XAD | None
        BPO.12 - BP Requested Dispense To Address (XAD) O S4.13.1.12

    bpo_13 : list[CWE] | None
        BPO.13 - BP Indication for Use (CWE) O rep S4.13.1.13 | 0509 - Indication for Use

    bpo_14 : str | None
        BPO.14 - BP Informed Consent Indicator (ID) O S4.13.1.14 | 0136 - Yes/no Indicator
    """
