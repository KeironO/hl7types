...
class CTD(HL7Model):
    """Contact Data (S11.7.4).

    Attributes
    ----------
    ctd_1 : list[CWE]
        CTD.1 (req, rep) - Contact Role (CWE) S11.7.4.1 | 0131 - Contact Role

    ctd_2 : list[XPN] | None
        CTD.2 (opt, rep) - Contact Name (XPN) S11.7.4.2

    ctd_3 : list[XAD] | None
        CTD.3 (opt, rep) - Contact Address (XAD) S11.7.4.3

    ctd_4 : PL | None
        CTD.4 (opt) - Contact Location (PL) S11.7.4.4

    ctd_5 : list[XTN] | None
        CTD.5 (opt, rep) - Contact Communication Information (XTN) S11.7.4.5

    ctd_6 : CWE | None
        CTD.6 (opt) - Preferred Method of Contact (CWE) S11.7.3.6 | 0185 - Preferred Method of Contact

    ctd_7 : list[PLN] | None
        CTD.7 (opt, rep) - Contact Identifiers (PLN) S11.7.4.7 | 0338 - Practitioner ID Number Type
    """
