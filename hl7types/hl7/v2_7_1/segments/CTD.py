...
class CTD(HL7Model):
    ...
    ----------
    ctd_1 : list[CWE]
        CTD.1 - Contact Role (CWE) R rep S11.7.4.1 | 0131 - Contact Role

    ctd_2 : list[XPN] | None
        CTD.2 - Contact Name (XPN) O rep S11.7.4.2

    ctd_3 : list[XAD] | None
        CTD.3 - Contact Address (XAD) O rep S11.7.4.3

    ctd_4 : PL | None
        CTD.4 - Contact Location (PL) O S11.7.4.4

    ctd_5 : list[XTN] | None
        CTD.5 - Contact Communication Information (XTN) O rep S11.7.4.5

    ctd_6 : CWE | None
        CTD.6 - Preferred Method of Contact (CWE) O S11.7.3.6 | 0185 - Preferred Method of Contact

    ctd_7 : list[PLN] | None
        CTD.7 - Contact Identifiers (PLN) O rep S11.7.4.7 | 0338 - Practitioner ID Number Type
    """
