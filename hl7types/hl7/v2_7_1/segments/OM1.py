...
class OM1(HL7Model):
    ...
    om1_30 : CWE | None
        OM1.30 - Confidentiality Code (CWE) O S4.4.1.28 | 0177 - Confidentiality Code

    om1_31 : CWE | None
        OM1.31 - Observations Required to Interpret this Observation (CWE) O S8.8.8.31 | 9999 - no table for CE
