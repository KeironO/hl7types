...
class GT1(HL7Model):
    ...
    gt1_8 : str | None
        GT1.8 (opt) - Guarantor Date/Time Of Birth (DTM) S6.5.5.8

    gt1_9 : CWE | None
        GT1.9 (opt) - Guarantor Administrative Sex (CWE) S6.5.5.9 | 0001 - Administrative Sex

    gt1_10 : CWE | None
        GT1.10 (opt) - Guarantor Type (CWE) S6.5.5.10 | 0068 - Guarantor Type

    gt1_11 : CWE | None
        GT1.11 (opt) - Guarantor Relationship (CWE) S6.5.5.11 | 0063 - Relationship
    ...
    gt1_20 : CWE | None
        GT1.20 (opt) - Guarantor Employment Status (CWE) S6.5.5.20 | 0066 - Employment Status
    ...
    gt1_23 : CWE | None
        GT1.23 (opt) - Guarantor Credit Rating Code (CWE) S6.5.5.23 | 0341 - Guarantor Credit Rating Code

    gt1_24 : str | None
        GT1.24 (opt) - Guarantor Death Date And Time (DTM) S6.5.5.24

    gt1_25 : str | None
        GT1.25 (opt) - Guarantor Death Flag (ID) S6.5.5.25 | 0136 - Yes/no Indicator

    gt1_26 : CWE | None
        GT1.26 (opt) - Guarantor Charge Adjustment Code (CWE) S6.5.5.26 | 0218 - Patient Charge Adjustment
    ...
    gt1_30 : CWE | None
        GT1.30 (opt) - Guarantor Marital Status Code (CWE) S6.5.5.30 | 0002 - Marital Status

    gt1_31 : str | None
        GT1.31 (opt) - Guarantor Hire Effective Date (DT) S6.5.5.31

    gt1_32 : str | None
        GT1.32 (opt) - Employment Stop Date (DT) S6.5.5.32

    gt1_33 : CWE | None
        GT1.33 (opt) - Living Dependency (CWE) S3.4.11.1 | 0223 - Living Dependency

    gt1_34 : list[CWE] | None
        GT1.34 (opt, rep) - Ambulatory Status (CWE) S3.4.3.15 | 0009 - Ambulatory Status

    gt1_35 : list[CWE] | None
        GT1.35 (opt, rep) - Citizenship (CWE) S15.4.8.30 | 0171 - Citizenship

    gt1_36 : CWE | None
        GT1.36 (opt) - Primary Language (CWE) S2.B.8.2.15 | 0296 - Primary Language

    gt1_37 : CWE | None
        GT1.37 (opt) - Living Arrangement (CWE) S3.4.11.2 | 0220 - Living Arrangement

    gt1_38 : CWE | None
        GT1.38 (opt) - Publicity Code (CWE) S3.4.11.11 | 0215 - Publicity Code

    gt1_39 : str | None
        GT1.39 (opt) - Protection Indicator (ID) S3.4.11.12 | 0136 - Yes/no Indicator

    gt1_40 : CWE | None
        GT1.40 (opt) - Student Indicator (CWE) S3.4.11.5 | 0231 - Student Status

    gt1_41 : CWE | None
        GT1.41 (opt) - Religion (CWE) S15.4.8.40 | 0006 - Religion

    gt1_42 : list[XPN] | None
        GT1.42 (opt, rep) - Mother's Maiden Name (XPN) S2.B.8.2.6

    gt1_43 : CWE | None
        GT1.43 (opt) - Nationality (CWE) S3.4.5.27 | 0212 - Nationality

    gt1_44 : list[CWE] | None
        GT1.44 (opt, rep) - Ethnic Group (CWE) S15.4.8.28 | 0189 - Ethnic Group

    gt1_45 : list[XPN] | None
        GT1.45 (opt, rep) - Contact Person's Name (XPN) S3.4.5.30 | 0200 - Name Type

    gt1_46 : list[XTN] | None
        GT1.46 (opt, rep) - Contact Person's Telephone Number (XTN) S3.4.5.31

    gt1_47 : CWE | None
        GT1.47 (opt) - Contact Reason (CWE) S3.4.5.29 | 0222 - Contact Reason

    gt1_48 : CWE | None
        GT1.48 (opt) - Contact Relationship (CWE) S6.5.5.48 | 0063 - Relationship

    gt1_49 : str | None
        GT1.49 (opt) - Job Title (ST) S15.4.8.18

    gt1_50 : JCC | None
        GT1.50 (opt) - Job Code/Class (JCC) S15.4.8.19 | 0327 - Job Code

    gt1_51 : list[XON] | None
        GT1.51 (opt, rep) - Guarantor Employer's Organization Name (XON) S6.5.5.51

    gt1_52 : CWE | None
        GT1.52 (opt) - Handicap (CWE) S3.4.11.6 | 0295 - Handicap

    gt1_53 : CWE | None
        GT1.53 (opt) - Job Status (CWE) S3.4.5.34 | 0311 - Job Status

    gt1_54 : FC | None
        GT1.54 (opt) - Guarantor Financial Class (FC) S6.5.5.54

    gt1_55 : list[CWE] | None
        GT1.55 (opt, rep) - Guarantor Race (CWE) S6.5.5.55 | 0005 - Race

    gt1_56 : str | None
        GT1.56 (opt) - Guarantor Birth Place (ST) S6.5.5.56

    gt1_57 : CWE | None
        GT1.57 (opt) - VIP Indicator (CWE) S3.4.3.16 | 0099 - VIP Indicator
    """
