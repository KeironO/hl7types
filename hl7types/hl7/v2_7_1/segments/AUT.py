...
class AUT(HL7Model):
    ...
    ----------
    aut_1 : CWE | None
        AUT.1 (opt) - Authorizing Payor, Plan ID (CWE) S11.7.2.1 | 0072 - Insurance Plan ID

    aut_2 : CWE
        AUT.2 (req) - Authorizing Payor, Company ID (CWE) S11.7.2.2 | 0285 - Insurance Company ID Codes

    aut_3 : str | None
        AUT.3 (opt) - Authorizing Payor, Company Name (ST) S11.7.2.3

    aut_4 : str | None
        AUT.4 (opt) - Authorization Effective Date (DTM) S11.7.2.4

    aut_5 : str | None
        AUT.5 (opt) - Authorization Expiration Date (DTM) S11.7.2.5

    aut_6 : EI | None
        AUT.6 (opt) - Authorization Identifier (EI) S11.7.2.6

    aut_7 : CP | None
        AUT.7 (opt) - Reimbursement Limit (CP) S11.7.2.7

    aut_8 : CQ | None
        AUT.8 (opt) - Requested Number of Treatments (CQ) S11.7.2.8

    aut_9 : CQ | None
        AUT.9 (opt) - Authorized Number of Treatments (CQ) S11.7.2.9

    aut_10 : str | None
        AUT.10 (opt) - Process Date (DTM) S11.7.1.9

    aut_11 : list[CWE] | None
        AUT.11 (opt, rep) - Requested Discipline(s) (CWE) S11.7.2.11

    aut_12 : list[CWE] | None
        AUT.12 (opt, rep) - Authorized Discipline(s) (CWE) S11.7.2.12
    """
