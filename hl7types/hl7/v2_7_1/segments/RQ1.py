...
class RQ1(HL7Model):
    ...
    ----------
    rq1_1 : str | None
        RQ1.1 - Anticipated Price (ST) O S4.10.2.1

    rq1_2 : CWE | None
        RQ1.2 - Manufacturer Identifier (CWE) C S13.4.4.17 | 0385 - Manufacturer Identifier

    rq1_3 : str | None
        RQ1.3 - Manufacturer's Catalog (ST) C S4.10.2.3

    rq1_4 : CWE | None
        RQ1.4 - Vendor ID (CWE) C S4.10.2.4 | 9999 - no table for CE

    rq1_5 : str | None
        RQ1.5 - Vendor Catalog (ST) C S4.10.2.5

    rq1_6 : str | None
        RQ1.6 - Taxable (ID) O S4.10.2.6 | 0136 - Yes/no Indicator

    rq1_7 : str | None
        RQ1.7 - Substitute Allowed (ID) O S4.10.2.7 | 0136 - Yes/no Indicator
    """
