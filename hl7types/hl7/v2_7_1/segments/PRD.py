...
class PRD(HL7Model):
    ...
    ----------
    prd_1 : list[CWE]
        PRD.1 - Provider Role (CWE) R rep S11.7.3.1 | 0286 - Provider Role

    prd_2 : list[XPN] | None
        PRD.2 - Provider Name (XPN) O rep S11.7.3.2

    prd_3 : list[XAD] | None
        PRD.3 - Provider Address (XAD) O rep S11.7.3.3

    prd_4 : PL | None
        PRD.4 - Provider Location (PL) O S11.7.3.4

    prd_5 : list[XTN] | None
        PRD.5 - Provider Communication Information (XTN) O rep S11.7.3.5

    prd_6 : CWE | None
        PRD.6 - Preferred Method of Contact (CWE) O S11.7.3.6 | 0185 - Preferred Method of Contact

    prd_7 : list[PLN] | None
        PRD.7 - Provider Identifiers (PLN) O rep S11.7.3.7 | 0338 - Practitioner ID Number Type

    prd_8 : str | None
        PRD.8 - Effective Start Date of Provider Role (DTM) O S11.7.3.8

    prd_9 : list[str] | None
        PRD.9 - Effective End Date of Provider Role (DTM) O rep S11.7.3.9

    prd_10 : XON | None
        PRD.10 - Provider Organization Name and Identifier (XON) O S11.7.3.10

    prd_11 : list[XAD] | None
        PRD.11 - Provider Organization Address (XAD) O rep S11.7.3.11

    prd_12 : list[PL] | None
        PRD.12 - Provider Organization Location Information (PL) O rep S11.7.3.12

    prd_13 : list[XTN] | None
        PRD.13 - Provider Organization Communication Information (XTN) O rep S11.7.3.13

    prd_14 : CWE | None
        PRD.14 - Provider Organization Method of Contact (CWE) O S11.7.3.14 | 0185 - Preferred Method of Contact
    """
