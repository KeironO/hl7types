...
class UB2(HL7Model):
    ...
    ub2_10 : list[str] | None
        UB2.10 - Uniform Billing 11 (State) (ST) O rep S6.5.11.10

    ub2_11 : str | None
        UB2.11 - Uniform Billing 31 (National) (ST) O S6.5.11.11

    ub2_12 : list[str] | None
        UB2.12 - Document Control Number (ST) O rep S6.5.11.12

    ub2_13 : list[str] | None
        UB2.13 - Uniform Billing 49 (National) (ST) O rep S6.5.11.13

    ub2_14 : list[str] | None
        UB2.14 - Uniform Billing 56 (State) (ST) O rep S6.5.11.14

    ub2_15 : str | None
        UB2.15 - Uniform Billing 57 (National) (ST) O S6.5.11.15

    ub2_16 : list[str] | None
        UB2.16 - Uniform Billing 78 (State) (ST) O rep S6.5.11.16
