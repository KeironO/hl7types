...
class TQ1(HL7Model):
    """Timing/Quantity (S4.4.4).

    Attributes
    ----------
    tq1_1 : str | None
        TQ1.1 - Set ID - TQ1 (SI) O S4.4.4.1

    tq1_2 : CQ | None
        TQ1.2 - Quantity (CQ) O S4.4.4.2

    tq1_3 : list[RPT] | None
        TQ1.3 - Repeat Pattern (RPT) O rep S4.4.4.3

    tq1_4 : list[str] | None
        TQ1.4 - Explicit Time (TM) O rep S4.4.4.4

    tq1_5 : list[CQ] | None
        TQ1.5 - Relative Time and Units (CQ) O rep S4.4.4.5

    tq1_6 : CQ | None
        TQ1.6 - Service Duration (CQ) O S4.4.4.6

    tq1_7 : str | None
        TQ1.7 - Start date/time (DTM) O S4.4.4.7

    tq1_8 : str | None
        TQ1.8 - End date/time (DTM) O S4.4.4.8

    tq1_9 : list[CWE] | None
        TQ1.9 - Priority (CWE) O rep S4.4.4.9 | 0485 - Extended Priority Codes

    tq1_10 : str | None
        TQ1.10 - Condition text (TX) O S4.4.4.10

    tq1_11 : str | None
        TQ1.11 - Text instruction (TX) O S4.4.4.11

    tq1_12 : str | None
        TQ1.12 - Conjunction (ID) C S4.4.4.12 | 0472 - TQ Conjunction ID

    tq1_13 : CQ | None
        TQ1.13 - Occurrence duration (CQ) O S4.4.4.13

    tq1_14 : str | None
        TQ1.14 - Total occurrences (NM) O S4.4.4.14
    """
    ...
    tq1_12: Optional[str] = Field(
        ...
        title="Conjunction",
        description="C | Item #01638 | Table 0472 - TQ Conjunction ID | LEN:1",
    )
