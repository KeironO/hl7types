...
class OM2(HL7Model):
    ...
    om2_2 : CWE | None
        OM2.2 (opt) - Units of Measure (CWE) S8.8.9.2 | 9999 - no table for CE

    om2_3 : list[str] | None
        OM2.3 (opt, rep) - Range of Decimal Precision (NM) S8.8.9.3

    om2_4 : CWE | None
        OM2.4 (opt) - Corresponding SI Units of Measure (CWE) S8.8.9.4 | 9999 - no table for CE

    om2_5 : str | None
        OM2.5 (opt) - SI Conversion Factor (TX) S8.8.9.5

    om2_6 : list[RFR] | None
        OM2.6 (opt, rep) - Reference (Normal) Range for Ordinal and Continuous Observations (RFR) S8.8.9.6
