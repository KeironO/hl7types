...
class AUT(HL7Model):
    ...
    aut_29: Optional[str] = Field(
        ...
        title="Action Code",
        description="O | Item #03429 | Table 0206 - Segment Action Code",
    )
