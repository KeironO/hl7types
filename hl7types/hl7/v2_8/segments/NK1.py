...
class NK1(HL7Model):
    ...
    nk1_7 : CWE | None
        NK1.7 (opt) - Contact Role (CWE) S11.8.4.1 | 0131 - Contact Role
    ...
    nk1_20 : CWE | None
        NK1.20 (opt) - Primary Language (CWE) S2.B.8.3.15 | 0296 - Primary Language
    ...
    nk1_26 : list[XPN] | None
        NK1.26 (opt, rep) - Mother's Maiden Name (XPN) S2.B.8.3.6
