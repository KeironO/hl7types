...
from ..groups.MFR_M05_MF_QUERY import MFR_M05_MF_QUERY

_DSC = DSC
_ERR = ERR
_MFI = MFI
_MFR_M05_MF_QUERY = MFR_M05_MF_QUERY
_MSA = MSA
_MSH = MSH
_QAK = QAK
_QRD = QRD
...
class MFR_M05(HL7Model):
    """MFN/MFK - Patient location master file (S8.10.1).
    ...
    Attributes:
        ...
        MF_QUERY (List[MFR_M05_MF_QUERY]): required
    ...
    MF_QUERY: List[_MFR_M05_MF_QUERY] = Field(
        min_length=1,
        title="MF_QUERY",
    )
