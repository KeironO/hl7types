...
from .PPV_PCA_ORDER_CHOICE import PPV_PCA_ORDER_CHOICE
from .PPV_PCA_ORDER_OBSERVATION import PPV_PCA_ORDER_OBSERVATION

_NTE = NTE
_PPV_PCA_ORDER_CHOICE = PPV_PCA_ORDER_CHOICE
...
class PPV_PCA_ORDER_DETAIL(HL7Model):
    ...
    Attributes:
        ORDER_CHOICE (PPV_PCA_ORDER_CHOICE): required
        NTE (Optional[List[NTE]]): optional
        VAR (Optional[List[VAR]]): optional
        ORDER_OBSERVATION (Optional[List[PPV_PCA_ORDER_OBSERVATION]]): optional
    """

    ORDER_CHOICE: _PPV_PCA_ORDER_CHOICE = Field(
        title="ORDER_CHOICE",
