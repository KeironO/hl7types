...
from .PTR_PCF_OBR_SUPPGRP import PTR_PCF_OBR_SUPPGRP
from .PTR_PCF_ORDER_OBSERVATION import PTR_PCF_ORDER_OBSERVATION

_NTE = NTE
_PTR_PCF_OBR_SUPPGRP = PTR_PCF_OBR_SUPPGRP
...
class PTR_PCF_ORDER_DETAIL(HL7Model):
    ...
    Attributes:
        OBR_SUPPGRP (PTR_PCF_OBR_SUPPGRP): required
        NTE (Optional[List[NTE]]): optional
        VAR (Optional[List[VAR]]): optional
        ORDER_OBSERVATION (Optional[List[PTR_PCF_ORDER_OBSERVATION]]): optional
    """

    OBR_SUPPGRP: _PTR_PCF_OBR_SUPPGRP = Field(
        title="OBR_SUPPGRP",
