...
class PDC(HL7Model):
    ...
    pdc_2 : CE
        PDC.2 (req) - Country (CE) S7.12.5.2
    ...
    pdc_5 : CE | None
        PDC.5 (opt) - Generic Name (CE) S7.12.5.5
    ...
    pdc_9 : CE | None
        PDC.9 (opt) - Product Code (CE) S7.12.5.9
    ...
    pdc_14 : TS | None
        PDC.14 (opt) - Date First Marketed (TS) S7.12.5.14

    pdc_15 : TS | None
        PDC.15 (opt) - Date Last Marketed (TS) S7.12.5.15
    """
