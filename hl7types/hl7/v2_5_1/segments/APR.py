...
class APR(HL7Model):
    ...
    ----------
    apr_1 : list[SCV] | None
        APR.1 (opt, rep) - Time Selection Criteria (SCV) S10.6.8.1 | 0294 - Time selection criteria parameter class codes

    apr_2 : list[SCV] | None
        APR.2 (opt, rep) - Resource Selection Criteria (SCV) S10.6.8.2 | 0294 - Time selection criteria parameter class codes

    apr_3 : list[SCV] | None
        APR.3 (opt, rep) - Location Selection Criteria (SCV) S10.6.8.3 | 0294 - Time selection criteria parameter class codes

    apr_4 : str | None
        APR.4 (opt) - Slot Spacing Criteria (NM) S10.6.8.4

    apr_5 : list[SCV] | None
        APR.5 (opt, rep) - Filler Override Criteria (SCV) S10.6.8.5
    """
