...
class OBX(HL7Model):
    ...
    obx_5 : list[str] | None
        OBX.5 - Observation Value (var) C rep S7.4.2.5

    obx_6 : CE | None
        OBX.6 - Units (CE) O S7.4.2.6
    ...
    obx_12 : TS | None
        OBX.12 - Effective Date of Reference Range Values (TS) O S7.4.2.12
    ...
    obx_15 : CE | None
        OBX.15 - Producer's Reference (CE) O S7.4.2.15
    ...
    obx_20 : XON | None
        OBX.20 - Performing Organization Name (XON) NA

    obx_21 : XAD | None
        OBX.21 - Performing Organization Address (XAD) NA

    obx_22 : XCN | None
        OBX.22 - Performing Organization Medical Director (XCN) NA
    """
