...
class OBX(HL7Model):
    ...
    obx_5 : list[str] | None
        OBX.5 (opt, rep) - Observation Value (var) S7.4.2.5

    obx_6 : CE | None
        OBX.6 (opt) - Units (CE) S7.4.2.6
    ...
    obx_12 : TS | None
        OBX.12 (opt) - Effective Date of Reference Range Values (TS) S7.4.2.12
    ...
    obx_15 : CE | None
        OBX.15 (opt) - Producer's Reference (CE) S7.4.2.15
    ...
    obx_20 : XON | None
        OBX.20 (opt) - Performing Organization Name (XON)

    obx_21 : XAD | None
        OBX.21 (opt) - Performing Organization Address (XAD)

    obx_22 : XCN | None
        OBX.22 (opt) - Performing Organization Medical Director (XCN)
    """
    ...
    obx_12: Optional[TS] = Field(
        ...
        validation_alias=AliasChoices(
            "obx_12",
            "effective_date_of_reference_range_values",
            "OBX.12",
        ),
        serialization_alias="OBX.12",
        title="Effective Date of Reference Range Values",
    ...
    obx_15: Optional[CE] = Field(
        ...
        validation_alias=AliasChoices(
            "obx_15",
            "producer_s_reference",
            "OBX.15",
        ),
        serialization_alias="OBX.15",
        title="Producer's Reference",
