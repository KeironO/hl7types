...
class GT1(HL7Model):
    ...
    gt1_35 : list[CE] | None
        GT1.35 (opt, rep) - Citizenship (CE) S15.4.8.30 | 0171 - Citizenship

    gt1_36 : CE | None
        GT1.36 (opt) - Primary Language (CE) S3.4.2.15 | 0296 - Primary Language

    gt1_37 : str | None
        GT1.37 (opt) - Living Arrangement (IS) S3.4.10.2 | 0220 - Living Arrangement

    gt1_38 : CE | None
        GT1.38 (opt) - Publicity Code (CE) S3.4.10.11 | 0215 - Publicity Code
    ...
    gt1_41 : CE | None
        GT1.41 (opt) - Religion (CE) S3.4.2.17 | 0006 - Religion

    gt1_42 : list[XPN] | None
        GT1.42 (opt, rep) - Mother's Maiden Name (XPN) S3.4.2.6

    gt1_43 : CE | None
        GT1.43 (opt) - Nationality (CE) S3.4.2.28 | 0212 - Nationality

    gt1_44 : list[CE] | None
        GT1.44 (opt, rep) - Ethnic Group (CE) S15.4.8.28 | 0189 - Ethnic Group

    gt1_45 : list[XPN] | None
        GT1.45 (opt, rep) - Contact Person's Name (XPN) S3.4.5.30

    gt1_46 : list[XTN] | None
        GT1.46 (opt, rep) - Contact Person's Telephone Number (XTN) S3.4.5.31

    gt1_47 : CE | None
        GT1.47 (opt) - Contact Reason (CE) S3.4.5.29 | 0222 - Contact Reason
