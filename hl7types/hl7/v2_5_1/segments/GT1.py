...
class GT1(HL7Model):
    ...
    gt1_35 : list[CE] | None
        GT1.35 - Citizenship (CE) O rep S15.4.8.30 | 0171 - Citizenship
    ...
    gt1_38 : CE | None
        GT1.38 - Publicity Code (CE) O S3.4.10.11 | 0215 - Publicity Code
    ...
    gt1_44 : list[CE] | None
        GT1.44 - Ethnic Group (CE) O rep S15.4.8.28 | 0189 - Ethnic Group
