...
class STF(HL7Model):
    ...
    stf_6 : TS | None
        STF.6 - Date/Time of Birth (TS) O S15.4.8.6

    stf_7 : str | None
        STF.7 - Active/Inactive Flag (ID) O S15.4.8.7 | 0183 - Active/Inactive

    stf_8 : list[CE] | None
        STF.8 - Department (CE) O rep S15.4.8.8 | 0184 - Department
    ...
    stf_17 : CE | None
        STF.17 - Marital Status (CE) O S15.4.8.17 | 0002 - Marital Status
    ...
    stf_27 : CE | None
        STF.27 - Race (CE) O S15.4.8.27 | 0005 - Race

    stf_28 : CE | None
        STF.28 - Ethnic Group (CE) O S15.4.8.28 | 0189 - Ethnic Group

    stf_29 : str | None
        STF.29 - Re-activation Approval Indicator (ID) O S15.4.8.29 | 0136 - Yes/no indicator

    stf_30 : list[CE] | None
        STF.30 - Citizenship (CE) O rep S15.4.8.30 | 0171 - Citizenship
