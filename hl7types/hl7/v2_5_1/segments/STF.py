...
class STF(HL7Model):
    ...
    stf_6 : TS | None
        STF.6 (opt) - Date/Time of Birth (TS) S15.4.8.6

    stf_7 : str | None
        STF.7 (opt) - Active/Inactive Flag (ID) S15.4.8.7 | 0183 - Active/Inactive

    stf_8 : list[CE] | None
        STF.8 (opt, rep) - Department (CE) S15.4.8.8 | 0184 - Department
    ...
    stf_17 : CE | None
        STF.17 (opt) - Marital Status (CE) S15.4.8.17 | 0002 - Marital Status
    ...
    stf_27 : CE | None
        STF.27 (opt) - Race (CE) S15.4.8.27 | 0005 - Race

    stf_28 : CE | None
        STF.28 (opt) - Ethnic Group (CE) S15.4.8.28 | 0189 - Ethnic Group

    stf_29 : str | None
        STF.29 (opt) - Re-activation Approval Indicator (ID) S15.4.8.29 | 0136 - Yes/no indicator

    stf_30 : list[CE] | None
        STF.30 (opt, rep) - Citizenship (CE) S15.4.8.30 | 0171 - Citizenship
