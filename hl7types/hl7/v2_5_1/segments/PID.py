...
class PID(HL7Model):
    ...
    pid_7 : TS | None
        PID.7 - Date/Time of Birth (TS) O S15.4.8.6
    ...
    pid_10 : list[CE] | None
        PID.10 - Race (CE) O rep S15.4.8.27 | 0005 - Race
    ...
    pid_16 : CE | None
        PID.16 - Marital Status (CE) O S15.4.8.17 | 0002 - Marital Status
    ...
    pid_22 : list[CE] | None
        PID.22 - Ethnic Group (CE) O rep S15.4.8.28 | 0189 - Ethnic Group
    ...
    pid_26 : list[CE] | None
        PID.26 - Citizenship (CE) O rep S15.4.8.30 | 0171 - Citizenship
