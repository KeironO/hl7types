...
class PID(HL7Model):
    ...
    pid_7 : TS | None
        PID.7 (opt) - Date/Time of Birth (TS) S15.4.8.6
    ...
    pid_10 : list[CE] | None
        PID.10 (opt, rep) - Race (CE) S15.4.8.27 | 0005 - Race
    ...
    pid_16 : CE | None
        PID.16 (opt) - Marital Status (CE) S15.4.8.17 | 0002 - Marital Status
    ...
    pid_22 : list[CE] | None
        PID.22 (opt, rep) - Ethnic Group (CE) S15.4.8.28 | 0189 - Ethnic Group
    ...
    pid_26 : list[CE] | None
        PID.26 (opt, rep) - Citizenship (CE) S15.4.8.30 | 0171 - Citizenship
