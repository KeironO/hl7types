...
class NTE(HL7Model):
    ...
    ----------
    nte_1 : str | None
        NTE.1 (opt) - Set ID - NTE (SI) S2.15.10.1

    nte_2 : str | None
        NTE.2 (opt) - Source of Comment (ID) S2.15.10.2 | 0105 - Source of comment

    nte_3 : list[str] | None
        NTE.3 (opt, rep) - Comment (FT) S2.15.10.3

    nte_4 : CE | None
        NTE.4 (opt) - Comment Type (CE) S2.15.10.4 | 0364 - Comment type
    """
