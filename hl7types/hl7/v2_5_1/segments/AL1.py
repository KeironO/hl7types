...
class AL1(HL7Model):
    ...
    al1_2 : CE | None
        AL1.2 - Allergen Type Code (CE) O S3.4.6.2 | 0127 - Allergen Type

    al1_3 : CE
        AL1.3 - Allergen Code/Mnemonic/Description (CE) R S3.4.6.3

    al1_4 : CE | None
        AL1.4 - Allergy Severity Code (CE) O S3.4.6.4 | 0128 - Allergy Severity
