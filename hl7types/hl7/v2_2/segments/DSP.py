...
class DSP(HL7Model):
    """DISPLAY DATA (S2.10.9).

    Attributes
    ----------
    dsp_1 : str | None
        DSP.1 - Set ID - Display Data (SI) NA S2.10.9.1

    dsp_2 : str | None
        DSP.2 - Display Level (SI) NA S2.10.9.2

    dsp_3 : str
        DSP.3 - Data Line (TX) R S2.10.9.3

    dsp_4 : str | None
        DSP.4 - Logical Break Point (ST) NA S2.10.9.4

    dsp_5 : str | None
        DSP.5 - Result ID (TX) NA S2.10.9.5
    """
    ...
    dsp_1: Optional[str] = Field(
        ...
        description="NA | Item #00061 | LEN:4",
    )
    ...
    dsp_2: Optional[str] = Field(
        ...
        title="Display Level",
        description="NA | Item #00062 | LEN:4",
    )
    ...
    dsp_4: Optional[str] = Field(
        ...
        description="NA | Item #00064 | LEN:2",
    )
