...
class ARQ(BaseModel):
    ...
    arq_15 : XCN | None
        ARQ.15 (opt) - Placer Contact Person (XCN)

    arq_16 : XTN | None
        ARQ.16 (opt) - Placer Contact Phone Number (XTN)

    arq_17 : XAD | None
        ARQ.17 (opt) - Placer Contact Address (XAD)

    arq_18 : PL | None
        ARQ.18 (opt) - Placer Contact Location (PL)

    arq_19 : XCN
        ARQ.19 (req) - Entered By Person (XCN)
