...
class TXA(HL7Model):
    ...
    txa_5 : XCN | None
        TXA.5 (opt) - Primary Activity Provider Code/Name (XCN)
    ...
    txa_9 : XCN | None
        TXA.9 (opt) - Originator Code/Name (XCN)

    txa_10 : list[XCN] | None
        TXA.10 (opt, rep) - Assigned Document Authenticator (XCN)

    txa_11 : XCN | None
        TXA.11 (opt) - Transcriptionist Code/Name (XCN)
    ...
    txa_17 : list[str]
        TXA.17 (req, rep) - Document Completion Status (ID)
