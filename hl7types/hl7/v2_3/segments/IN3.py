...
class IN3(HL7Model):
    ...
    ----------
    in3_1 : str
        IN3.1 (req) - Set ID - Insurance Certification (SI) S6.4.8.1
    ...
    in3_5 : str | None
        IN3.5 (opt) - Penalty (CM) S6.4.8.5 | 0148 - Penalty Type
    ...
    in3_11 : str | None
        IN3.11 (opt) - Days (CM) S6.4.8.11 | 0149 - Day Type
    ...
    in3_14 : list[XCN] | None
        IN3.14 (opt, rep) - Physician Reviewer (XCN) S6.4.8.14
    ...
    in3_17 : CE | None
        IN3.17 (opt) - Appeal Reason (CE) S6.4.8.17

    in3_18 : CE | None
        IN3.18 (opt) - Certification Agency (CE) S6.4.8.18

    in3_19 : list[XTN] | None
        IN3.19 (opt, rep) - Certification Agency Phone Number (XTN) S6.4.8.19

    in3_20 : list[str] | None
        IN3.20 (opt, rep) - Pre-Certification required/Window (CM) S6.4.8.20
    ...
    in3_25 : list[XCN] | None
        IN3.25 (opt, rep) - Second Opinion Physician (XCN) S6.4.8.25
    """
