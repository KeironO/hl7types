...
class FAC(HL7Model):
    ...
    ----------
    fac_1 : list[EI]
        FAC.1 - Facility ID (EI) R rep S7.11.6.1

    fac_2 : str | None
        FAC.2 - Facility Type (ID) O S7.11.6.2 | 0331 - Facility Type

    fac_3 : XAD
        FAC.3 - Facility Address (XAD) R S7.11.6.3

    fac_4 : XTN
        FAC.4 - Facility Telecommunication (XTN) R S7.11.6.4

    fac_5 : list[XCN] | None
        FAC.5 - Contact Person (XCN) O rep S7.11.6.5

    fac_6 : list[str] | None
        FAC.6 - Contact Title (ST) O rep S7.11.6.6

    fac_7 : list[XAD] | None
        FAC.7 - Contact Address (XAD) O rep S7.11.6.7

    fac_8 : list[XTN] | None
        FAC.8 - Contact Telecommunication (XTN) O rep S7.11.6.8

    fac_9 : XCN
        FAC.9 - Signature Authority (XCN) R S7.11.6.9

    fac_10 : str | None
        FAC.10 - Signature Authority Title (ST) O S7.11.6.10

    fac_11 : XAD | None
        FAC.11 - Signature Authority Address (XAD) O S7.11.6.11

    fac_12 : XTN | None
        FAC.12 - Signature Authority Telecommunication (XTN) O S7.11.6.12
    """
    ...
    fac_6: Optional[List[str]] = Field(
        ...
        title="Contact Title",
        description="O | Item #01267 | LEN:60",
    )
    ...
    fac_10: Optional[str] = Field(
        ...
        description="O | Item #01271 | LEN:60",
    )

    fac_11: Optional[XAD] = Field(
        default=None,
        validation_alias=AliasChoices(
            "fac_11",
