...
class OM4(HL7Model):
    """Observations that require specimens (S8.7.6).

    Attributes
    ----------
    om4_1 : str | None
        OM4.1 - Sequence Number - Test/ Observation Master File (NM) O S8.7.3

    om4_2 : str | None
        OM4.2 - Derived Specimen (ID) O S8.7.6.2 | 0170 - Derived Specimen

    om4_3 : str | None
        OM4.3 - Container Description (TX) O S8.7.6.3

    om4_4 : str | None
        OM4.4 - Container Volume (NM) O S8.7.6.4

    om4_5 : CE | None
        OM4.5 - Container Units (CE) O S8.7.6.5

    om4_6 : CE | None
        OM4.6 - Specimen (CE) O S8.7.6.6

    om4_7 : CE | None
        OM4.7 - Additive (CE) O S8.7.6.7

    om4_8 : str | None
        OM4.8 - Preparation (TX) O S8.7.6.8

    om4_9 : str | None
        OM4.9 - Special Handling Requirements (TX) O S8.7.6.9

    om4_10 : CQ | None
        OM4.10 - Normal Collection Volume (CQ) O S8.7.6.10

    om4_11 : CQ | None
        OM4.11 - Minimum Collection Volume (CQ) O S8.7.6.11

    om4_12 : str | None
        OM4.12 - Specimen Requirements (TX) O S8.7.6.12

    om4_13 : str | None
        OM4.13 - Specimen Priorities (ID) O S8.7.6.13 | 0027 - Priority

    om4_14 : CQ | None
        OM4.14 - Specimen Retention Time (CQ) O S8.7.6.14
    """
