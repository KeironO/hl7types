...
class URS(HL7Model):
    """Unsolicited selection segment (S2.24.7).
    ...
    urs_2 : TS | None
        URS.2 - R/U When Data Start Date/Time (TS) NA S2.24.7.2

    urs_3 : TS | None
        URS.3 - R/U When Data End Date/Time (TS) NA S2.24.7.3
    ...
    urs_9 : TQ | None
        URS.9 - R/U Quantity/Timing Qualifier (TQ) O S2.24.7
    """
