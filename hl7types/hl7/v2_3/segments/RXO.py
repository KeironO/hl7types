...
class RXO(HL7Model):
    ...
    rxo_7 : list[CE] | None
        RXO.7 (opt, rep) - Provider's Administration Instructions (CE) S4.8.2

    rxo_8 : str | None
        RXO.8 (opt) - Deliver To Location (CM) S4.8.2
    ...
    rxo_13 : str | None
        RXO.13 (opt) - Number of Refills (NM) S4.8.2

    rxo_14 : CN | None
        RXO.14 (opt) - Ordering Provider's DEA Number (CN) S4.8.2

    rxo_15 : CN | None
        RXO.15 (opt) - Pharmacist/Treatment Supplier's Verifier ID (CN) S4.8.2

    rxo_16 : str | None
        RXO.16 (opt) - Needs Human Review (ID) S4.8.2 | 0136 - Yes/No Indicator
    ...
    rxo_20 : CE | None
        RXO.20 (opt) - Indication (CE) S4.8.2
