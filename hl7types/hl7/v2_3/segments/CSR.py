...
class CSR(HL7Model):
    ...
    csr_2 : EI | None
        CSR.2 - Alternate Study ID (EI) O S7.7.1.2
    ...
    csr_5 : CX | None
        CSR.5 - Alternate Patient ID (CX) O S7.7.1.5

    csr_6 : TS | None
        CSR.6 - Date/Time of Patient Study Registration (TS) NA S7.7.1.6

    csr_7 : XCN | None
        CSR.7 - Person Performing Study Registration (XCN) O S7.7.1.7

    csr_8 : XCN
        CSR.8 - Study Authorizing Provider (XCN) R S7.7.1.8
    ...
    csr_12 : list[CE] | None
        CSR.12 - Study Randomized Arm (CE) O rep S7.7.1.12
