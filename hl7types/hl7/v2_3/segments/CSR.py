...
class CSR(HL7Model):
    ...
    csr_5 : CX | None
        CSR.5 (opt) - Alternate Patient ID (CX)

    csr_6 : TS | None
        CSR.6 (opt) - Date/Time of Patient Study Registration (TS)

    csr_7 : XCN | None
        CSR.7 (opt) - Person Performing Study Registration (XCN)

    csr_8 : XCN
        CSR.8 (req) - Study Authorizing Provider (XCN)
    ...
    csr_12 : list[CE] | None
        CSR.12 (opt, rep) - Study Randomized Arm (CE)
