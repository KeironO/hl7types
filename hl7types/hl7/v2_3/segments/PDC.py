...
class PDC(HL7Model):
    ...
    ----------
    pdc_1 : XON
        PDC.1 - Manufacturer/Distributor (XON) R S7.11.5.1
    ...
    pdc_11 : str | None
        PDC.11 - Marketing Approval Identifier (ST) O S7.11.5.11
    ...
    pdc_14 : TS | None
        PDC.14 - Date First Marked (TS) O S7.11.5.14

    pdc_15 : TS | None
        PDC.15 - Date Last Marked (TS) O S7.11.5.15
    """
