...
class PDC(HL7Model):
    """Product Detail Country (S7.11.5).

    Attributes
    ----------
    pdc_1 : XON
        PDC.1 (req) - Manufacturer/Distributor (XON) S7.11.5.1
    ...
    pdc_11 : str | None
        PDC.11 (opt) - Marketing Approval Identifier (ST) S7.11.5.11
    ...
    pdc_14 : TS | None
        PDC.14 (opt) - Date First Marked (TS) S7.11.5.14

    pdc_15 : TS | None
        PDC.15 (opt) - Date Last Marked (TS) S7.11.5.15
    """
    ...
    pdc_11: Optional[str] = Field(
        ...
        validation_alias=AliasChoices(
            "pdc_11",
            "marketing_approval_identifier",
            "PDC.11",
        ),
        serialization_alias="PDC.11",
        title="Marketing Approval Identifier",
