...
class OM2(HL7Model):
    ...
    ----------
    om2_1 : str | None
        OM2.1 - Sequence Number - Test/ Observation Master File (NM) O S8.7.3

    om2_2 : CE | None
        OM2.2 - Units of Measure (CE) O S8.7.4.2

    om2_3 : list[str] | None
        OM2.3 - Range of Decimal Precision (NM) O rep S8.7.4.3

    om2_4 : CE | None
        OM2.4 - Corresponding SI Units of Measure (CE) O S8.7.4.4

    om2_5 : str | None
        OM2.5 - SI Conversion Factor (TX) O S8.7.4.5

    om2_6 : str | None
        OM2.6 - Reference (Normal) Range - Ordinal & Continuous Obs (CM) O S8.7.4.6

    om2_7 : str | None
        OM2.7 - Critical Range for Ordinal & Continuous Obs (CM) O S8.7.4.7

    om2_8 : str | None
        OM2.8 - Absolute Range for Ordinal & Continuous Obs (CM) O S8.7.4.8

    om2_9 : list[str] | None
        OM2.9 - Delta Check Criteria (CM) O rep S8.7.4.9

    om2_10 : str | None
        OM2.10 - Minimum Meaningful Increments (NM) O S8.7.4.10
    """
