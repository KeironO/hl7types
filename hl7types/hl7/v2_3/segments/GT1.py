...
class GT1(HL7Model):
    ...
    ----------
    gt1_1 : str
        GT1.1 - Set ID - Guarantor (SI) R S6.4.5.1
    ...
    gt1_10 : str | None
        GT1.10 - Guarantor Type (IS) O S6.4.5.10 | 0068 - Guarantor Relationship

    gt1_11 : str | None
        GT1.11 - Guarantor Relationship (IS) O S6.4.5.11 | 0063 - Relationship
    ...
    gt1_18 : list[XTN] | None
        GT1.18 - Guarantor Employ Phone Number (XTN) O rep S6.4.5.18
    ...
    gt1_21 : list[XON] | None
        GT1.21 - Guarantor Organization (XON) O rep S6.4.5.21

    gt1_22 : str | None
        GT1.22 - Guarantor Billing Hold Flag (ID) O S6.4.5.22 | 0136 - Yes/No Indicator

    gt1_23 : CE | None
        GT1.23 - Guarantor Credit Rating Code (CE) O S6.4.5.23
    ...
    gt1_26 : CE | None
        GT1.26 - Guarantor Charge Adjustment Code (CE) O S6.4.5.26 | 0218 - Charge Adjustment
    ...
    gt1_30 : str | None
        GT1.30 - Guarantor Marital Status Code (IS) O S6.4.5.30

    gt1_31 : str | None
        GT1.31 - Guarantor Hire Effective Date (DT) O S6.4.5.31

    gt1_32 : str | None
        GT1.32 - Employment Stop Date (DT) O S6.4.5

    gt1_33 : str | None
        GT1.33 - Living Dependency (IS) O S3.3.5 | 0223 - Living Dependency

    gt1_34 : str | None
        GT1.34 - Ambulatory Status (IS) O S3.3.3 | 0009 - Ambulatory Status

    gt1_35 : str | None
        GT1.35 - Citizenship (IS) O S3.3.2 | 0171 - Country Code

    gt1_36 : CE | None
        GT1.36 - Primary Language (CE) O S3.3.2 | 0296 - Language

    gt1_37 : str | None
        GT1.37 - Living Arrangement (IS) O S3.3.5 | 0220 - Living Arrangements

    gt1_38 : CE | None
        GT1.38 - Publicity Indicator (CE) O S3.3.5 | 0215 - Publicity Code

    gt1_39 : str | None
        GT1.39 - Protection Indicator (ID) O S3.3.5 | 0136 - Yes/No Indicator

    gt1_40 : str | None
        GT1.40 - Student Indicator (IS) O S3.3.5 | 0231 - Student Status

    gt1_41 : str | None
        GT1.41 - Religion (IS) O S3.3.2 | 0006 - Religion

    gt1_42 : XPN | None
        GT1.42 - Mother’s Maiden Name (XPN) O S3.3.5

    gt1_43 : CE | None
        GT1.43 - Nationality Code (CE) O S3.3.2 | 0212 - Nationality

    gt1_44 : str | None
        GT1.44 - Ethnic Group (IS) O S3.3.2 | 0189 - Ethnic Group

    gt1_45 : list[XPN] | None
        GT1.45 - Contact Person's Name (XPN) O rep S3.3.5

    gt1_46 : list[XTN] | None
        GT1.46 - Contact Person’s Telephone Number (XTN) O rep S3.3.5

    gt1_47 : CE | None
        GT1.47 - Contact Reason (CE) O S3.3.5 | 0222 - Contact Reason

    gt1_48 : str | None
        GT1.48 - Contact Relationship Code (IS) O S6.4.5.48 | 0063 - Relationship

    gt1_49 : str | None
        GT1.49 - Job Title (ST) O S6.4.5

    gt1_50 : JCC | None
        GT1.50 - Job Code/Class (JCC) O S6.4.5

    gt1_51 : list[XON] | None
        GT1.51 - Guarantor Employer's Organization Name (XON) O rep S6.4.5.51

    gt1_52 : str | None
        GT1.52 - Handicap (IS) O S3.3.5 | 0295 - Handicap

    gt1_53 : str | None
        GT1.53 - Job Status (IS) O S3.3.5 | 0311 - Job Status

    gt1_54 : FC | None
        GT1.54 - Guarantor Financial Class (FC) O S6.4.5.54 | 0064 - Financial Class

    gt1_55 : str | None
        GT1.55 - Guarantor Race (IS) O S6.4.5.55 | 0005 - Race
    """
    ...
    gt1_10: Optional[str] = Field(
        ...
        description=(
            "O | Item #00414 | Table 0068 - Guarantor Relationship | LEN:2"
        ),
    )
    ...
    gt1_11: Optional[str] = Field(
        ...
        description="O | Item #00415 | Table 0063 - Relationship | LEN:2",
    )
    ...
    gt1_26: Optional[CE] = Field(
        ...
        description="O | Item #00777 | Table 0218 - Charge Adjustment",
    )
    ...
    gt1_30: Optional[str] = Field(
        ...
        description="O | Item #00781 | LEN:1",
    )
    ...
    gt1_48: Optional[str] = Field(
        ...
        title="Contact Relationship Code",
    ...
    gt1_55: Optional[str] = Field(
        ...
        description="O | Item #01291 | Table 0005 - Race | LEN:1",
    )
