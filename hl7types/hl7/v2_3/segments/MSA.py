...
class MSA(HL7Model):
    ...
    ----------
    msa_1 : str
        MSA.1 (req) - Acknowledgement code (ID) S2.24.2.1 | 0008 - Acknowledgement Code

    msa_2 : str
        MSA.2 (req) - Message Control ID (ST) S2.24.1
    ...
    msa_5 : str | None
        MSA.5 (opt) - Delayed Acknowledgement Type (ID) S2.24.2.5 | 0102 - Delayed Acknowledgement Type
