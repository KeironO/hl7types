...
class RGS(HL7Model):
    """Resource Group (S10.5.3).

    Attributes
    ----------
    rgs_1 : str
        RGS.1 - Set ID - RGS (SI) R S10.5.3.1

    rgs_2 : str | None
        RGS.2 - Segment Action Code (ID) O S8.8.3 | 0206 - Segment Action Code

    rgs_3 : CE | None
        RGS.3 - Resource Group ID (CE) O S10.5.3.3
    """
