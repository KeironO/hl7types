...
class AIS(HL7Model):
    ...
    ais_2 : str | None
        AIS.2 - Segment Action Code (ID) O S8.8.3 | 0206 - Segment Action Code

    ais_3 : CE
        AIS.3 - Universal Service Identifier (CE) R S4.5.1

    ais_4 : TS | None
        AIS.4 - Start Date/Time (TS) C S10.5.4

    ais_5 : str | None
        AIS.5 - Start Date/Time Offset (NM) C S10.5.4

    ais_6 : CE | None
        AIS.6 - Start Date/Time Offset Units (CE) C S10.5.4

    ais_7 : str | None
        AIS.7 - Duration (NM) O S10.5.4

    ais_8 : CE | None
        AIS.8 - Duration Units (CE) O S10.5.4

    ais_9 : str | None
        AIS.9 - Allow Substitution Code (IS) C S10.5.4 | 0279 - Allow Substitution Codes

    ais_10 : CE | None
        AIS.10 - Filler Status Code (CE) C S10.5.2 | 0278 - Filler Status Codes
    """
