...
class DRG(HL7Model):
    """Diagnosis Related Group (S6.4.3).

    Attributes
    ----------
    drg_1 : CE | None
        DRG.1 - Diagnostic Related Group (CE) O S6.4.2 | 0055 - DRG Code

    drg_2 : TS | None
        DRG.2 - DRG Assigned Date/Time (TS) O S6.4.3.2

    drg_3 : str | None
        DRG.3 - DRG Approval Indicator (ID) O S6.4.2 | 0136 - Yes/No Indicator

    drg_4 : str | None
        DRG.4 - DRG Grouper Review Code (IS) O S6.4.2 | 0056 - DRG Grouper Review Code

    drg_5 : CE | None
        DRG.5 - Outlier Type (CE) O S6.4.2 | 0083 - Outlier Type

    drg_6 : str | None
        DRG.6 - Outlier Days (NM) O S6.4.2

    drg_7 : CP | None
        DRG.7 - Outlier Cost (CP) O S6.4.2

    drg_8 : str | None
        DRG.8 - DRG Payor (IS) O S6.4.3.8 | 0229 - Outlier Type

    drg_9 : CP | None
        DRG.9 - Outlier Reimbursement (CP) O S6.4.3.9

    drg_10 : str | None
        DRG.10 - Confidential Indicator (ID) O S6.4.2 | 0136 - Yes/No Indicator
    """
    ...
    drg_8: Optional[str] = Field(
        ...
        title="DRG Payor",
        description="O | Item #00770 | Table 0229 - Outlier Type | LEN:1",
    )
