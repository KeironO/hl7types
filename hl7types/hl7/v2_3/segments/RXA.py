...
class RXA(HL7Model):
    ...
    ----------
    rxa_1 : str
        RXA.1 (req) - Give Sub-ID Counter (ID) S4.8.12
    ...
    rxa_9 : list[CE] | None
        RXA.9 (opt, rep) - Administration Notes (CE) S4.8.12

    rxa_10 : XCN | None
        RXA.10 (opt) - Administering Provider (XCN) S4.8.14.10
    ...
    rxa_15 : list[str] | None
        RXA.15 (opt, rep) - Substance Lot Number (ST) S4.8.10

    rxa_16 : list[TS] | None
        RXA.16 (opt, rep) - Substance Expiration Date (TS) S4.8.10

    rxa_17 : list[CE] | None
        RXA.17 (opt, rep) - Substance Manufacturer Name (CE) S4.8.10 | 0227 - Manufacturers of Vaccines

    rxa_18 : list[CE] | None
        RXA.18 (opt, rep) - Substance Refusal Reason (CE) S4.8.14.18

    rxa_19 : list[CE] | None
        RXA.19 (opt, rep) - Indication (CE) S4.8.2
