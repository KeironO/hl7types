...
class PCR(HL7Model):
    """Possible Causal Relationship (S7.11.3).

    Attributes
    ----------
    pcr_1 : CE
        PCR.1 - Implicated Product (CE) R S7.11.3.1

    pcr_2 : str | None
        PCR.2 - Generic Product (IS) O S7.11.3.2 | 0249 - Generic Product

    pcr_3 : CE | None
        PCR.3 - Product Class (CE) O S7.11.3.3

    pcr_4 : CQ | None
        PCR.4 - Total Duration Of Therapy (CQ) O S7.11.3.4

    pcr_5 : TS | None
        PCR.5 - Product Manufacture Date (TS) O S7.11.3.5

    pcr_6 : TS | None
        PCR.6 - Product Expiration Date (TS) O S7.11.3.6

    pcr_7 : TS | None
        PCR.7 - Product Implantation Date (TS) O S7.11.3.7

    pcr_8 : TS | None
        PCR.8 - Product Explantation Date (TS) O S7.11.3.8

    pcr_9 : str | None
        PCR.9 - Single Use Device (IS) O S7.11.3.9 | 0244 - Single Use Device

    pcr_10 : CE | None
        PCR.10 - Indication For Product Use (CE) O S7.11.3.10

    pcr_11 : str | None
        PCR.11 - Product Problem (IS) O S7.11.3.11 | 0245 - Product Problem

    pcr_12 : list[str] | None
        PCR.12 - Product Serial/Lot Number (ST) O rep S7.11.3.12

    pcr_13 : str | None
        PCR.13 - Product Available For Inspection (IS) O S7.11.3.13 | 0246 - Product Available for Inspection

    pcr_14 : CE | None
        PCR.14 - Product Evaluation Performed (CE) O S7.11.3.14

    pcr_15 : CE | None
        PCR.15 - Product Evaluation Status (CE) O S7.11.3.15 | 0247 - Start of Evaluation

    pcr_16 : CE | None
        PCR.16 - Product Evaluation Results (CE) O S7.11.3.16

    pcr_17 : str | None
        PCR.17 - Evaluated Product Source (ID) O S7.11.3.17 | 0248 - Product Source

    pcr_18 : TS | None
        PCR.18 - Date Product Returned To Manufacturer (TS) NA S7.11.3.18

    pcr_19 : str | None
        PCR.19 - Device Operator Qualifications (ID) O S7.11.3.19 | 0242 - Primary Observer's Qualification

    pcr_20 : str | None
        PCR.20 - Relatedness Assessment (ID) O S7.11.3.20 | 0250 - Relatedness Assessment

    pcr_21 : list[str] | None
        PCR.21 - Action Taken In Response To The Event (ID) O rep S7.11.3.21 | 0251 - Action Taken in Response to the Event

    pcr_22 : list[str] | None
        PCR.22 - Event Causality Observations (ID) O rep S7.11.3.22 | 0232 - Insurance Company Contact Reason

    pcr_23 : list[str] | None
        PCR.23 - Indirect Exposure Mechanism (ID) O rep S7.11.3.23 | 0253 - Indirect Exposure Mechanism
    """
    ...
    pcr_15: Optional[CE] = Field(
        ...
        description="O | Item #01112 | Table 0247 - Start of Evaluation",
    )
    ...
    pcr_20: Optional[str] = Field(
        ...
        description=(
            "O | Item #01117 | Table 0250 - Relatedness Assessment | LEN:8"
        ),
    )
    ...
    pcr_22: Optional[List[str]] = Field(
        ...
        description=(
            "O | Item #01119 | Table 0232 - Insurance Company Contact Reason | "
            "LEN:2"
        ),
    )
    ...
    pcr_23: Optional[List[str]] = Field(
        ...
        description=(
            "O | Item #01120 | Table 0253 - Indirect Exposure Mechanism | LEN:2"
        ),
    )
