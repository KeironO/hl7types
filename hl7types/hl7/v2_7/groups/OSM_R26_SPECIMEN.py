...
from .OSM_R26_SUBJECT_PERSON_ANIMAL_IDENTIFICATION import (
    OSM_R26_SUBJECT_PERSON_ANIMAL_IDENTIFICATION,
)
from .OSM_R26_SUBJECT_POPULATION_LOCATION_IDENTIFICATION import (
...
_OSM_R26_SUBJECT_POPULATION_LOCATION_IDENTIFICATION = (
    OSM_R26_SUBJECT_POPULATION_LOCATION_IDENTIFICATION
)
_PRT = PRT
_SPM = SPM
...
class OSM_R26_SPECIMEN(BaseModel):
    ...
    SUBJECT_PERSON_ANIMAL_IDENTIFICATION: _OSM_R26_SUBJECT_PERSON_ANIMAL_IDENTIFICATION | None = (
        Field(
            default=None,
    ...
    SUBJECT_POPULATION_LOCATION_IDENTIFICATION: (
        _OSM_R26_SUBJECT_POPULATION_LOCATION_IDENTIFICATION | None
    ) = Field(
        default=None,
