...
class STF(HL7Model):
    ...
    stf_4 : list[CWE] | None
        STF.4 (opt, rep) - Staff Type (CWE) S15.4.8.4 | 0182 - Staff type

    stf_5 : CWE | None
        STF.5 (opt) - Administrative Sex (CWE) S15.4.8.5 | 0001 - Administrative Sex
    ...
    stf_16 : CWE | None
        STF.16 (opt) - Preferred Method of Contact (CWE) S11.8.3.6 | 0185 - Preferred Method of Contact
    ...
    stf_19 : JCC | None
        STF.19 (opt) - Job Code/Class (JCC) S15.4.8.19 | 0327 - Job Code
    ...
    stf_36 : list[CWE] | None
        STF.36 (opt, rep) - Cost Center Code (CWE) S15.4.5.13 | 0539 - Cost Center Code
    ...
    stf_40 : CWE | None
        STF.40 (opt) - Religion (CWE) S15.4.8.40 | 0006 - Religion

    stf_41 : ED | None
        STF.41 (opt) - Signature (ED) S15.4.2.6
    """
