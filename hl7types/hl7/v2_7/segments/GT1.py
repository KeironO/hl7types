...
class GT1(HL7Model):
    ...
    gt1_8 : str | None
        GT1.8 - Guarantor Date/Time Of Birth (DTM) O S6.5.5.8

    gt1_9 : CWE | None
        GT1.9 - Guarantor Administrative Sex (CWE) O S6.5.5.9 | 0001 - Administrative Sex

    gt1_10 : CWE | None
        GT1.10 - Guarantor Type (CWE) O S6.5.5.10 | 0068 - Guarantor Type

    gt1_11 : CWE | None
        GT1.11 - Guarantor Relationship (CWE) O S6.5.5.11 | 0063 - Relationship
    ...
    gt1_20 : CWE | None
        GT1.20 - Guarantor Employment Status (CWE) O S6.5.5.20 | 0066 - Employment Status
    ...
    gt1_23 : CWE | None
        GT1.23 - Guarantor Credit Rating Code (CWE) O S6.5.5.23 | 0341 - Guarantor Credit Rating Code

    gt1_24 : str | None
        GT1.24 - Guarantor Death Date And Time (DTM) O S6.5.5.24

    gt1_25 : str | None
        GT1.25 - Guarantor Death Flag (ID) O S6.5.5.25 | 0136 - Yes/no Indicator

    gt1_26 : CWE | None
        GT1.26 - Guarantor Charge Adjustment Code (CWE) O S6.5.5.26 | 0218 - Patient Charge Adjustment
    ...
    gt1_30 : CWE | None
        GT1.30 - Guarantor Marital Status Code (CWE) O S6.5.5.30 | 0002 - Marital Status
    ...
    gt1_33 : CWE | None
        GT1.33 - Living Dependency (CWE) O S3.4.11.1 | 0223 - Living Dependency

    gt1_34 : list[CWE] | None
        GT1.34 - Ambulatory Status (CWE) O rep S3.4.3.15 | 0009 - Ambulatory Status

    gt1_35 : list[CWE] | None
        GT1.35 - Citizenship (CWE) O rep S15.4.8.30 | 0171 - Citizenship

    gt1_36 : CWE | None
        GT1.36 - Primary Language (CWE) O S2.B.8.3.15 | 0296 - Primary Language

    gt1_37 : CWE | None
        GT1.37 - Living Arrangement (CWE) O S3.4.11.2 | 0220 - Living Arrangement

    gt1_38 : CWE | None
        GT1.38 - Publicity Code (CWE) O S3.4.11.11 | 0215 - Publicity Code

    gt1_39 : str | None
        GT1.39 - Protection Indicator (ID) O S3.4.11.12 | 0136 - Yes/no Indicator

    gt1_40 : CWE | None
        GT1.40 - Student Indicator (CWE) O S3.4.11.5 | 0231 - Student Status

    gt1_41 : CWE | None
        GT1.41 - Religion (CWE) O S15.4.8.40 | 0006 - Religion

    gt1_42 : list[XPN] | None
        GT1.42 - Mother's Maiden Name (XPN) O rep S2.B.8.3.6

    gt1_43 : CWE | None
        GT1.43 - Nationality (CWE) O S3.4.5.27 | 0212 - Nationality

    gt1_44 : list[CWE] | None
        GT1.44 - Ethnic Group (CWE) O rep S15.4.8.28 | 0189 - Ethnic Group

    gt1_45 : list[XPN] | None
        GT1.45 - Contact Person's Name (XPN) O rep S3.4.5.30 | 0200 - Name Type

    gt1_46 : list[XTN] | None
        GT1.46 - Contact Person's Telephone Number (XTN) O rep S3.4.5.31

    gt1_47 : CWE | None
        GT1.47 - Contact Reason (CWE) O S3.4.5.29 | 0222 - Contact Reason

    gt1_48 : CWE | None
        GT1.48 - Contact Relationship (CWE) O S6.5.5.48 | 0063 - Relationship

    gt1_49 : str | None
        GT1.49 - Job Title (ST) O S15.4.8.18

    gt1_50 : JCC | None
        GT1.50 - Job Code/Class (JCC) O S15.4.8.19 | 0327 - Job Code

    gt1_51 : list[XON] | None
        GT1.51 - Guarantor Employer's Organization Name (XON) O rep S6.5.5.51

    gt1_52 : CWE | None
        GT1.52 - Handicap (CWE) O S3.4.11.6 | 0295 - Handicap

    gt1_53 : CWE | None
        GT1.53 - Job Status (CWE) O S3.4.5.34 | 0311 - Job Status

    gt1_54 : FC | None
        GT1.54 - Guarantor Financial Class (FC) O S6.5.5.54

    gt1_55 : list[CWE] | None
        GT1.55 - Guarantor Race (CWE) O rep S6.5.5.55 | 0005 - Race

    gt1_56 : str | None
        GT1.56 - Guarantor Birth Place (ST) O S6.5.5.56

    gt1_57 : CWE | None
        GT1.57 - VIP Indicator (CWE) O S3.4.3.16 | 0099 - VIP Indicator
    """
    ...
    gt1_9: Optional[CWE] = Field(
        ...
        description="O | Item #00413 | Table 0001 - Administrative Sex",
    )
    ...
    gt1_10: Optional[CWE] = Field(
        ...
        description="O | Item #00414 | Table 0068 - Guarantor Type",
    )
    ...
    gt1_20: Optional[CWE] = Field(
        ...
        description="O | Item #00424 | Table 0066 - Employment Status",
    )
    ...
    gt1_48: Optional[CWE] = Field(
        ...
        description="O | Item #00784 | Table 0063 - Relationship",
    )
