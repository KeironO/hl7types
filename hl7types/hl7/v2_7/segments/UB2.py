...
class UB2(HL7Model):
    ...
    ub2_10 : list[str] | None
        UB2.10 (opt, rep) - Uniform Billing 11 (State) (ST) S6.5.11.10

    ub2_11 : str | None
        UB2.11 (opt) - Uniform Billing 31 (National) (ST) S6.5.11.11

    ub2_12 : list[str] | None
        UB2.12 (opt, rep) - Document Control Number (ST) S6.5.11.12

    ub2_13 : list[str] | None
        UB2.13 (opt, rep) - Uniform Billing 49 (National) (ST) S6.5.11.13

    ub2_14 : list[str] | None
        UB2.14 (opt, rep) - Uniform Billing 56 (State) (ST) S6.5.11.14

    ub2_15 : str | None
        UB2.15 (opt) - Uniform Billing 57 (National) (ST) S6.5.11.15

    ub2_16 : list[str] | None
        UB2.16 (opt, rep) - Uniform Billing 78 (State) (ST) S6.5.11.16
    ...
    ub2_10: Optional[List[str]] = Field(
        ...
        validation_alias=AliasChoices(
            "ub2_10",
            "uniform_billing_11_state",
            "UB2.10",
        ),
        serialization_alias="UB2.10",
        title="Uniform Billing 11 (State)",
    ...
    ub2_11: Optional[str] = Field(
        ...
        validation_alias=AliasChoices(
            "ub2_11",
            "uniform_billing_31_national",
            "UB2.11",
        ),
        serialization_alias="UB2.11",
        title="Uniform Billing 31 (National)",
    ...
    ub2_13: Optional[List[str]] = Field(
        ...
        validation_alias=AliasChoices(
            "ub2_13",
            "uniform_billing_49_national",
            "UB2.13",
        ),
        serialization_alias="UB2.13",
        title="Uniform Billing 49 (National)",
    ...
    ub2_14: Optional[List[str]] = Field(
        ...
        validation_alias=AliasChoices(
            "ub2_14",
            "uniform_billing_56_state",
            "UB2.14",
        ),
        serialization_alias="UB2.14",
        title="Uniform Billing 56 (State)",
    ...
    ub2_15: Optional[str] = Field(
        ...
        validation_alias=AliasChoices(
            "ub2_15",
            "uniform_billing_57_national",
            "UB2.15",
        ),
        serialization_alias="UB2.15",
        title="Uniform Billing 57 (National)",
    ...
    ub2_16: Optional[List[str]] = Field(
        ...
        validation_alias=AliasChoices(
            "ub2_16",
            "uniform_billing_78_state",
            "UB2.16",
        ),
        serialization_alias="UB2.16",
        title="Uniform Billing 78 (State)",
