...
class PID(HL7Model):
    ...
    pid_18 : CX | None
        PID.18 - Patient Account Number (CX) O S3.4.2.18 | 0061 - Check Digit Scheme

    pid_21 : list[CX] | None
        PID.21 - Mother's Identifier (CX) O rep S3.4.2.21 | 0061 - Check Digit Scheme
    ...
    pid_35 : CWE | None
        PID.35 - Species Code (CWE) C S2.B.8.3.35 | 0446 - Species Code

    pid_36 : CWE | None
        PID.36 - Breed Code (CWE) C S2.B.8.3.36 | 0447 - Breed Code
    ...
    pid_18: Optional[CX] = Field(
        ...
        description="O | Item #00121 | Table 0061 - Check Digit Scheme",
    )
    ...
    pid_21: Optional[List[CX]] = Field(
        ...
        description="O | Item #00124 | Table 0061 - Check Digit Scheme",
    )
