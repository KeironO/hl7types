...
class OM2(HL7Model):
    ...
    om2_2 : CWE | None
        OM2.2 (opt) - Units of Measure (CWE)

    om2_3 : list[str] | None
        OM2.3 (opt, rep) - Range of Decimal Precision (NM)

    om2_4 : CWE | None
        OM2.4 (opt) - Corresponding SI Units of Measure (CWE)

    om2_5 : str | None
        OM2.5 (opt) - SI Conversion Factor (TX)

    om2_6 : list[RFR] | None
        OM2.6 (opt, rep) - Reference (Normal) Range for Ordinal and Continuous Observations (RFR)
