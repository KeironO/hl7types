...
class RXA(HL7Model):
    ...
    ----------
    rxa_1 : str
        RXA.1 - Give Sub-ID Counter (NM) R S4.A.4.5.1

    rxa_2 : str
        RXA.2 - Administration Sub-ID Counter (NM) R S4.A.4.6.2

    rxa_3 : str
        RXA.3 - Date/Time Start of Administration (DTM) R S4.A.4.6.3

    rxa_4 : str
        RXA.4 - Date/Time End of Administration (DTM) R S4.A.4.6.4

    rxa_5 : CWE
        RXA.5 - Administered Code (CWE) R S4.A.4.6.5 | 0292 - Vaccines administered

    rxa_6 : str
        RXA.6 - Administered Amount (NM) R S4.A.4.6.6

    rxa_7 : CWE | None
        RXA.7 - Administered Units (CWE) C S4.A.4.6.7 | 9999 - no table for CE

    rxa_8 : CWE | None
        RXA.8 - Administered Dosage Form (CWE) O S4.A.4.6.8 | 9999 - no table for CE

    rxa_9 : list[CWE] | None
        RXA.9 - Administration Notes (CWE) O rep S4.A.4.5.9 | 9999 - no table for CE

    rxa_10 : list[XCN] | None
        RXA.10 - Administering Provider (XCN) O rep S4.A.4.6.10

    rxa_11 : LA2 | None
        RXA.11 - Administered-at Location (LA2) O S4.A.4.6.11

    rxa_12 : str | None
        RXA.12 - Administered Per (Time Unit) (ST) C S4.A.4.6.12

    rxa_13 : str | None
        RXA.13 - Administered Strength (NM) O S4.A.4.6.13

    rxa_14 : CWE | None
        RXA.14 - Administered Strength Units (CWE) O S4.A.4.6.14 | 9999 - no table for CE

    rxa_15 : list[str] | None
        RXA.15 - Substance Lot Number (ST) O rep S13.4.11.2

    rxa_16 : list[str] | None
        RXA.16 - Substance Expiration Date (DTM) O rep S4.A.4.4.19

    rxa_17 : list[CWE] | None
        RXA.17 - Substance Manufacturer Name (CWE) O rep S4.A.4.4.20 | 0227 - Manufacturers of Vaccines (code=MVX)

    rxa_18 : list[CWE] | None
        RXA.18 - Substance/Treatment Refusal Reason (CWE) O rep S4.A.4.6.18 | 9999 - no table for CE

    rxa_19 : list[CWE] | None
        RXA.19 - Indication (CWE) O rep S4.A.4.0.20 | 9999 - no table for CE

    rxa_20 : str | None
        RXA.20 - Completion Status (ID) O S4.A.4.6.20 | 0322 - Completion Status

    rxa_21 : str | None
        RXA.21 - Action Code - RXA (ID) O S4.A.4.6.21 | 0206 - Segment action code

    rxa_22 : str | None
        RXA.22 - System Entry Date/Time (DTM) O S4.A.4.6.22

    rxa_23 : str | None
        RXA.23 - Administered Drug Strength Volume (NM) O S4.A.4.6.23

    rxa_24 : CWE | None
        RXA.24 - Administered Drug Strength Volume Units (CWE) O S4.A.4.6.24 | 9999 - no table for CE

    rxa_25 : CWE | None
        RXA.25 - Administered Barcode Identifier (CWE) O S4.A.4.6.25 | 9999 - no table for CE

    rxa_26 : str | None
        RXA.26 - Pharmacy Order Type (ID) O S4.A.4.6.26 | 0480 - Pharmacy Order Types

    rxa_27 : PL | None
        RXA.27 - Administer-at (PL) O S4.A.4.6.27

    rxa_28 : XAD | None
        RXA.28 - Administered-at Address (XAD) O S4.A.4.6.28
    """
