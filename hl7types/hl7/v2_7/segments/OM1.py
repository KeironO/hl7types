...
class OM1(BaseModel):
    ...
    om1_7 : CWE | None
        OM1.7 (opt) - Other Service/Test/Observation IDs for the Observation (CWE)
    ...
    om1_31 : CWE | None
        OM1.31 (opt) - Observations Required to Interpret this Observation (CWE)

    om1_32 : TX | None
        OM1.32 (opt) - Interpretation of Observations (TX)

    om1_33 : CWE | None
        OM1.33 (opt) - Contraindications to Observations (CWE)
    ...
    om1_36 : CWE | None
        OM1.36 (opt) - Fixed Canned Message (CWE)
