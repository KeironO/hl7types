...
class PSL(HL7Model):
    ...
    psl_17 : list[CWE] | None
        PSL.17 (opt, rep) - Product/Service Clarification Code Type (CWE) S16.4.6.17 | 0561 - Product/Services Clarification Codes
    ...
    psl_20 : list[CWE] | None
        PSL.20 (opt, rep) - Processing Consideration Code (CWE) S16.4.6.20 | 0562 - Processing Consideration Codes
