...
_all_ = {
    ...
    'CSP', 'CSR', 'CSS', 'CTD', 'CTI', 'DB1', 'DG1', 'DMI', 'DON', 'DPS',
    'DRG', 'DSC', 'DSP', 'ECD', 'ECR', 'EDU', 'EQP', 'EQU', 'ERR', 'EVN',
    'FAC', 'FHS', 'FT1', 'FTS', 'GOL', 'GP1', 'GP2', 'GT1', 'Hxx', 'IAM',
    'IAR', 'IIM', 'ILT', 'IN1', 'IN2', 'IN3', 'INV', 'IPC', 'IPR', 'ISD',
    'ITM', 'IVC', 'IVT', 'LAN', 'LCC', 'LCH', 'LDP', 'LOC', 'LRL', 'MCP',
    'MFA', 'MFE', 'MFI', 'MRG', 'MSA', 'MSH', 'NCK', 'NDS', 'NK1', 'NPU',
    'NSC', 'NST', 'NTE', 'OBR', 'OBX', 'ODS', 'ODT', 'OM1', 'OM2', 'OM3',
    'OM4', 'OM5', 'OM6', 'OM7', 'OMC', 'ORC', 'ORG', 'OVR', 'PAC', 'PCE',
    'PCR', 'PD1', 'PDA', 'PDC', 'PEO', 'PES', 'PID', 'PKG', 'PM1', 'PMT',
    'PR1', 'PRA', 'PRB', 'PRC', 'PRD', 'PRT', 'PSG', 'PSH', 'PSL', 'PSS',
    'PTH', 'PV1', 'PV2', 'PYE', 'QAK', 'QID', 'QPD', 'QRD', 'QRF', 'QRI',
    'RCP', 'RDF', 'RDT', 'REL', 'RF1', 'RFI', 'RGS', 'RMI', 'ROL', 'RQ1',
    'RQD', 'RXA', 'RXC', 'RXD', 'RXE', 'RXG', 'RXO', 'RXR', 'RXV', 'SAC',
    'SCD', 'SCH', 'SCP', 'SDD', 'SFT', 'SGH', 'SGT', 'SHP', 'SID', 'SLT',
