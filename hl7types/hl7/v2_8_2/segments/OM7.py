...
class OM7(HL7Model):
    ...
    om7_3 : list[CWE] | None
        OM7.3 - Category Identifier (CWE) O rep S8.8.15.3 | 0412 - Category Identifier

    om7_4 : str | None
        OM7.4 - Category Description (TX) O S8.8.15.4

    om7_5 : list[str] | None
        OM7.5 - Category Synonym (ST) O rep S8.8.15.5

    om7_6 : str | None
        OM7.6 - Effective Test/Service Start Date/Time (DTM) O S8.8.15.6

    om7_7 : str | None
        OM7.7 - Effective Test/Service End Date/Time (DTM) O S8.8.15.7

    om7_8 : str | None
        OM7.8 - Test/Service Default Duration Quantity (NM) O S8.8.15.8

    om7_9 : CWE | None
        OM7.9 - Test/Service Default Duration Units (CWE) O S8.8.15.9 | 9999 - no table for CE

    om7_10 : CWE | None
        OM7.10 - Test/Service Default Frequency (CWE) O S8.8.15.10

    om7_11 : str | None
        OM7.11 - Consent Indicator (ID) O S8.8.15.11 | 0136 - Yes/no Indicator

    om7_12 : CWE | None
        OM7.12 - Consent Identifier (CWE) O S8.8.15.12 | 0413 - Consent Identifier

    om7_13 : str | None
        OM7.13 - Consent Effective Start Date/Time (DTM) O S8.8.15.13

    om7_14 : str | None
        OM7.14 - Consent Effective End Date/Time (DTM) O S8.8.15.14

    om7_15 : str | None
        OM7.15 - Consent Interval Quantity (NM) O S8.8.15.15

    om7_16 : CWE | None
        OM7.16 - Consent Interval Units (CWE) C S8.8.15.16 | 0414 - Units of Time

    om7_17 : str | None
        OM7.17 - Consent Waiting Period Quantity (NM) O S8.8.15.17

    om7_18 : CWE | None
        OM7.18 - Consent Waiting Period Units (CWE) C S8.8.15.18 | 0414 - Units of Time

    om7_19 : str | None
        OM7.19 - Effective Date/Time of Change (DTM) O S8.8.15.19

    om7_20 : XCN | None
        OM7.20 - Entered By (XCN) O S2.14.10.5

    om7_21 : list[PL] | None
        OM7.21 - Orderable-at Location (PL) O rep S8.8.15.21

    om7_22 : CWE | None
        OM7.22 - Formulary Status (CWE) O S8.8.15.22 | 0473 - Formulary Status

    om7_23 : str | None
        OM7.23 - Special Order Indicator (ID) O S8.8.15.23 | 0136 - Yes/no Indicator

    om7_24 : list[CWE] | None
        OM7.24 - Primary Key Value - CDM (CWE) O rep S8.8.15.24
    """
