...
class OBR(HL7Model):
    ...
    obr_13 : list[CWE] | None
        OBR.13 - Relevant Clinical Information (CWE) O rep S4.5.3.13 | 0916 - Relevant Clincial Information
    ...
    obr_29 : EIP | None
        OBR.29 - Parent  Results Observation Identifier (EIP) O S4.5.3.29
    ...
    obr_49 : CWE | None
        OBR.49 - Result Handling (CWE) O S4.5.3.49 | 0507 - Observation Result Handling

    obr_50 : CWE | None
        OBR.50 - Parent Universal Service Identifier (CWE) O S4.5.3.50

    obr_51 : EI | None
        OBR.51 - Observation Group ID (EI) O S4.5.3.51

    obr_52 : EI | None
        OBR.52 - Parent Observation Group ID (EI) O S4.5.3.52

    obr_53 : list[CX] | None
        OBR.53 - Alternate Placer Order Number (CX) O rep S4.5.3.53

    obr_54 : EIP | None
        OBR.54 - Parent Order (EIP) O S4.5.1.8
    """
