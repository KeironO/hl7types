...
class OBR(HL7Model):
    ...
    obr_7 : str | None
        OBR.7 (opt) - Observation Date/Time # (DTM) S4.5.3.7

    obr_8 : str | None
        OBR.8 (opt) - Observation End Date/Time # (DTM) S4.5.3.8
    ...
    obr_12 : CWE | None
        OBR.12 (opt) - Danger Code (CWE) S4.5.3.12 | 9999 - no table for CE

    obr_13 : list[CWE] | None
        OBR.13 (opt, rep) - Relevant Clinical Information (CWE) S4.5.3.13 | 0916 - Relevant Clincial Information
    ...
    obr_22 : str | None
        OBR.22 (opt) - Results Rpt/Status Chng - Date/Time + (DTM) S4.5.3.22
    ...
    obr_29 : EIP | None
        OBR.29 (opt) - Parent  Results Observation Identifier (EIP) S4.5.3.29

    obr_30 : str | None
        OBR.30 (opt) - Transportation Mode (ID) S4.5.3.30 | 0124 - Transportation Mode

    obr_31 : list[CWE] | None
        OBR.31 (opt, rep) - Reason for Study (CWE) S4.5.3.31 | 9999 - no table for CE
    ...
    obr_36 : str | None
        OBR.36 (opt) - Scheduled Date/Time + (DTM) S4.5.3.36

    obr_37 : str | None
        OBR.37 (opt) - Number of Sample Containers * (NM) S4.5.3.37

    obr_38 : list[CWE] | None
        OBR.38 (opt, rep) - Transport Logistics of Collected Sample * (CWE) S4.5.3.38 | 9999 - no table for CE

    obr_39 : list[CWE] | None
        OBR.39 (opt, rep) - Collector's Comment * (CWE) S4.5.3.39 | 9999 - no table for CE

    obr_40 : CWE | None
        OBR.40 (opt) - Transport Arrangement Responsibility (CWE) S4.5.3.40 | 9999 - no table for CE
    ...
    obr_43 : list[CWE] | None
        OBR.43 (opt, rep) - Planned Patient Transport Comment (CWE) S4.5.3.43 | 9999 - no table for CE
    ...
    obr_49 : CWE | None
        OBR.49 (opt) - Result Handling (CWE) S4.5.3.49 | 0507 - Observation Result Handling

    obr_50 : CWE | None
        OBR.50 (opt) - Parent Universal Service Identifier (CWE) S4.5.3.50

    obr_51 : EI | None
        OBR.51 (opt) - Observation Group ID (EI) S4.5.3.51

    obr_52 : EI | None
        OBR.52 (opt) - Parent Observation Group ID (EI) S4.5.3.52

    obr_53 : list[CX] | None
        OBR.53 (opt, rep) - Alternate Placer Order Number (CX) S4.5.3.53

    obr_54 : EIP | None
        OBR.54 (opt) - Parent Order (EIP) S4.5.1.8
    """
    ...
    obr_29: Optional[EIP] = Field(
        ...
        title="Parent  Results Observation Identifier",
