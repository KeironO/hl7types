...
class OBX(HL7Model):
    ...
    obx_4 : OG | None
        OBX.4 (opt) - Observation Sub-ID (OG)
    ...
    obx_27 : CWE | None
        OBX.27 (opt) - Root Cause (CWE)

    obx_28 : list[CWE] | None
        OBX.28 (opt, rep) - Local Process Control (CWE)

    obx_29 : str | None
        OBX.29 (opt) - Observation Type (ID)

    obx_30 : str | None
        OBX.30 (opt) - Observation Sub-Type (ID)
    """
