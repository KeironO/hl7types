...
class OBX(HL7Model):
    ...
    obx_4 : OG | None
        OBX.4 - Observation Sub-ID (OG) C S7.4.2.4
    ...
    obx_8 : list[CWE] | None
        OBX.8 - Interpretation Codes (CWE) O rep S7.4.2.8 | 0078 - Interpretation Codes
    ...
    obx_29 : str | None
        OBX.29 - Observation Type (ID) O S7.4.2.29 | 0936 - Observation Type

    obx_30 : str | None
        OBX.30 - Observation Sub-Type (ID) O S7.4.2.30 | 0937 - Observation Sub-Type
    """
    ...
    obx_8: Optional[List[CWE]] = Field(
        ...
        description="O | Item #00576 | Table 0078 - Interpretation Codes",
    )
    ...
    obx_29: Optional[str] = Field(
        ...
        description="O | Item #03432 | Table 0936 - Observation Type",
    )
    ...
    obx_30: Optional[str] = Field(
        ...
        description="O | Item #03475 | Table 0937 - Observation Sub-Type",
    )
