...
class LRL(HL7Model):
    ...
    lrl_2 : str | None
        LRL.2 - Segment Action Code (ID) O S8.8.16.2 | 0206 - Segment Action Code

    lrl_3 : EI | None
        LRL.3 - Segment Unique Key (EI) O S8.8.16.3
    ...
    lrl_2: Optional[str] = Field(
        ...
        description="O | Item #00763 | Table 0206 - Segment Action Code",
    )
