...
class RXA(HL7Model):
    ...
    rxa_5 : CWE
        RXA.5 - Administered Code (CWE) R S4.A.1.5 | 0292 - Vaccines Administered (code = CVX) (parenteral, unless oral is noted)
    ...
    rxa_5: CWE = Field(
        ...
        description=(
            "R | Item #00347 | Table 0292 - Vaccines Administered (code = CVX) "
