...
class RXD(HL7Model):
    ...
    rxd_2 : CWE
        RXD.2 (req) - Dispense/Give Code (CWE) S4.A.5.2 | 0292 - Vaccines Administered (code = CVX) (parenteral, unless oral is noted)
    ...
    rxd_7 : str
        RXD.7 (req) - Prescription Number (ST) S6.5.1.42
    ...
    rxd_15 : list[CWE] | None
        RXD.15 (opt, rep) - Special Dispensing Instructions (CWE) S4.A.4.21 | 9999 - no table for CE
    ...
    rxd_20 : list[CWE] | None
        RXD.20 (opt, rep) - Substance Manufacturer Name (CWE) S4.A.5.20
    ...
    rxd_35 : list[EI] | None
        RXD.35 (opt, rep) - Dispense Tag Identifier (EI) S4.A.5.35
    """
