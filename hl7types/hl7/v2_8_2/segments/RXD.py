...
class RXD(HL7Model):
    ...
    rxd_2 : CWE
        RXD.2 - Dispense/Give Code (CWE) R S4.A.5.2 | 0292 - Vaccines Administered (code = CVX) (parenteral, unless oral is noted)
    ...
    rxd_7 : str
        RXD.7 - Prescription Number (ST) R S6.5.1.42
    ...
    rxd_2: CWE = Field(
        ...
        description=(
            "R | Item #00335 | Table 0292 - Vaccines Administered (code = CVX) "
