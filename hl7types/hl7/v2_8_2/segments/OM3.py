...
class OM3(HL7Model):
    ...
    om3_2 : CWE | None
        OM3.2 - Preferred Coding System (CWE) O S8.8.11.2 | 9999 - no table for CE

    om3_3 : list[CWE] | None
        OM3.3 - Valid Coded "Answers" (CWE) O rep S8.8.11.3 | 9999 - no table for CE

    om3_4 : list[CWE] | None
        OM3.4 - Normal Text/Codes for Categorical Observations (CWE) O rep S8.8.11.4 | 9999 - no table for CE

    om3_5 : list[CWE] | None
        OM3.5 - Abnormal Text/Codes for Categorical Observations (CWE) O rep S8.8.11.5 | 9999 - no table for CE

    om3_6 : list[CWE] | None
        OM3.6 - Critical Text/Codes for Categorical Observations (CWE) O rep S8.8.11.6 | 9999 - no table for CE
