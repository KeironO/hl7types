...
class OM1(HL7Model):
    ...
    om1_52 : list[CWE] | None
        OM1.52 (opt, rep) - Replacement Producer's Service/Test/Observation ID (CWE)

    om1_53 : list[TX] | None
        OM1.53 (opt, rep) - Prior Resuts Instructions (TX)

    om1_54 : TX | None
        OM1.54 (opt) - Special Instructions (TX)

    om1_55 : list[CWE] | None
        OM1.55 (opt, rep) - Test Category (CWE)

    om1_56 : CWE | None
        OM1.56 (opt) - Observation/Identifier associated with Producer's Service/Test/Observation ID (CWE)

    om1_57 : CQ | None
        OM1.57 (opt) - Typical Turn-Around Time (CQ)

    om1_58 : list[CWE] | None
        OM1.58 (opt, rep) - Gender Restriction (CWE)

    om1_59 : list[NR] | None
        OM1.59 (opt, rep) - Age Restriction (NR)
    """
