...
class OM2(HL7Model):
    ...
    om2_2 : CWE | None
        OM2.2 - Units of Measure (CWE) O S8.8.10.2 | 9999 - no table for CE

    om2_3 : list[str] | None
        OM2.3 - Range of Decimal Precision (NM) O rep S8.8.10.3

    om2_4 : CWE | None
        OM2.4 - Corresponding SI Units of Measure (CWE) O S8.8.10.4 | 9999 - no table for CE

    om2_5 : str | None
        OM2.5 - SI Conversion Factor (TX) O S8.8.10.5

    om2_6 : list[RFR] | None
        OM2.6 - Reference (Normal) Range for Ordinal and Continuous Observations (RFR) O rep S8.8.10.6

    om2_7 : list[RFR] | None
        OM2.7 - Critical Range for Ordinal and Continuous Observations (RFR) O rep S8.8.10.7

    om2_8 : RFR | None
        OM2.8 - Absolute Range for Ordinal and Continuous Observations (RFR) O S8.8.10.8

    om2_9 : list[DLT] | None
        OM2.9 - Delta Check Criteria (DLT) O rep S8.8.10.9

    om2_10 : str | None
        OM2.10 - Minimum Meaningful Increments (NM) O S8.8.10.10
    """
