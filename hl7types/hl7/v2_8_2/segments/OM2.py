...
class OM2(HL7Model):
    ...
    om2_2 : CWE | None
        OM2.2 (opt) - Units of Measure (CWE) S8.8.10.2 | 9999 - no table for CE

    om2_3 : list[str] | None
        OM2.3 (opt, rep) - Range of Decimal Precision (NM) S8.8.10.3

    om2_4 : CWE | None
        OM2.4 (opt) - Corresponding SI Units of Measure (CWE) S8.8.10.4 | 9999 - no table for CE

    om2_5 : str | None
        OM2.5 (opt) - SI Conversion Factor (TX) S8.8.10.5

    om2_6 : list[RFR] | None
        OM2.6 (opt, rep) - Reference (Normal) Range for Ordinal and Continuous Observations (RFR) S8.8.10.6

    om2_7 : list[RFR] | None
        OM2.7 (opt, rep) - Critical Range for Ordinal and Continuous Observations (RFR) S8.8.10.7

    om2_8 : RFR | None
        OM2.8 (opt) - Absolute Range for Ordinal and Continuous Observations (RFR) S8.8.10.8

    om2_9 : list[DLT] | None
        OM2.9 (opt, rep) - Delta Check Criteria (DLT) S8.8.10.9

    om2_10 : str | None
        OM2.10 (opt) - Minimum Meaningful Increments (NM) S8.8.10.10
    """
