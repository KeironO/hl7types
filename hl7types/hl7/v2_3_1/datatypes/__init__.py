...
_all_ = {
    ...
    'DTN', 'ED', 'EI', 'EIP', 'ELD', 'FC', 'FN', 'HD', 'JCC', 'LA1', 'LA2',
    'MA', 'MO', 'MOC', 'MOP', 'MSG', 'NA', 'NDL', 'NR', 'OCD', 'OSD', 'OSP',
    'PCF', 'PI', 'PIP', 'PL', 'PLN', 'PN', 'PPN', 'PRL', 'PT', 'PTA', 'QIP',
    'QSC', 'RCD', 'RFR', 'RI', 'RMC', 'RP', 'SCV', 'SN', 'SPD', 'SPS', 'TQ',
    'TS', 'TX_CHALLENGE', 'UVC', 'VH', 'VID', 'VR', 'WVI', 'WVS', 'XAD', 'XCN',
    'XON', 'XPN', 'XTN', 'varies'
}  # type: ignore
