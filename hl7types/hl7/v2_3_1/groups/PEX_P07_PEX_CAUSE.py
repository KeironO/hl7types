...
class PEX_P07_PEX_CAUSE(HL7Model):
    ...
    PCR: _PCR = Field(
        title="PCR",
        description="PCR - possible causal relationship segment",
    )
