...
from .PPR_PC1_PATHWAY_OBSERVATION import PPR_PC1_PATHWAY_OBSERVATION
...
_PPR_PC1_PATHWAY_OBSERVATION = PPR_PC1_PATHWAY_OBSERVATION
...
class PPR_PC1_PROBLEM(BaseModel):
    ...
    Attributes:
        ...
        PATHWAY_OBSERVATION (Optional[List[PPR_PC1_PATHWAY_OBSERVATION]]): optional
    ...
    PROBLEM_ROLE: list[_PPR_PC1_PROBLEM_ROLE] | None = Field(
        default=None,
        title="PROBLEM_ROLE",
        description="Optional, repeating",
    )

    PATHWAY: list[_PPR_PC1_PATHWAY] | None = Field(
        default=None,
        title="PATHWAY",
        description="Optional, repeating",
    )

    PATHWAY_OBSERVATION: list[_PPR_PC1_PATHWAY_OBSERVATION] | None = Field(
        default=None,
        title="PATHWAY_OBSERVATION",
        description="Optional, repeating",
    )

    GOAL: list[_PPR_PC1_GOAL] | None = Field(
        default=None,
        title="GOAL",
        description="Optional, repeating",
    )

    ORDER: list[_PPR_PC1_ORDER] | None = Field(
        default=None,
        title="ORDER",
        description="Optional, repeating",
    )
