...
class CTI(HL7Model):
    """CTI - clinical trial identification segment (S7.7.4).

    Attributes
    ----------
    cti_1 : EI
        CTI.1 (req) - Sponsor Study ID (EI) S8.10.2.2

    cti_2 : CE | None
        CTI.2 (opt) - Study Phase Identifier (CE) S8.10.3.2

    cti_3 : CE | None
        CTI.3 (opt) - Study Scheduled Time Point (CE) S7.7.4.3
    """
