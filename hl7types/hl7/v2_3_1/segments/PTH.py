...
class PTH(HL7Model):
    ...
    ----------
    pth_1 : str
        PTH.1 (req) - Action Code (ID) S12.3.4.1 | 0287 - Problem/Goal Action code
    ...
    pth_5 : CE | None
        PTH.5 (opt) - Pathway Life Cycle Status (CE) S12.3.4.5

    pth_6 : TS | None
        PTH.6 (opt) - Change Pathway Life Cycle Status Date/Time (TS) S12.3.4.6
    """
