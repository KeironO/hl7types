...
class DB1(HL7Model):
    ...
    db1_5 : str | None
        DB1.5 - Disability Start Date (DT) O S3.3.10.5

    db1_6 : str | None
        DB1.6 - Disability End Date (DT) O S3.3.10.6

    db1_7 : str | None
        DB1.7 - Disability Return to Work Date (DT) O S3.3.10.7

    db1_8 : str | None
        DB1.8 - Disability Unable to Work Date (DT) O S3.3.10.8
    """
