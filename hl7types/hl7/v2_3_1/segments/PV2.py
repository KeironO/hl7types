...
class PV2(HL7Model):
    ...
    pv2_8 : TS | None
        PV2.8 (opt) - Expected Admit Date/Time (TS) S3.3.4.8

    pv2_9 : TS | None
        PV2.9 (opt) - Expected Discharge Date/Time (TS) S3.3.4.9
    ...
    pv2_13 : list[XCN] | None
        PV2.13 (opt, rep) - Referral Source Code (XCN) S3.3.4.13
    ...
    pv2_24 : str | None
        PV2.24 (opt) - Patient Status Code (IS) S3.3.4.24 | 0216 - Patient Status Code

    pv2_25 : str | None
        PV2.25 (opt) - Visit Priority Code (IS) S3.3.4.25 | 0217 - Visit Priority Code

    pv2_26 : str | None
        PV2.26 (opt) - Previous Treatment Date (DT) S3.3.4.26

    pv2_27 : str | None
        PV2.27 (opt) - Expected Discharge Disposition (IS) S3.3.4.27 | 0112 - Discharge disposition
    ...
    pv2_30 : CE | None
        PV2.30 (opt) - Patient Charge Adjustment Code (CE) S3.3.4.30 | 0218 - Patient Charge Adjustment Code

    pv2_31 : str | None
        PV2.31 (opt) - Recurring Service Code (IS) S3.3.4.31 | 0219 - Recurring Service Code
    ...
    pv2_35 : str | None
        PV2.35 (opt) - Military Non-Availability Code (ID) S3.3.4.35 | 0136 - Yes/no indicator
