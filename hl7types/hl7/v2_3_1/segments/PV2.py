...
class PV2(HL7Model):
    """PV2 - patient visit - additional information segment (S3.3.4).

    Attributes
    ----------
    pv2_1 : PL | None
        PV2.1 - Prior Pending Location (PL) C S3.3.4.1
    ...
    pv2_8 : TS | None
        PV2.8 - Expected Admit Date/Time (TS) O S3.3.4.8

    pv2_9 : TS | None
        PV2.9 - Expected Discharge Date/Time (TS) O S3.3.4.9
    ...
    pv2_13 : list[XCN] | None
        PV2.13 - Referral Source Code (XCN) O rep S3.3.4.13
    ...
    pv2_24 : str | None
        PV2.24 - Patient Status Code (IS) O S3.3.4.24 | 0216 - Patient Status Code

    pv2_25 : str | None
        PV2.25 - Visit Priority Code (IS) O S3.3.4.25 | 0217 - Visit Priority Code

    pv2_26 : str | None
        PV2.26 - Previous Treatment Date (DT) O S3.3.4.26

    pv2_27 : str | None
        PV2.27 - Expected Discharge Disposition (IS) O S3.3.4.27 | 0112 - Discharge disposition
    ...
    pv2_30 : CE | None
        PV2.30 - Patient Charge Adjustment Code (CE) O S3.3.4.30 | 0218 - Patient Charge Adjustment Code

    pv2_31 : str | None
        PV2.31 - Recurring Service Code (IS) O S3.3.4.31 | 0219 - Recurring Service Code
    ...
    pv2_35 : str | None
        PV2.35 - Military Non-Availability Code (ID) O S3.3.4.35 | 0136 - Yes/no indicator
    ...
    pv2_30: Optional[CE] = Field(
        ...
        description=(
            "O | Item #00731 | Table 0218 - Patient Charge Adjustment Code"
        ),
    )
