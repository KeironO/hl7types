...
class OM5(HL7Model):
    """OM5 - observation batteries (sets)  segment (S8.7.7).

    Attributes
    ----------
    om5_1 : str | None
        OM5.1 - Sequence Number - Test/Observation Master File (NM) NA S8.7.8.1

    om5_2 : list[CE] | None
        OM5.2 - Test/Observations Included within an Ordered Test Battery (CE) O rep S8.7.7.2
