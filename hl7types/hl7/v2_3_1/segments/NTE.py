...
class NTE(HL7Model):
    ...
    ----------
    nte_1 : str | None
        NTE.1 - Set ID - NTE (SI) O S2.24.15.1

    nte_2 : str | None
        NTE.2 - Source of Comment (ID) O S2.24.15.2 | 0105 - Source of comment

    nte_3 : list[str] | None
        NTE.3 - Comment (FT) O rep S2.24.15.3

    nte_4 : CE | None
        NTE.4 - Comment Type (CE) O S2.24.15.4 | 0364 - Comment type
    """
