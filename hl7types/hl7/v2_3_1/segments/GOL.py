...
class GOL(HL7Model):
    ...
    ----------
    gol_1 : str
        GOL.1 (req) - Action Code (ID) S12.3.4.1 | 0287 - Problem/Goal Action code

    gol_2 : TS
        GOL.2 (req) - Action Date/Time (TS) S12.3.2.2
    ...
    gol_5 : EI | None
        GOL.5 (opt) - Episode of Care ID (EI) S12.3.2.5
    ...
    gol_8 : TS | None
        GOL.8 (opt) - Expected Goal Achieve Date/Time (TS) S12.3.1.8
