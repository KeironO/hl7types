...
class GOL(HL7Model):
    ...
    ----------
    gol_1 : str
        GOL.1 - Action Code (ID) R S12.3.4.1 | 0287 - Problem/Goal Action code

    gol_2 : TS
        GOL.2 - Action Date/Time (TS) R S12.3.2.2
    ...
    gol_5 : EI | None
        GOL.5 - Episode of Care ID (EI) O S12.3.2.5
    ...
    gol_8 : TS | None
        GOL.8 - Expected Goal Achieve Date/Time (TS) NA S12.3.1.8
