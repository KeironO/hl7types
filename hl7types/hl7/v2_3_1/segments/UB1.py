...
class UB1(HL7Model):
    """UB1 - UB82 data segment (S6.4.10).

    Attributes
    ----------
    ub1_1 : str | None
        UB1.1 - Set ID - UB1 (SI) O S6.4.10.1

    ub1_2 : str | None
        UB1.2 - Blood Deductible  (43) (NM) O S6.4.10.2

    ub1_3 : str | None
        UB1.3 - Blood Furnished-Pints Of (40) (NM) O S6.4.10.3

    ub1_4 : str | None
        UB1.4 - Blood Replaced-Pints (41) (NM) O S6.4.10.4

    ub1_5 : str | None
        UB1.5 - Blood Not Replaced-Pints(42) (NM) O S6.4.10.5

    ub1_6 : str | None
        UB1.6 - Co-Insurance Days (25) (NM) O S6.4.10.6

    ub1_7 : list[str] | None
        UB1.7 - Condition Code (35-39) (IS) O rep S6.4.10.7 | 0043 - Condition code

    ub1_8 : str | None
        UB1.8 - Covered Days - (23) (NM) O S6.4.10.8

    ub1_9 : str | None
        UB1.9 - Non Covered Days - (24) (NM) O S6.4.10.9

    ub1_10 : list[UVC] | None
        UB1.10 - Value Amount & Code (46-49) (UVC) O rep S6.4.10.10 | 0153 - Value code

    ub1_11 : str | None
        UB1.11 - Number Of Grace Days (90) (NM) O S6.4.10.11

    ub1_12 : CE | None
        UB1.12 - Special Program Indicator (44) (CE) O S6.4.10.12 | 0348 - Special program indicator

    ub1_13 : CE | None
        UB1.13 - PSRO/UR Approval Indicator (87) (CE) O S6.4.10.13 | 0349 - PSRO/UR approval indicator

    ub1_14 : str | None
        UB1.14 - PSRO/UR Approved Stay-Fm (88) (DT) O S6.4.10.14

    ub1_15 : str | None
        UB1.15 - PSRO/UR Approved Stay-To (89) (DT) O S6.4.10.15

    ub1_16 : list[OCD] | None
        UB1.16 - Occurrence (28-32) (OCD) O rep S6.4.10.16 | 0350 - Occurrence code

    ub1_17 : CE | None
        UB1.17 - Occurrence Span (33) (CE) O S6.4.10.17 | 0351 - Occurrence span

    ub1_18 : str | None
        UB1.18 - Occur Span Start Date(33) (DT) O S6.4.10.18

    ub1_19 : str | None
        UB1.19 - Occur Span End Date (33) (DT) O S6.4.10.19

    ub1_20 : str | None
        UB1.20 - UB-82 Locator 2 (ST) O S6.4.10.20

    ub1_21 : str | None
        UB1.21 - UB-82 Locator 9 (ST) O S6.4.10.21

    ub1_22 : str | None
        UB1.22 - UB-82 Locator 27 (ST) O S6.4.10.22

    ub1_23 : str | None
        UB1.23 - UB-82 Locator 45 (ST) O S6.4.10.23
    """
    ...
    ub1_10: Optional[List[UVC]] = Field(
        ...
        description="O | Item #00539 | Table 0153 - Value code",
    )
    ...
    ub1_16: Optional[List[OCD]] = Field(
        ...
        description="O | Item #00545 | Table 0350 - Occurrence code",
    )
