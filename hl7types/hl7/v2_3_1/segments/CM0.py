...
class CM0(HL7Model):
    """CM0 - clinical study master segment (S8.10.2).

    Attributes
    ----------
    cm0_1 : str | None
        CM0.1 (opt) - Set ID - CM0 (SI) S8.10.2.1

    cm0_2 : EI
        CM0.2 (req) - Sponsor Study ID (EI) S8.10.2.2

    cm0_3 : list[EI] | None
        CM0.3 (opt, rep) - Alternate Study ID (EI) S8.10.2.3

    cm0_4 : str
        CM0.4 (req) - Title of Study (ST) S8.10.2.4

    cm0_5 : list[XCN] | None
        CM0.5 (opt, rep) - Chairman of Study (XCN) S8.10.2.5
    ...
    cm0_9 : list[XCN] | None
        CM0.9 (opt, rep) - Contact for Study (XCN) S8.10.2.9

    cm0_10 : XTN | None
        CM0.10 (opt) - Contact's Tel. Number (XTN) S8.10.2.10

    cm0_11 : list[XAD] | None
        CM0.11 (opt, rep) - Contact's Address (XAD) S8.10.2.11
    """
