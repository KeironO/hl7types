...
class CM0(HL7Model):
    ...
    ----------
    cm0_1 : str | None
        CM0.1 - Set ID - CM0 (SI) O S8.10.2.1

    cm0_2 : EI
        CM0.2 - Sponsor Study ID (EI) R S8.10.2.2

    cm0_3 : list[EI] | None
        CM0.3 - Alternate Study ID (EI) O rep S8.10.2.3

    cm0_4 : str
        CM0.4 - Title of Study (ST) R S8.10.2.4

    cm0_5 : list[XCN] | None
        CM0.5 - Chairman of Study (XCN) O rep S8.10.2.5
    ...
    cm0_9 : list[XCN] | None
        CM0.9 - Contact for Study (XCN) O rep S8.10.2.9

    cm0_10 : XTN | None
        CM0.10 - Contact's Tel. Number (XTN) O S8.10.2.10

    cm0_11 : list[XAD] | None
        CM0.11 - Contact's Address (XAD) O rep S8.10.2.11
    """
