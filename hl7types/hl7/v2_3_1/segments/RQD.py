...
class RQD(HL7Model):
    """RQD - requisition detail segment (S4.7.1).
    ...
    rqd_2 : CE | None
        RQD.2 - Item Code - Internal (CE) C S4.7.1.2

    rqd_3 : CE | None
        RQD.3 - Item Code - External (CE) C S4.7.1.3

    rqd_4 : CE | None
        RQD.4 - Hospital Item Code (CE) C S4.7.1.4
    ...
    rqd_7 : str | None
        RQD.7 - Dept. Cost Center (IS) O S4.7.1.7 | 0319 - Department Cost Center

    rqd_8 : str | None
        RQD.8 - Item Natural Account Code (IS) O S4.7.1.8 | 0320 - Item Natural Account Code
