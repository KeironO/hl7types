...
class PV1(HL7Model):
    """PV1 - patient visit segment- (S3.3.3.53).

    Attributes
    ----------
    pv1_1 : str | None
        PV1.1 - Set ID - PV1 (SI) O S3.3.3.1

    pv1_2 : str
        PV1.2 - Patient Class (IS) R S3.3.3.2 | 0004 - Patient class

    pv1_3 : PL | None
        PV1.3 - Assigned Patient Location (PL) O S6.4.1.16

    pv1_4 : str | None
        PV1.4 - Admission Type (IS) O S3.3.3.4 | 0007 - Admission type
    ...
    pv1_7 : list[XCN] | None
        PV1.7 - Attending Doctor (XCN) O rep S3.3.3.7 | 0010 - Physician ID

    pv1_8 : list[XCN] | None
        PV1.8 - Referring Doctor (XCN) O rep S3.3.3.8 | 0010 - Physician ID

    pv1_9 : list[XCN] | None
        PV1.9 - Consulting Doctor (XCN) O rep S3.3.3.9 | 0010 - Physician ID

    pv1_10 : str | None
        PV1.10 - Hospital Service (IS) O S3.3.3.10 | 0069 - Hospital Service

    pv1_11 : PL | None
        PV1.11 - Temporary Location (PL) O S3.3.3.11

    pv1_12 : str | None
        PV1.12 - Preadmit Test Indicator (IS) O S3.3.3.12 | 0087 - Preadmit Test Indicator

    pv1_13 : str | None
        PV1.13 - Re-admission Indicator (IS) O S3.3.3.13 | 0092 - Re-admission Indicator

    pv1_14 : str | None
        PV1.14 - Admit Source (IS) O S3.3.3.14 | 0023 - Admit source

    pv1_15 : list[str] | None
        PV1.15 - Ambulatory Status (IS) O rep S6.4.7.32 | 0009 - Ambulatory status

    pv1_16 : str | None
        PV1.16 - VIP Indicator (IS) O S3.3.3.16 | 0099 - VIP Indicator

    pv1_17 : list[XCN] | None
        PV1.17 - Admitting Doctor (XCN) O rep S3.3.3.17 | 0010 - Physician ID

    pv1_18 : str | None
        PV1.18 - Patient Type (IS) O S6.4.1.18 | 0018 - Patient Type
    ...
    pv1_21 : str | None
        PV1.21 - Charge Price Indicator (IS) O S3.3.3.21 | 0032 - Charge/Price Indicator

    pv1_22 : str | None
        PV1.22 - Courtesy Code (IS) O S3.3.3.22 | 0045 - Courtesy Code

    pv1_23 : str | None
        PV1.23 - Credit Rating (IS) O S3.3.3.23 | 0046 - Credit Rating

    pv1_24 : list[str] | None
        PV1.24 - Contract Code (IS) O rep S3.3.3.24 | 0044 - Contract Code
    ...
    pv1_28 : str | None
        PV1.28 - Interest Code (IS) O S3.3.3.28 | 0073 - Interest Rate Code

    pv1_29 : str | None
        PV1.29 - Transfer to Bad Debt Code (IS) O S3.3.3.29 | 0110 - Transfer to Bad Debt Code

    pv1_30 : str | None
        PV1.30 - Transfer to Bad Debt Date (DT) O S3.3.3.30

    pv1_31 : str | None
        PV1.31 - Bad Debt Agency Code (IS) O S3.3.3.31 | 0021 - Bad Debt Agency Code
    ...
    pv1_34 : str | None
        PV1.34 - Delete Account Indicator (IS) O S3.3.3.34 | 0111 - Delete Account Code

    pv1_35 : str | None
        PV1.35 - Delete Account Date (DT) O S3.3.3.35

    pv1_36 : str | None
        PV1.36 - Discharge Disposition (IS) O S3.3.3.36 | 0112 - Discharge disposition

    pv1_37 : DLD | None
        PV1.37 - Discharged to Location (DLD) O S3.3.3.37 | 0113 - Discharged to Location

    pv1_38 : CE | None
        PV1.38 - Diet Type (CE) O S3.3.3.38 | 0114 - Diet Type

    pv1_39 : str | None
        PV1.39 - Servicing Facility (IS) O S3.3.3.39 | 0115 - Servicing Facility

    pv1_40 : str | None
        PV1.40 - Bed Status (IS) O S3.3.7.2 | 0116 - Bed status

    pv1_41 : str | None
        PV1.41 - Account Status (IS) O S3.3.3.41 | 0117 - Account Status
    ...
    pv1_50 : CX | None
        PV1.50 - Alternate Visit ID (CX) O S3.3.3.50 | 0203 - Identifier type

    pv1_51 : str | None
        PV1.51 - Visit Indicator (IS) O S3.3.3.51 | 0326 - Visit indicator
    ...
    pv1_12: Optional[str] = Field(
        ...
        description=(
            "O | Item #00142 | Table 0087 - Preadmit Test Indicator | LEN:2"
        ),
    )
