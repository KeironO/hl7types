...
class PV1(HL7Model):
    ...
    ----------
    pv1_1 : str | None
        PV1.1 (opt) - Set ID - PV1 (SI) S3.3.3.1

    pv1_2 : str
        PV1.2 (req) - Patient Class (IS) S3.3.3.2 | 0004 - Patient class

    pv1_3 : PL | None
        PV1.3 (opt) - Assigned Patient Location (PL) S6.4.1.16

    pv1_4 : str | None
        PV1.4 (opt) - Admission Type (IS) S3.3.3.4 | 0007 - Admission type
    ...
    pv1_7 : list[XCN] | None
        PV1.7 (opt, rep) - Attending Doctor (XCN) S3.3.3.7 | 0010 - Physician ID

    pv1_8 : list[XCN] | None
        PV1.8 (opt, rep) - Referring Doctor (XCN) S3.3.3.8 | 0010 - Physician ID

    pv1_9 : list[XCN] | None
        PV1.9 (opt, rep) - Consulting Doctor (XCN) S3.3.3.9 | 0010 - Physician ID

    pv1_10 : str | None
        PV1.10 (opt) - Hospital Service (IS) S3.3.3.10 | 0069 - Hospital Service

    pv1_11 : PL | None
        PV1.11 (opt) - Temporary Location (PL) S3.3.3.11

    pv1_12 : str | None
        PV1.12 (opt) - Preadmit Test Indicator (IS) S3.3.3.12 | 0087 - Preadmit Test Indicator

    pv1_13 : str | None
        PV1.13 (opt) - Re-admission Indicator (IS) S3.3.3.13 | 0092 - Re-admission Indicator

    pv1_14 : str | None
        PV1.14 (opt) - Admit Source (IS) S3.3.3.14 | 0023 - Admit source

    pv1_15 : list[str] | None
        PV1.15 (opt, rep) - Ambulatory Status (IS) S6.4.7.32 | 0009 - Ambulatory status

    pv1_16 : str | None
        PV1.16 (opt) - VIP Indicator (IS) S3.3.3.16 | 0099 - VIP Indicator

    pv1_17 : list[XCN] | None
        PV1.17 (opt, rep) - Admitting Doctor (XCN) S3.3.3.17 | 0010 - Physician ID

    pv1_18 : str | None
        PV1.18 (opt) - Patient Type (IS) S6.4.1.18 | 0018 - Patient Type
    ...
    pv1_21 : str | None
        PV1.21 (opt) - Charge Price Indicator (IS) S3.3.3.21 | 0032 - Charge/Price Indicator

    pv1_22 : str | None
        PV1.22 (opt) - Courtesy Code (IS) S3.3.3.22 | 0045 - Courtesy Code

    pv1_23 : str | None
        PV1.23 (opt) - Credit Rating (IS) S3.3.3.23 | 0046 - Credit Rating

    pv1_24 : list[str] | None
        PV1.24 (opt, rep) - Contract Code (IS) S3.3.3.24 | 0044 - Contract Code
    ...
    pv1_28 : str | None
        PV1.28 (opt) - Interest Code (IS) S3.3.3.28 | 0073 - Interest Rate Code

    pv1_29 : str | None
        PV1.29 (opt) - Transfer to Bad Debt Code (IS) S3.3.3.29 | 0110 - Transfer to Bad Debt Code

    pv1_30 : str | None
        PV1.30 (opt) - Transfer to Bad Debt Date (DT) S3.3.3.30

    pv1_31 : str | None
        PV1.31 (opt) - Bad Debt Agency Code (IS) S3.3.3.31 | 0021 - Bad Debt Agency Code
    ...
    pv1_34 : str | None
        PV1.34 (opt) - Delete Account Indicator (IS) S3.3.3.34 | 0111 - Delete Account Code

    pv1_35 : str | None
        PV1.35 (opt) - Delete Account Date (DT) S3.3.3.35

    pv1_36 : str | None
        PV1.36 (opt) - Discharge Disposition (IS) S3.3.3.36 | 0112 - Discharge disposition

    pv1_37 : DLD | None
        PV1.37 (opt) - Discharged to Location (DLD) S3.3.3.37 | 0113 - Discharged to Location

    pv1_38 : CE | None
        PV1.38 (opt) - Diet Type (CE) S3.3.3.38 | 0114 - Diet Type

    pv1_39 : str | None
        PV1.39 (opt) - Servicing Facility (IS) S3.3.3.39 | 0115 - Servicing Facility

    pv1_40 : str | None
        PV1.40 (opt) - Bed Status (IS) S3.3.7.2 | 0116 - Bed status

    pv1_41 : str | None
        PV1.41 (opt) - Account Status (IS) S3.3.3.41 | 0117 - Account Status
    ...
    pv1_50 : CX | None
        PV1.50 (opt) - Alternate Visit ID (CX) S3.3.3.50 | 0203 - Identifier type

    pv1_51 : str | None
        PV1.51 (opt) - Visit Indicator (IS) S3.3.3.51 | 0326 - Visit indicator
