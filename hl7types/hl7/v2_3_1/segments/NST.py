...
class NST(HL7Model):
    """Application control level statistics (SC.2.2.16).

    Attributes
    ----------
    nst_1 : str | None
        NST.1 - Statistics Available (ID) NA SC.2.2.1 | 0136 - Yes/no indicator
    ...
    nst_1: Optional[str] = Field(
        ...
        description="NA | Item #01173 | Table 0136 - Yes/no indicator",
    )
