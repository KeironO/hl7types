...
class AIG(HL7Model):
    ...
    aig_2 : str | None
        AIG.2 - Segment Action Code (ID) C S10.5.7.2 | 0206 - Segment action code
    ...
    aig_5 : list[CE] | None
        AIG.5 - Resource Group (CE) O rep S10.5.7.5
    ...
    aig_8 : TS | None
        AIG.8 - Start Date/Time (TS) C S10.5.7.6

    aig_9 : str | None
        AIG.9 - Start Date/Time Offset (NM) C S10.5.7.7

    aig_10 : CE | None
        AIG.10 - Start Date/Time Offset Units (CE) C S10.5.7.8

    aig_11 : str | None
        AIG.11 - Duration (NM) O S10.5.7.9

    aig_12 : CE | None
        AIG.12 - Duration Units (CE) O S10.5.7.10

    aig_13 : str | None
        AIG.13 - Allow Substitution Code (IS) C S10.5.7.11 | 0279 - Allow substitution codes

    aig_14 : CE | None
        AIG.14 - Filler Status Code (CE) C S10.5.7.12 | 0278 - Filler status codes
    """
