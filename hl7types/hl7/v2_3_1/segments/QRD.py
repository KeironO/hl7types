...
class QRD(HL7Model):
    ...
    ----------
    qrd_1 : TS
        QRD.1 - Query Date/Time (TS) R S2.24.4.1
    ...
    qrd_6 : TS | None
        QRD.6 - Deferred Response Date/Time (TS) O S2.24.4.6
    ...
    qrd_11 : list[VR] | None
        QRD.11 - What Data Code Value Qual. (VR) O rep S2.24.4.11

    qrd_12 : str | None
        QRD.12 - Query Results Level (ID) O S2.24.4.12 | 0108 - Query results level
    """
