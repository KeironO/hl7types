...
class PRC(HL7Model):
    ...
    ----------
    prc_1 : CE
        PRC.1 (req) - Primary Key Value - PRC (CE) S8.9.3.1 | 0132 - Transaction Code

    prc_2 : list[CE] | None
        PRC.2 (opt, rep) - Facility ID - PRC (CE) S8.9.3.2

    prc_3 : list[CE] | None
        PRC.3 (opt, rep) - Department (CE) S8.9.3.3 | 0184 - Department

    prc_4 : list[str] | None
        PRC.4 (opt, rep) - Valid Patient Classes (IS) S8.9.3.4 | 0004 - Patient class
    ...
    prc_13 : str | None
        PRC.13 (opt) - Price Override Flag (IS) S8.9.3.13 | 0268 - Override
    ...
    prc_16 : str | None
        PRC.16 (opt) - Active/Inactive Flag (ID) S8.9.3.16 | 0183 - Active/inactive

    prc_17 : MO | None
        PRC.17 (opt) - Cost (MO) S8.9.3.17

    prc_18 : str | None
        PRC.18 (opt) - Charge On Indicator (IS) S8.9.3.18 | 0269 - Charge on indicator
    """
