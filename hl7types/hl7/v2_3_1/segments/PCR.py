...
class PCR(HL7Model):
    """PCR - possible causal relationship segment (S7.11.3).
    ...
    pcr_15 : CE | None
        PCR.15 (opt) - Product Evaluation Status (CE) S7.11.3.15 | 0247 - Status of evaluation
    ...
    pcr_22 : list[str] | None
        PCR.22 (opt, rep) - Event Causality Observations (ID) S7.11.3.22 | 0252 - Causality observations
