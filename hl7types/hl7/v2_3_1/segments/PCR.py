...
class PCR(HL7Model):
    ...
    pcr_15 : CE | None
        PCR.15 - Product Evaluation Status (CE) O S7.11.3.15 | 0247 - Status of evaluation
    ...
    pcr_18 : TS | None
        PCR.18 - Date Product Returned To Manufacturer (TS) O S7.11.3.18
    ...
    pcr_22 : list[str] | None
        PCR.22 - Event Causality Observations (ID) O rep S7.11.3.22 | 0252 - Causality observations
