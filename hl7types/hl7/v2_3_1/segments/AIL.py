...
class AIL(HL7Model):
    ...
    ail_2 : str | None
        AIL.2 - Segment Action Code (ID) C S10.5.7.2 | 0206 - Segment action code

    ail_3 : PL | None
        AIL.3 - Location Resource ID (PL) C S10.5.6.3

    ail_4 : CE
        AIL.4 - Location Type-AIL (CE) R S10.5.6.4

    ail_5 : CE | None
        AIL.5 - Location Group (CE) O S10.5.6.5

    ail_6 : TS | None
        AIL.6 - Start Date/Time (TS) C S10.5.7.6

    ail_7 : str | None
        AIL.7 - Start Date/Time Offset (NM) C S10.5.7.7

    ail_8 : CE | None
        AIL.8 - Start Date/Time Offset Units (CE) C S10.5.7.8

    ail_9 : str | None
        AIL.9 - Duration (NM) O S10.5.7.9

    ail_10 : CE | None
        AIL.10 - Duration Units (CE) O S10.5.7.10

    ail_11 : str | None
        AIL.11 - Allow Substitution Code (IS) C S10.5.7.11 | 0279 - Allow substitution codes

    ail_12 : CE | None
        AIL.12 - Filler Status Code (CE) C S10.5.7.12 | 0278 - Filler status codes
    """
