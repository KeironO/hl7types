...
class NSC(HL7Model):
    ...
    ----------
    nsc_1 : str | None
        NSC.1 (opt) - Network Change Type (IS) SC.2.3.1 | 0333 - Driver’s license issuing authority
    ...
    nsc_9 : str | None
        NSC.9 (opt) - New Facility (ST) SC.2.3.9
    """
    ...
    nsc_1: Optional[str] = Field(
        ...
        description="Item #1188 | Table HL70333",
    )
