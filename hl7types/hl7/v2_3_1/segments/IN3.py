...
class IN3(HL7Model):
    """IN3 - insurance additional information, certification segment (S6.4.8).

    Attributes
    ----------
    in3_1 : str
        IN3.1 - Set ID - IN3 (SI) R S6.4.8.1
    ...
    in3_5 : MOP | None
        IN3.5 - Penalty (MOP) O S6.4.8.5 | 0148 - Penalty type

    in3_6 : TS | None
        IN3.6 - Certification Date/Time (TS) O S6.4.8.6

    in3_7 : TS | None
        IN3.7 - Certification Modify Date/Time (TS) O S6.4.8.7

    in3_8 : list[XCN] | None
        IN3.8 - Operator (XCN) O rep S6.4.8.8

    in3_9 : str | None
        IN3.9 - Certification Begin Date (DT) O S6.4.8.9

    in3_10 : str | None
        IN3.10 - Certification End Date (DT) O S6.4.8.10

    in3_11 : DTN | None
        IN3.11 - Days (DTN) O S6.4.8.11 | 0149 - Day type

    in3_12 : CE | None
        IN3.12 - Non-Concur Code/Description (CE) O S6.4.8.12 | 0233 - Non-concur Code/Description

    in3_13 : TS | None
        IN3.13 - Non-Concur Effective Date/Time (TS) O S6.4.8.13

    in3_14 : list[XCN] | None
        IN3.14 - Physician Reviewer (XCN) O rep S6.4.8.14 | 0010 - Physician ID

    in3_15 : str | None
        IN3.15 - Certification Contact (ST) O S6.4.8.15

    in3_16 : list[XTN] | None
        IN3.16 - Certification Contact Phone Number (XTN) O rep S6.4.8.16

    in3_17 : CE | None
        IN3.17 - Appeal Reason (CE) O S6.4.8.17 | 0345 - Appeal Reason

    in3_18 : CE | None
        IN3.18 - Certification Agency (CE) O S6.4.8.18 | 0346 - Certification Agency

    in3_19 : list[XTN] | None
        IN3.19 - Certification Agency Phone Number (XTN) O rep S6.4.8.19

    in3_20 : list[PCF] | None
        IN3.20 - Pre-Certification Req/Window (PCF) O rep S6.4.8.20 | 0150 - Pre-certification patient type

    in3_21 : str | None
        IN3.21 - Case Manager (ST) O S6.4.8.21

    in3_22 : str | None
        IN3.22 - Second Opinion Date (DT) O S6.4.8.22

    in3_23 : str | None
        IN3.23 - Second Opinion Status (IS) O S6.4.8.23 | 0151 - Second Opinion Status

    in3_24 : list[str] | None
        IN3.24 - Second Opinion Documentation Received (IS) O rep S6.4.8.24 | 0152 - Second Opinion Documentation Received

    in3_25 : list[XCN] | None
        IN3.25 - Second Opinion Physician (XCN) O rep S6.4.8.25 | 0010 - Physician ID
    """
    ...
    in3_9: Optional[str] = Field(
        ...
        description="O | Item #00510 | LEN:8",
    )
    ...
    in3_10: Optional[str] = Field(
        ...
        description="O | Item #00511 | LEN:8",
    )
    ...
    in3_11: Optional[DTN] = Field(
        ...
        title="Days",
        description="O | Item #00512 | Table 0149 - Day type",
    )
    ...
    in3_15: Optional[str] = Field(
        ...
        description="O | Item #00516 | LEN:48",
    )
    ...
    in3_20: Optional[List[PCF]] = Field(
        default=None,
        validation_alias=AliasChoices(
            "in3_20",
            "pre_certification_req_window",
            "IN3.20",
        ),
        serialization_alias="IN3.20",
        title="Pre-Certification Req/Window",
        description=(
            "O | Item #00521 | Table 0150 - Pre-certification patient type"
        ),
    )
    ...
    in3_21: Optional[str] = Field(
        ...
        title="Case Manager",
        description="O | Item #00522 | LEN:48",
    )
    ...
    in3_22: Optional[str] = Field(
        ...
        description="O | Item #00523 | LEN:8",
    )
    ...
    in3_23: Optional[str] = Field(
        ...
        description=(
            "O | Item #00524 | Table 0151 - Second Opinion Status | LEN:1"
        ),
    )
