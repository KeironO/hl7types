...
class SPR(HL7Model):
    ...
    ----------
    spr_1 : str | None
        SPR.1 - Query Tag (ST) O S2.24.22.1

    spr_2 : str
        SPR.2 - Query/ Response Format Code (ID) R S2.24.20.2 | 0106 - Query/response format code

    spr_3 : CE
        SPR.3 - Stored Procedure Name (CE) R S2.24.20.3

    spr_4 : list[QIP] | None
        SPR.4 - Input Parameter List (QIP) O rep S2.24.21.3
    """
