...
class OBR(HL7Model):
    """OBR - observation request segment (S7.3.1).

    Attributes
    ----------
    obr_1 : str | None
        OBR.1 (opt) - Set ID - OBR (SI) S7.3.1.1

    obr_2 : EI | None
        OBR.2 (opt) - Placer Order Number (EI) S9.5.1.14

    obr_3 : EI | None
        OBR.3 (opt) - Filler Order Number (EI) S9.5.1.15

    obr_4 : CE
        OBR.4 (req) - Universal Service ID (CE) S10.5.4.3

    obr_5 : str | None
        OBR.5 (opt) - Priority-OBR (ID) S7.3.1.5

    obr_6 : TS | None
        OBR.6 (opt) - Requested Date/time (TS) S7.3.1.6

    obr_7 : TS | None
        OBR.7 (opt) - Observation Date/Time # (TS) S7.3.1.7

    obr_8 : TS | None
        OBR.8 (opt) - Observation End Date/Time # (TS) S7.3.1.8

    obr_9 : CQ | None
        OBR.9 (opt) - Collection Volume * (CQ) S7.3.1.9

    obr_10 : list[XCN] | None
        OBR.10 (opt, rep) - Collector Identifier * (XCN) S7.3.1.10

    obr_11 : str | None
        OBR.11 (opt) - Specimen Action Code * (ID) S7.3.1.11 | 0065 - Specimen action code

    obr_12 : CE | None
        OBR.12 (opt) - Danger Code (CE) S7.3.1.12

    obr_13 : str | None
        OBR.13 (opt) - Relevant Clinical Info. (ST) S7.3.1.13

    obr_14 : TS | None
        OBR.14 (opt) - Specimen Received Date/Time * (TS) S7.3.1.14

    obr_15 : SPS | None
        OBR.15 (opt) - Specimen Source (SPS) S7.3.1.15 | 0070 - Specimen source codes

    obr_16 : list[XCN] | None
        OBR.16 (opt, rep) - Ordering Provider (XCN) S7.3.1.16

    obr_17 : list[XTN] | None
        OBR.17 (opt, rep) - Order Callback Phone Number (XTN) S7.3.1.17

    obr_18 : str | None
        OBR.18 (opt) - Placer Field 1 (ST) S7.3.1.18

    obr_19 : str | None
        OBR.19 (opt) - Placer Field 2 (ST) S7.3.1.19

    obr_20 : str | None
        OBR.20 (opt) - Filler Field 1 + (ST) S7.3.1.20

    obr_21 : str | None
        OBR.21 (opt) - Filler Field 2 + (ST) S7.3.1.21

    obr_22 : TS | None
        OBR.22 (opt) - Results Rpt/Status Chng - Date/Time + (TS) S7.3.1.22

    obr_23 : MOC | None
        OBR.23 (opt) - Charge to Practice + (MOC) S7.3.1.23

    obr_24 : str | None
        OBR.24 (opt) - Diagnostic Serv Sect ID (ID) S7.3.1.24 | 0074 - Diagnostic service section ID

    obr_25 : str | None
        OBR.25 (opt) - Result Status + (ID) S7.3.1.25 | 0123 - Result status

    obr_26 : PRL | None
        OBR.26 (opt) - Parent Result + (PRL) S7.3.1.26

    obr_27 : list[TQ] | None
        OBR.27 (opt, rep) - Quantity/Timing (TQ) S7.3.1.27

    obr_28 : list[XCN] | None
        OBR.28 (opt, rep) - Result Copies To (XCN) S7.3.1.28

    obr_29 : EIP | None
        OBR.29 (opt) - Parent (EIP) S7.3.1.29

    obr_30 : str | None
        OBR.30 (opt) - Transportation Mode (ID) S7.3.1.30 | 0124 - Transportation mode

    obr_31 : list[CE] | None
        OBR.31 (opt, rep) - Reason for Study (CE) S7.3.1.31

    obr_32 : NDL | None
        OBR.32 (opt) - Principal Result Interpreter + (NDL) S7.3.1.32

    obr_33 : list[NDL] | None
        OBR.33 (opt, rep) - Assistant Result Interpreter + (NDL) S7.3.1.33

    obr_34 : list[NDL] | None
        OBR.34 (opt, rep) - Technician + (NDL) S7.3.1.34

    obr_35 : list[NDL] | None
        OBR.35 (opt, rep) - Transcriptionist + (NDL) S7.3.1.35

    obr_36 : TS | None
        OBR.36 (opt) - Scheduled Date/Time + (TS) S7.3.1.36

    obr_37 : str | None
        OBR.37 (opt) - Number of Sample Containers * (NM) S7.3.1.37

    obr_38 : list[CE] | None
        OBR.38 (opt, rep) - Transport Logistics of Collected Sample * (CE) S7.3.1.38

    obr_39 : list[CE] | None
        OBR.39 (opt, rep) - Collector’s Comment * (CE) S7.3.1.39

    obr_40 : CE | None
        OBR.40 (opt) - Transport Arrangement Responsibility (CE) S7.3.1.40

    obr_41 : str | None
        OBR.41 (opt) - Transport Arranged (ID) S7.3.1.41 | 0224 - Transport arranged

    obr_42 : str | None
        OBR.42 (opt) - Escort Required (ID) S7.3.1.42 | 0225 - Escort required

    obr_43 : list[CE] | None
        OBR.43 (opt, rep) - Planned Patient Transport Comment (CE) S7.3.1.43

    obr_44 : CE | None
        OBR.44 (opt) - Procedure Code (CE) S8.9.2.7 | 0088 - Procedure Code

    obr_45 : list[CE] | None
        OBR.45 (opt, rep) - Procedure Code Modifier (CE) S7.3.1.45 | 0340 - Procedure Code Modifier
    """
