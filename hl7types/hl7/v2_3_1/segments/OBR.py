...
class OBR(HL7Model):
    ...
    ----------
    obr_1 : str | None
        OBR.1 - Set ID - OBR (SI) O S7.3.1.1

    obr_2 : EI | None
        OBR.2 - Placer Order Number (EI) C S9.5.1.14

    obr_3 : EI | None
        OBR.3 - Filler Order Number (EI) C S9.5.1.15

    obr_4 : CE
        OBR.4 - Universal Service ID (CE) R S10.5.4.3

    obr_5 : str | None
        OBR.5 - Priority-OBR (ID) X S7.3.1.5

    obr_6 : TS | None
        OBR.6 - Requested Date/time (TS) X S7.3.1.6

    obr_7 : TS | None
        OBR.7 - Observation Date/Time # (TS) C S7.3.1.7

    obr_8 : TS | None
        OBR.8 - Observation End Date/Time # (TS) O S7.3.1.8

    obr_9 : CQ | None
        OBR.9 - Collection Volume * (CQ) O S7.3.1.9

    obr_10 : list[XCN] | None
        OBR.10 - Collector Identifier * (XCN) O rep S7.3.1.10

    obr_11 : str | None
        OBR.11 - Specimen Action Code * (ID) O S7.3.1.11 | 0065 - Specimen action code

    obr_12 : CE | None
        OBR.12 - Danger Code (CE) O S7.3.1.12

    obr_13 : str | None
        OBR.13 - Relevant Clinical Info. (ST) O S7.3.1.13

    obr_14 : TS | None
        OBR.14 - Specimen Received Date/Time * (TS) C S7.3.1.14

    obr_15 : SPS | None
        OBR.15 - Specimen Source (SPS) O S7.3.1.15 | 0070 - Specimen source codes

    obr_16 : list[XCN] | None
        OBR.16 - Ordering Provider (XCN) O rep S7.3.1.16

    obr_17 : list[XTN] | None
        OBR.17 - Order Callback Phone Number (XTN) O rep S7.3.1.17

    obr_18 : str | None
        OBR.18 - Placer Field 1 (ST) O S7.3.1.18

    obr_19 : str | None
        OBR.19 - Placer Field 2 (ST) O S7.3.1.19

    obr_20 : str | None
        OBR.20 - Filler Field 1 + (ST) O S7.3.1.20

    obr_21 : str | None
        OBR.21 - Filler Field 2 + (ST) O S7.3.1.21

    obr_22 : TS | None
        OBR.22 - Results Rpt/Status Chng - Date/Time + (TS) C S7.3.1.22

    obr_23 : MOC | None
        OBR.23 - Charge to Practice + (MOC) O S7.3.1.23

    obr_24 : str | None
        OBR.24 - Diagnostic Serv Sect ID (ID) O S7.3.1.24 | 0074 - Diagnostic service section ID

    obr_25 : str | None
        OBR.25 - Result Status + (ID) C S7.3.1.25 | 0123 - Result status

    obr_26 : PRL | None
        OBR.26 - Parent Result + (PRL) O S7.3.1.26

    obr_27 : list[TQ] | None
        OBR.27 - Quantity/Timing (TQ) O rep S7.3.1.27

    obr_28 : list[XCN] | None
        OBR.28 - Result Copies To (XCN) O rep S7.3.1.28

    obr_29 : EIP | None
        OBR.29 - Parent (EIP) O S7.3.1.29

    obr_30 : str | None
        OBR.30 - Transportation Mode (ID) O S7.3.1.30 | 0124 - Transportation mode

    obr_31 : list[CE] | None
        OBR.31 - Reason for Study (CE) O rep S7.3.1.31

    obr_32 : NDL | None
        OBR.32 - Principal Result Interpreter + (NDL) O S7.3.1.32

    obr_33 : list[NDL] | None
        OBR.33 - Assistant Result Interpreter + (NDL) O rep S7.3.1.33

    obr_34 : list[NDL] | None
        OBR.34 - Technician + (NDL) O rep S7.3.1.34

    obr_35 : list[NDL] | None
        OBR.35 - Transcriptionist + (NDL) O rep S7.3.1.35

    obr_36 : TS | None
        OBR.36 - Scheduled Date/Time + (TS) O S7.3.1.36

    obr_37 : str | None
        OBR.37 - Number of Sample Containers * (NM) O S7.3.1.37

    obr_38 : list[CE] | None
        OBR.38 - Transport Logistics of Collected Sample * (CE) O rep S7.3.1.38

    obr_39 : list[CE] | None
        OBR.39 - Collector’s Comment * (CE) O rep S7.3.1.39

    obr_40 : CE | None
        OBR.40 - Transport Arrangement Responsibility (CE) O S7.3.1.40

    obr_41 : str | None
        OBR.41 - Transport Arranged (ID) O S7.3.1.41 | 0224 - Transport arranged

    obr_42 : str | None
        OBR.42 - Escort Required (ID) O S7.3.1.42 | 0225 - Escort required

    obr_43 : list[CE] | None
        OBR.43 - Planned Patient Transport Comment (CE) O rep S7.3.1.43

    obr_44 : CE | None
        OBR.44 - Procedure Code (CE) O S8.9.2.7 | 0088 - Procedure Code

    obr_45 : list[CE] | None
        OBR.45 - Procedure Code Modifier (CE) O rep S7.3.1.45 | 0340 - Procedure Code Modifier
    """
    ...
    obr_5: Optional[str] = Field(
        ...
        title="Priority-OBR",
        description="X | Item #00239 | LEN:2",
    )
