...
class TXA(HL7Model):
    ...
    txa_2 : str
        TXA.2 - Document Type (IS) R S9.5.1.2 | 0270 - Document type

    txa_3 : str | None
        TXA.3 - Document Content Presentation (ID) C S9.5.1.3 | 0191 - Type of referenced data

    txa_4 : TS | None
        TXA.4 - Activity Date/Time (TS) O S9.5.1.4

    txa_5 : list[XCN] | None
        TXA.5 - Primary Activity Provider Code/Name (XCN) C rep S9.5.1.5
    ...
    txa_9 : list[XCN] | None
        TXA.9 - Originator Code/Name (XCN) O rep S9.5.1.9

    txa_10 : list[XCN] | None
        TXA.10 - Assigned Document Authenticator (XCN) O rep S9.5.1.10

    txa_11 : list[XCN] | None
        TXA.11 - Transcriptionist Code/Name (XCN) C rep S9.5.1.11
    ...
    txa_14 : list[EI] | None
        TXA.14 - Placer Order Number (EI) O rep S9.5.1.14

    txa_15 : EI | None
        TXA.15 - Filler Order Number (EI) O S9.5.1.15

    txa_16 : str | None
        TXA.16 - Unique Document File Name (ST) O S9.5.1.16

    txa_17 : str
        TXA.17 - Document Completion Status (ID) R S9.5.1.17 | 0271 - Document completion status
    ...
    txa_22 : list[PPN] | None
        TXA.22 - Authentication Person, Time Stamp (PPN) C rep S9.5.1.22
    ...
    txa_2: str = Field(
        ...
        title="Document Type",
        description="R | Item #00915 | Table 0270 - Document type | LEN:30",
    )
    ...
    txa_3: Optional[str] = Field(
        ...
        description=(
            "C | Item #00916 | Table 0191 - Type of referenced data | LEN:2"
        ),
    )
