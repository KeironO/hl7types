...
class TXA(HL7Model):
    ...
    txa_2 : str
        TXA.2 (req) - Document Type (IS) S9.5.1.2 | 0270 - Document type

    txa_3 : str | None
        TXA.3 (opt) - Document Content Presentation (ID) S9.5.1.3 | 0191 - Type of referenced data

    txa_4 : TS | None
        TXA.4 (opt) - Activity Date/Time (TS) S9.5.1.4

    txa_5 : list[XCN] | None
        TXA.5 (opt, rep) - Primary Activity Provider Code/Name (XCN) S9.5.1.5
    ...
    txa_9 : list[XCN] | None
        TXA.9 (opt, rep) - Originator Code/Name (XCN) S9.5.1.9

    txa_10 : list[XCN] | None
        TXA.10 (opt, rep) - Assigned Document Authenticator (XCN) S9.5.1.10

    txa_11 : list[XCN] | None
        TXA.11 (opt, rep) - Transcriptionist Code/Name (XCN) S9.5.1.11
    ...
    txa_14 : list[EI] | None
        TXA.14 (opt, rep) - Placer Order Number (EI) S9.5.1.14

    txa_15 : EI | None
        TXA.15 (opt) - Filler Order Number (EI) S9.5.1.15

    txa_16 : str | None
        TXA.16 (opt) - Unique Document File Name (ST) S9.5.1.16

    txa_17 : str
        TXA.17 (req) - Document Completion Status (ID) S9.5.1.17 | 0271 - Document completion status
