...
class PRD(HL7Model):
    ...
    ----------
    prd_1 : list[CE]
        PRD.1 - Provider Role (CE) R rep S11.5.3.1 | 0286 - Provider role

    prd_2 : list[XPN] | None
        PRD.2 - Provider Name (XPN) O rep S11.5.3.2

    prd_3 : list[XAD] | None
        PRD.3 - Provider Address (XAD) O rep S11.5.3.3
    ...
    prd_6 : CE | None
        PRD.6 - Preferred Method Of Contact (CE) NA S11.5.4.6 | 0185 - Preferred method of contact

    prd_7 : list[PI] | None
        PRD.7 - Provider Identifiers (PI) O rep S11.5.3.7

    prd_8 : TS | None
        PRD.8 - Effective Start Date of Provider Role (TS) O S11.5.3.8

    prd_9 : TS | None
        PRD.9 - Effective End Date of Provider Role (TS) O S11.5.3.9
    """
