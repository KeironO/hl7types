...
class ARQ(HL7Model):
    ...
    ----------
    arq_1 : EI
        ARQ.1 (req) - Placer Appointment ID (EI) S10.5.2.1

    arq_2 : EI | None
        ARQ.2 (opt) - Filler Appointment ID (EI) S10.5.2.2

    arq_3 : str | None
        ARQ.3 (opt) - Occurrence Number (NM) S10.5.2.3

    arq_4 : EI | None
        ARQ.4 (opt) - Placer Group Number (EI) S10.5.2.4

    arq_5 : CE | None
        ARQ.5 (opt) - Schedule ID (CE) S10.5.2.5

    arq_6 : CE | None
        ARQ.6 (opt) - Request Event Reason (CE) S10.5.1.6

    arq_7 : CE | None
        ARQ.7 (opt) - Appointment Reason (CE) S10.5.2.7 | 0276 - Appointment reason codes

    arq_8 : CE | None
        ARQ.8 (opt) - Appointment Type (CE) S10.5.2.8 | 0277 - Appointment type codes

    arq_9 : str | None
        ARQ.9 (opt) - Appointment Duration (NM) S10.5.2.9

    arq_10 : CE | None
        ARQ.10 (opt) - Appointment Duration Units (CE) S10.5.2.10

    arq_11 : list[DR] | None
        ARQ.11 (opt, rep) - Requested Start Date/Time Range (DR) S10.5.1.11

    arq_12 : str | None
        ARQ.12 (opt) - Priority-ARQ (ST) S10.5.1.12
    ...
    arq_15 : list[XCN]
        ARQ.15 (req, rep) - Placer Contact Person (XCN) S10.5.2.12

    arq_16 : list[XTN] | None
        ARQ.16 (opt, rep) - Placer Contact Phone Number (XTN) S10.5.2.13

    arq_17 : list[XAD] | None
        ARQ.17 (opt, rep) - Placer Contact Address (XAD) S10.5.2.14

    arq_18 : PL | None
        ARQ.18 (opt) - Placer Contact Location (PL) S10.5.2.15

    arq_19 : list[XCN]
        ARQ.19 (req, rep) - Entered by Person (XCN) S10.5.2.20

    arq_20 : list[XTN] | None
        ARQ.20 (opt, rep) - Entered by Phone Number (XTN) S10.5.2.21

    arq_21 : PL | None
        ARQ.21 (opt) - Entered by Location (PL) S10.5.2.22

    arq_22 : EI | None
        ARQ.22 (opt) - Parent Placer Appointment ID (EI) S10.5.2.23

    arq_23 : EI | None
        ARQ.23 (opt) - Parent Filler Appointment ID (EI) S10.5.2.24
    """
