...
class IN2(HL7Model):
    ...
    ----------
    in2_1 : list[CX] | None
        IN2.1 (opt, rep) - Insured’s Employee ID (CX) S6.4.7.1

    in2_2 : str | None
        IN2.2 (opt) - Insured’s Social Security Number (ST) S6.4.7.2

    in2_3 : list[XCN] | None
        IN2.3 (opt, rep) - Insured’s Employer’s Name and ID (XCN) S6.4.7.3

    in2_4 : str | None
        IN2.4 (opt) - Employer Information Data (IS) S6.4.7.4 | 0139 - Employer Information Data

    in2_5 : list[str] | None
        IN2.5 (opt, rep) - Mail Claim Party (IS) S6.4.7.5 | 0137 - Mail claim party

    in2_6 : str | None
        IN2.6 (opt) - Medicare Health Ins Card Number (ST) S6.4.7.6

    in2_7 : list[XPN] | None
        IN2.7 (opt, rep) - Medicaid Case Name (XPN) S6.4.7.7

    in2_8 : str | None
        IN2.8 (opt) - Medicaid Case Number (ST) S6.4.7.8

    in2_9 : list[XPN] | None
        IN2.9 (opt, rep) - Military Sponsor Name (XPN) S6.4.7.9

    in2_10 : str | None
        IN2.10 (opt) - Military ID Number (ST) S6.4.7.10

    in2_11 : CE | None
        IN2.11 (opt) - Dependent Of Military Recipient (CE) S6.4.7.11 | 0342 - Military recipient

    in2_12 : str | None
        IN2.12 (opt) - Military Organization (ST) S6.4.7.12

    in2_13 : str | None
        IN2.13 (opt) - Military Station (ST) S6.4.7.13

    in2_14 : str | None
        IN2.14 (opt) - Military Service (IS) S6.4.7.14 | 0140 - Military service

    in2_15 : str | None
        IN2.15 (opt) - Military Rank/Grade (IS) S6.4.7.15 | 0141 - Military rank/grade

    in2_16 : str | None
        IN2.16 (opt) - Military Status (IS) S6.4.7.16 | 0142 - Military status

    in2_17 : str | None
        IN2.17 (opt) - Military Retire Date (DT) S6.4.7.17

    in2_18 : str | None
        IN2.18 (opt) - Military Non-Avail Cert On File (ID) S6.4.7.18 | 0136 - Yes/no indicator
    ...
    in2_22 : list[XPN] | None
        IN2.22 (opt, rep) - Special Coverage Approval Name (XPN) S6.4.7.22

    in2_23 : str | None
        IN2.23 (opt) - Special Coverage Approval Title (ST) S6.4.7.23

    in2_24 : list[str] | None
        IN2.24 (opt, rep) - Non-Covered Insurance Code (IS) S6.4.7.24 | 0143 - Non-covered Insurance Code

    in2_25 : list[CX] | None
        IN2.25 (opt, rep) - Payor ID (CX) S6.4.7.25

    in2_26 : list[CX] | None
        IN2.26 (opt, rep) - Payor Subscriber ID (CX) S6.4.7.26

    in2_27 : str | None
        IN2.27 (opt) - Eligibility Source (IS) S6.4.7.27 | 0144 - Eligibility source

    in2_28 : list[RMC] | None
        IN2.28 (opt, rep) - Room Coverage Type/Amount (RMC) S6.4.7.28 | 0145 - Room type

    in2_29 : list[PTA] | None
        IN2.29 (opt, rep) - Policy Type/Amount (PTA) S6.4.7.29 | 0147 - Policy type

    in2_30 : DDI | None
        IN2.30 (opt) - Daily Deductible (DDI) S6.4.7.30

    in2_31 : str | None
        IN2.31 (opt) - Living Dependency (IS) S6.4.7.31 | 0223 - Living dependency

    in2_32 : list[str] | None
        IN2.32 (opt, rep) - Ambulatory Status (IS) S6.4.7.32 | 0009 - Ambulatory status

    in2_33 : list[CE] | None
        IN2.33 (opt, rep) - Citizenship (CE) S6.4.7.33 | 0171 - Citizenship

    in2_34 : CE | None
        IN2.34 (opt) - Primary Language (CE) S6.4.7.34 | 0296 - Primary Language

    in2_35 : str | None
        IN2.35 (opt) - Living Arrangement (IS) S6.4.7.35 | 0220 - Living arrangement

    in2_36 : CE | None
        IN2.36 (opt) - Publicity Code (CE) S6.4.7.36 | 0215 - Publicity Code

    in2_37 : str | None
        IN2.37 (opt) - Protection Indicator (ID) S6.4.7.37 | 0136 - Yes/no indicator

    in2_38 : str | None
        IN2.38 (opt) - Student Indicator (IS) S6.4.7.38 | 0231 - Student status

    in2_39 : CE | None
        IN2.39 (opt) - Religion (CE) S6.4.7.39 | 0006 - Religion

    in2_40 : list[XPN] | None
        IN2.40 (opt, rep) - Mother’s Maiden Name (XPN) S6.4.7.40

    in2_41 : CE | None
        IN2.41 (opt) - Nationality (CE) S6.4.7.41 | 0212 - Nationality

    in2_42 : list[CE] | None
        IN2.42 (opt, rep) - Ethnic Group (CE) S6.4.7.42 | 0189 - Ethnic Group

    in2_43 : list[CE] | None
        IN2.43 (opt, rep) - Marital Status (CE) S12.3.3.4 | 0002 - Marital status

    in2_44 : str | None
        IN2.44 (opt) - Insured’s Employment Start Date (DT) S6.4.7.44

    in2_45 : str | None
        IN2.45 (opt) - Employment Stop Date (DT) S6.4.7.45

    in2_46 : str | None
        IN2.46 (opt) - Job Title (ST) S8.6.2.18

    in2_47 : JCC | None
        IN2.47 (opt) - Job Code/Class (JCC) S8.6.2.19 | 0327 - Job Code/Class

    in2_48 : str | None
        IN2.48 (opt) - Job Status (IS) S6.4.7.48 | 0311 - Job Status
    ...
    in2_53 : list[XTN] | None
        IN2.53 (opt, rep) - Insured’s Contact Person Phone Number (XTN) S6.4.7.53
    ...
    in2_62 : CE | None
        IN2.62 (opt) - Guarantor’s Relationship To Insured (CE) S6.4.7.62 | 0063 - Relationship

    in2_63 : list[XTN] | None
        IN2.63 (opt, rep) - Insured’s Phone Number - Home (XTN) S6.4.7.63

    in2_64 : list[XTN] | None
        IN2.64 (opt, rep) - Insured’s Employer Phone Number (XTN) S6.4.7.64

    in2_65 : CE | None
        IN2.65 (opt) - Military Handicapped Program (CE) S6.4.7.65 | 0343 - Military Handicapped Program code

    in2_66 : str | None
        IN2.66 (opt) - Suspend Flag (ID) S6.4.7.66 | 0136 - Yes/no indicator

    in2_67 : str | None
        IN2.67 (opt) - Copay Limit Flag (ID) S6.4.7.67 | 0136 - Yes/no indicator
    ...
    in2_71 : list[CE] | None
        IN2.71 (opt, rep) - Race (CE) S6.4.7.71 | 0005 - Race

    in2_72 : CE | None
        IN2.72 (opt) - HCFA Patient’s Relationship to Insured (CE) S6.4.7.72 | 0344 - Patient’s relationship to insured
    """
