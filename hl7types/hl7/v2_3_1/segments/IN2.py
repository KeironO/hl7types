...
class IN2(HL7Model):
    """IN2 - insurance additional information segment (S6.4.7).

    Attributes
    ----------
    in2_1 : list[CX] | None
        IN2.1 - Insured’s Employee ID (CX) O rep S6.4.7.1

    in2_2 : str | None
        IN2.2 - Insured’s Social Security Number (ST) O S6.4.7.2

    in2_3 : list[XCN] | None
        IN2.3 - Insured’s Employer’s Name and ID (XCN) O rep S6.4.7.3

    in2_4 : str | None
        IN2.4 - Employer Information Data (IS) O S6.4.7.4 | 0139 - Employer Information Data

    in2_5 : list[str] | None
        IN2.5 - Mail Claim Party (IS) O rep S6.4.7.5 | 0137 - Mail claim party

    in2_6 : str | None
        IN2.6 - Medicare Health Ins Card Number (ST) O S6.4.7.6

    in2_7 : list[XPN] | None
        IN2.7 - Medicaid Case Name (XPN) O rep S6.4.7.7

    in2_8 : str | None
        IN2.8 - Medicaid Case Number (ST) O S6.4.7.8

    in2_9 : list[XPN] | None
        IN2.9 - Military Sponsor Name (XPN) O rep S6.4.7.9

    in2_10 : str | None
        IN2.10 - Military ID Number (ST) O S6.4.7.10

    in2_11 : CE | None
        IN2.11 - Dependent Of Military Recipient (CE) O S6.4.7.11 | 0342 - Military recipient

    in2_12 : str | None
        IN2.12 - Military Organization (ST) O S6.4.7.12

    in2_13 : str | None
        IN2.13 - Military Station (ST) O S6.4.7.13

    in2_14 : str | None
        IN2.14 - Military Service (IS) O S6.4.7.14 | 0140 - Military service

    in2_15 : str | None
        IN2.15 - Military Rank/Grade (IS) O S6.4.7.15 | 0141 - Military rank/grade

    in2_16 : str | None
        IN2.16 - Military Status (IS) O S6.4.7.16 | 0142 - Military status

    in2_17 : str | None
        IN2.17 - Military Retire Date (DT) O S6.4.7.17

    in2_18 : str | None
        IN2.18 - Military Non-Avail Cert On File (ID) O S6.4.7.18 | 0136 - Yes/no indicator

    in2_19 : str | None
        IN2.19 - Baby Coverage (ID) O S6.4.7.19 | 0136 - Yes/no indicator

    in2_20 : str | None
        IN2.20 - Combine Baby Bill (ID) O S6.4.7.20 | 0136 - Yes/no indicator

    in2_21 : str | None
        IN2.21 - Blood Deductible (ST) O S6.4.7.21

    in2_22 : list[XPN] | None
        IN2.22 - Special Coverage Approval Name (XPN) O rep S6.4.7.22

    in2_23 : str | None
        IN2.23 - Special Coverage Approval Title (ST) O S6.4.7.23

    in2_24 : list[str] | None
        IN2.24 - Non-Covered Insurance Code (IS) O rep S6.4.7.24 | 0143 - Non-covered Insurance Code

    in2_25 : list[CX] | None
        IN2.25 - Payor ID (CX) O rep S6.4.7.25

    in2_26 : list[CX] | None
        IN2.26 - Payor Subscriber ID (CX) O rep S6.4.7.26

    in2_27 : str | None
        IN2.27 - Eligibility Source (IS) O S6.4.7.27 | 0144 - Eligibility source

    in2_28 : list[RMC] | None
        IN2.28 - Room Coverage Type/Amount (RMC) O rep S6.4.7.28 | 0145 - Room type

    in2_29 : list[PTA] | None
        IN2.29 - Policy Type/Amount (PTA) O rep S6.4.7.29 | 0147 - Policy type

    in2_30 : DDI | None
        IN2.30 - Daily Deductible (DDI) O S6.4.7.30

    in2_31 : str | None
        IN2.31 - Living Dependency (IS) O S6.4.7.31 | 0223 - Living dependency

    in2_32 : list[str] | None
        IN2.32 - Ambulatory Status (IS) O rep S6.4.7.32 | 0009 - Ambulatory status

    in2_33 : list[CE] | None
        IN2.33 - Citizenship (CE) O rep S6.4.7.33 | 0171 - Citizenship

    in2_34 : CE | None
        IN2.34 - Primary Language (CE) O S6.4.7.34 | 0296 - Primary Language

    in2_35 : str | None
        IN2.35 - Living Arrangement (IS) O S6.4.7.35 | 0220 - Living arrangement

    in2_36 : CE | None
        IN2.36 - Publicity Code (CE) O S6.4.7.36 | 0215 - Publicity Code

    in2_37 : str | None
        IN2.37 - Protection Indicator (ID) O S6.4.7.37 | 0136 - Yes/no indicator

    in2_38 : str | None
        IN2.38 - Student Indicator (IS) O S6.4.7.38 | 0231 - Student status

    in2_39 : CE | None
        IN2.39 - Religion (CE) O S6.4.7.39 | 0006 - Religion

    in2_40 : list[XPN] | None
        IN2.40 - Mother’s Maiden Name (XPN) O rep S6.4.7.40

    in2_41 : CE | None
        IN2.41 - Nationality (CE) O S6.4.7.41 | 0212 - Nationality

    in2_42 : list[CE] | None
        IN2.42 - Ethnic Group (CE) O rep S6.4.7.42 | 0189 - Ethnic Group

    in2_43 : list[CE] | None
        IN2.43 - Marital Status (CE) O rep S12.3.3.4 | 0002 - Marital status

    in2_44 : str | None
        IN2.44 - Insured’s Employment Start Date (DT) O S6.4.7.44

    in2_45 : str | None
        IN2.45 - Employment Stop Date (DT) O S6.4.7.45

    in2_46 : str | None
        IN2.46 - Job Title (ST) O S8.6.2.18

    in2_47 : JCC | None
        IN2.47 - Job Code/Class (JCC) O S8.6.2.19 | 0327 - Job Code/Class

    in2_48 : str | None
        IN2.48 - Job Status (IS) O S6.4.7.48 | 0311 - Job Status

    in2_49 : list[XPN] | None
        IN2.49 - Employer Contact Person Name (XPN) O rep S6.4.7.49

    in2_50 : list[XTN] | None
        IN2.50 - Employer Contact Person Phone Number (XTN) O rep S6.4.7.50

    in2_51 : str | None
        IN2.51 - Employer Contact Reason (IS) O S6.4.7.51 | 0222 - Contact Reason

    in2_52 : list[XPN] | None
        IN2.52 - Insured’s Contact Person’s Name (XPN) O rep S6.4.7.52

    in2_53 : list[XTN] | None
        IN2.53 - Insured’s Contact Person Phone Number (XTN) O rep S6.4.7.53

    in2_54 : list[str] | None
        IN2.54 - Insured’s Contact Person Reason (IS) O rep S6.4.7.54 | 0222 - Contact Reason

    in2_55 : str | None
        IN2.55 - Relationship To The Patient Start Date (DT) O S6.4.7.55

    in2_56 : list[str] | None
        IN2.56 - Relationship To The Patient Stop Date (DT) O rep S6.4.7.56

    in2_57 : str | None
        IN2.57 - Insurance Co. Contact Reason (IS) O S6.4.7.57 | 0232 - Insurance company contact reason

    in2_58 : XTN | None
        IN2.58 - Insurance Co Contact Phone Number (XTN) O S6.4.7.58

    in2_59 : str | None
        IN2.59 - Policy Scope (IS) O S6.4.7.59 | 0312 - Policy Scope

    in2_60 : str | None
        IN2.60 - Policy Source (IS) O S6.4.7.60 | 0313 - Policy Source

    in2_61 : CX | None
        IN2.61 - Patient Member Number (CX) O S6.4.7.61

    in2_62 : CE | None
        IN2.62 - Guarantor’s Relationship To Insured (CE) O S6.4.7.62 | 0063 - Relationship

    in2_63 : list[XTN] | None
        IN2.63 - Insured’s Phone Number - Home (XTN) O rep S6.4.7.63

    in2_64 : list[XTN] | None
        IN2.64 - Insured’s Employer Phone Number (XTN) O rep S6.4.7.64

    in2_65 : CE | None
        IN2.65 - Military Handicapped Program (CE) O S6.4.7.65 | 0343 - Military Handicapped Program code

    in2_66 : str | None
        IN2.66 - Suspend Flag (ID) O S6.4.7.66 | 0136 - Yes/no indicator

    in2_67 : str | None
        IN2.67 - Copay Limit Flag (ID) O S6.4.7.67 | 0136 - Yes/no indicator

    in2_68 : str | None
        IN2.68 - Stoploss Limit Flag (ID) O S6.4.7.68 | 0136 - Yes/no indicator

    in2_69 : list[XON] | None
        IN2.69 - Insured Organization Name And ID (XON) O rep S6.4.7.69

    in2_70 : list[XON] | None
        IN2.70 - Insured Employer Organization Name And ID (XON) O rep S6.4.7.70

    in2_71 : list[CE] | None
        IN2.71 - Race (CE) O rep S6.4.7.71 | 0005 - Race

    in2_72 : CE | None
        IN2.72 - HCFA Patient’s Relationship to Insured (CE) O S6.4.7.72 | 0344 - Patient’s relationship to insured
    """
