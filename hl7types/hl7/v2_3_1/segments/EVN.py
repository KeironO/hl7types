...
class EVN(HL7Model):
    ...
    ----------
    evn_1 : str | None
        EVN.1 (opt) - Event Type Code (ID) S3.3.1.1 | 0003 - Event type

    evn_2 : TS
        EVN.2 (req) - Recorded Date/Time (TS) S3.3.1.2

    evn_3 : TS | None
        EVN.3 (opt) - Date/Time Planned Event (TS) S3.3.1.3

    evn_4 : str | None
        EVN.4 (opt) - Event Reason Code (IS) S3.3.1.4 | 0062 - Event reason

    evn_5 : list[XCN] | None
        EVN.5 (opt, rep) - Operator ID (XCN) S3.3.1.5 | 0188 - Operator ID

    evn_6 : TS | None
        EVN.6 (opt) - Event Occurred (TS) S3.3.1.6
    """
