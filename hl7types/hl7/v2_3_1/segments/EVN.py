...
class EVN(HL7Model):
    """EVN - event type segment (S3.3.1).

    Attributes
    ----------
    evn_1 : str | None
        EVN.1 - Event Type Code (ID) O S3.3.1.1 | 0003 - Event type

    evn_2 : TS
        EVN.2 - Recorded Date/Time (TS) R S3.3.1.2

    evn_3 : TS | None
        EVN.3 - Date/Time Planned Event (TS) O S3.3.1.3

    evn_4 : str | None
        EVN.4 - Event Reason Code (IS) O S3.3.1.4 | 0062 - Event reason

    evn_5 : list[XCN] | None
        EVN.5 - Operator ID (XCN) O rep S3.3.1.5 | 0188 - Operator ID

    evn_6 : TS | None
        EVN.6 - Event Occurred (TS) O S3.3.1.6
    """
