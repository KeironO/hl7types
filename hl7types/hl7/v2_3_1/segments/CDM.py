...
class CDM(HL7Model):
    ...
    ----------
    cdm_1 : CE
        CDM.1 (req) - Primary Key Value - CDM (CE) S8.9.2.1 | 0132 - Transaction Code
    ...
    cdm_5 : str | None
        CDM.5 (opt) - Description Override Indicator (IS) S8.9.2.5 | 0268 - Override

    cdm_6 : list[CE] | None
        CDM.6 (opt, rep) - Exploding Charges (CE) S8.9.2.6

    cdm_7 : list[CE] | None
        CDM.7 (opt, rep) - Procedure Code (CE) S8.9.2.7 | 0088 - Procedure Code

    cdm_8 : str | None
        CDM.8 (opt) - Active/Inactive Flag (ID) S8.9.3.16 | 0183 - Active/inactive
    ...
    cdm_12 : list[XON] | None
        CDM.12 (opt, rep) - Contract Organization (XON) S8.9.2.12
