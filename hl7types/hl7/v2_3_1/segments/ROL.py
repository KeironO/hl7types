...
class ROL(HL7Model):
    ...
    rol_2 : str
        ROL.2 (req) - Action Code (ID) S12.3.4.1 | 0287 - Problem/Goal Action code

    rol_3 : CE
        ROL.3 (req) - Role-ROL (CE) S12.3.3.3

    rol_4 : list[XCN]
        ROL.4 (req, rep) - Role Person (XCN) S12.3.3.4
    ...
    rol_8 : CE | None
        ROL.8 (opt) - Role Action Reason (CE) S12.3.3.8
    """
