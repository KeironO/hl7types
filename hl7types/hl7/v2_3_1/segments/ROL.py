...
class ROL(HL7Model):
    ...
    rol_2 : str
        ROL.2 - Action Code (ID) R S12.3.4.1 | 0287 - Problem/Goal Action code

    rol_3 : CE
        ROL.3 - Role-ROL (CE) R S12.3.3.3

    rol_4 : list[XCN]
        ROL.4 - Role Person (XCN) R rep S12.3.3.4
    ...
    rol_8 : CE | None
        ROL.8 - Role Action Reason (CE) O S12.3.3.8
    """
