...
class LCH(HL7Model):
    """LCH - location characteristic segment (S8.8.3).

    Attributes
    ----------
    lch_1 : PL
        LCH.1 - Primary Key Value - LCH (PL) R S8.8.3.1

    lch_2 : str | None
        LCH.2 - Segment Action Code (ID) O S10.5.7.2 | 0206 - Segment action code

    lch_3 : EI | None
        LCH.3 - Segment Unique Key (EI) O S8.8.4.3

    lch_4 : CE
        LCH.4 - Location Characteristic ID (CE) R S8.8.3.4 | 0324 - Location characteristic ID

    lch_5 : CE | None
        LCH.5 - Location Characteristic Value (CE) O S8.8.3.5
    """
