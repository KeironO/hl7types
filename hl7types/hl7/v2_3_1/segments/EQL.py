...
class EQL(HL7Model):
    """EQL - embedded query language segment (S2.24.16.4).

    Attributes
    ----------
    eql_1 : str | None
        EQL.1 - Query Tag (ST) O S2.24.22.1

    eql_2 : str
        EQL.2 - Query/ Response Format Code (ID) R S2.24.20.2 | 0106 - Query/response format code

    eql_3 : CE
        EQL.3 - EQL  Query Name (CE) R S2.24.16.3

    eql_4 : str
        EQL.4 - EQL  Query Statement (ST) R S2.24.16.4
    """
