...
class CSS(HL7Model):
    """CSS - clinical study data schedule segment (S7.7.3).

    Attributes
    ----------
    css_1 : CE
        CSS.1 - Study Scheduled Time Point (CE) R S7.7.4.3

    css_2 : TS | None
        CSS.2 - Study Scheduled Patient Time Point (TS) O S7.7.3.2

    css_3 : list[CE] | None
        CSS.3 - Study Quality Control Codes (CE) O rep S7.7.3.3
    """
