...
class FAC(HL7Model):
    ...
    ----------
    fac_1 : EI
        FAC.1 (req) - Facility ID-FAC (EI) S7.11.6.1

    fac_2 : str | None
        FAC.2 (opt) - Facility Type (ID) S7.11.6.2 | 0331 - Facility type

    fac_3 : list[XAD]
        FAC.3 (req, rep) - Facility Address (XAD) S7.11.6.3

    fac_4 : XTN
        FAC.4 (req) - Facility Telecommunication (XTN) S7.11.6.4

    fac_5 : list[XCN] | None
        FAC.5 (opt, rep) - Contact Person (XCN) S7.11.6.5

    fac_6 : list[str] | None
        FAC.6 (opt, rep) - Contact Title (ST) S7.11.6.6

    fac_7 : list[XAD] | None
        FAC.7 (opt, rep) - Contact Address (XAD) S11.5.4.3

    fac_8 : list[XTN] | None
        FAC.8 (opt, rep) - Contact Telecommunication (XTN) S7.11.6.8

    fac_9 : list[XCN]
        FAC.9 (req, rep) - Signature Authority (XCN) S7.11.6.9

    fac_10 : str | None
        FAC.10 (opt) - Signature Authority Title (ST) S7.11.6.10

    fac_11 : list[XAD] | None
        FAC.11 (opt, rep) - Signature Authority Address (XAD) S7.11.6.11

    fac_12 : XTN | None
        FAC.12 (opt) - Signature Authority Telecommunication (XTN) S7.11.6.12
    """
