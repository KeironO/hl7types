...
class FAC(HL7Model):
    """FAC - facility segment (S7.11.6).

    Attributes
    ----------
    fac_1 : EI
        FAC.1 - Facility ID-FAC (EI) R S7.11.6.1

    fac_2 : str | None
        FAC.2 - Facility Type (ID) O S7.11.6.2 | 0331 - Facility type

    fac_3 : list[XAD]
        FAC.3 - Facility Address (XAD) R rep S7.11.6.3
    ...
    fac_7 : list[XAD] | None
        FAC.7 - Contact Address (XAD) O rep S11.5.4.3

    fac_8 : list[XTN] | None
        FAC.8 - Contact Telecommunication (XTN) O rep S7.11.6.8

    fac_9 : list[XCN]
        FAC.9 - Signature Authority (XCN) R rep S7.11.6.9

    fac_10 : str | None
        FAC.10 - Signature Authority Title (ST) O S7.11.6.10

    fac_11 : list[XAD] | None
        FAC.11 - Signature Authority Address (XAD) O rep S7.11.6.11
