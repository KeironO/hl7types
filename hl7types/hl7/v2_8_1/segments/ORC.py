...
class ORC(HL7Model):
    ...
    orc_4 : EIP | None
        ORC.4 - Placer Group Number (EIP) O S10.6.1.4
    ...
    orc_8 : EIP | None
        ORC.8 - Parent Order (EIP) O S4.5.1.8
    ...
    orc_32 : str | None
        ORC.32 - Advanced Beneficiary Notice Date (DT) O S4.5.1.32

    orc_33 : list[CX] | None
        ORC.33 - Alternate Placer Order Number (CX) O rep S4.5.1.33

    orc_34 : list[CWE] | None
        ORC.34 - Order Workflow Profile (CWE) O rep S4.5.1.34 | 0934 - Order Workflow Profile
    """
    ...
    orc_34: Optional[List[CWE]] = Field(
        ...
        description="O | Item #03387 | Table 0934 - Order Workflow Profile",
    )
