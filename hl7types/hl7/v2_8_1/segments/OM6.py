...
class OM6(HL7Model):
    """Observations that are Calculated from Other Observations (S8.8.13).

    Attributes
    ----------
    om6_1 : str | None
        OM6.1 (opt) - Sequence Number - Test/Observation Master File (NM) S8.8.10.1

    om6_2 : str | None
        OM6.2 (opt) - Derivation Rule (TX) S8.8.13.2
    """
