...
class RXR(HL7Model):
    ...
    ----------
    rxr_1 : CWE
        RXR.1 - Route (CWE) R S4.A.2.1 | 0162 - Route of Administration

    rxr_2 : CWE | None
        RXR.2 - Administration Site (CWE) O S4.A.2.2 | 0550 - Body Parts

    rxr_3 : CWE | None
        RXR.3 - Administration Device (CWE) O S4.A.2.3 | 0164 - Administration Device

    rxr_4 : CWE | None
        RXR.4 - Administration Method (CWE) O S4.A.2.4 | 0165 - Administration Method

    rxr_5 : CWE | None
        RXR.5 - Routing Instruction (CWE) O S4.A.2.5 | 9999 - no table for CE

    rxr_6 : CWE | None
        RXR.6 - Administration Site Modifier (CWE) O S4.A.2.6 | 0495 - Body Site Modifier
    """
