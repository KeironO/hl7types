...
class OM4(HL7Model):
    ...
    om4_3 : list[str] | None
        OM4.3 - Container Description (TX) O rep S8.8.11.3

    om4_4 : list[str] | None
        OM4.4 - Container Volume (NM) O rep S13.4.3.21

    om4_5 : list[CWE] | None
        OM4.5 - Container Units (CWE) O rep S8.8.11.5 | 9999 - no table for CE

    om4_6 : CWE | None
        OM4.6 - Specimen (CWE) O S8.8.11.6 | 9999 - no table for CE
    ...
    om4_16 : str | None
        OM4.16 - Specimen Preference (ID) O S8.8.11.16 | 0920 - Preferred Specimen/Attribute Status

    om4_17 : str | None
        OM4.17 - Preferred Specimen/Attribture Sequence ID (NM) O S8.8.11.17
