...
class PV2(HL7Model):
    ...
    pv2_7 : list[CWE] | None
        PV2.7 - Visit User Code (CWE) O rep S3.4.4.7 | 0130 - Visit User Code
    ...
    pv2_16 : CWE | None
        PV2.16 - Purge Status Code (CWE) O S3.4.4.16 | 0213 - Purge Status Code

    pv2_17 : str | None
        PV2.17 - Purge Status Date (DT) O S3.4.4.17

    pv2_18 : CWE | None
        PV2.18 - Special Program Code (CWE) O S3.4.4.18 | 0214 - Special Program Code
    ...
    pv2_21 : CWE | None
        PV2.21 - Visit Publicity Code (CWE) O S3.4.4.21 | 0215 - Publicity Code
    ...
    pv2_24 : CWE | None
        PV2.24 - Patient Status Code (CWE) O S3.4.4.24 | 0216 - Patient Status Code

    pv2_25 : CWE | None
        PV2.25 - Visit Priority Code (CWE) O S3.4.4.25 | 0217 - Visit Priority Code

    pv2_26 : str | None
        PV2.26 - Previous Treatment Date (DT) O S3.4.4.26

    pv2_27 : CWE | None
        PV2.27 - Expected Discharge Disposition (CWE) O S3.4.4.27 | 0112 - Discharge Disposition
    ...
    pv2_31 : CWE | None
        PV2.31 - Recurring Service Code (CWE) O S3.4.4.31 | 0219 - Recurring Service Code
    ...
    pv2_43 : CWE | None
        PV2.43 - Living Will Code (CWE) O S3.4.11.7 | 0315 - Living Will Code

    pv2_44 : CWE | None
        PV2.44 - Organ Donor Code (CWE) O S3.4.11.8 | 0316 - Organ Donor Code

    pv2_45 : list[CWE] | None
        PV2.45 - Advance Directive Code (CWE) C rep S3.4.11.15 | 0435 - Advance Directive Code
    ...
    pv2_49 : list[CWE] | None
        PV2.49 - Notify Clergy Code (CWE) O rep S3.4.4.49 | 0534 - Notify Clergy Code

    pv2_50 : str | None
        PV2.50 - Advance Directive Last Verified Date (DT) O S3.4.11.22
    """
    ...
    pv2_7: Optional[List[CWE]] = Field(
        ...
        description="O | Item #00187 | Table 0130 - Visit User Code",
    )
    ...
    pv2_16: Optional[CWE] = Field(
        ...
        description="O | Item #00717 | Table 0213 - Purge Status Code",
    )
    ...
    pv2_18: Optional[CWE] = Field(
        ...
        description="O | Item #00719 | Table 0214 - Special Program Code",
    )
    ...
    pv2_21: Optional[CWE] = Field(
        ...
        description="O | Item #00722 | Table 0215 - Publicity Code",
    )
    ...
    pv2_24: Optional[CWE] = Field(
        ...
        description="O | Item #00725 | Table 0216 - Patient Status Code",
    )
    ...
    pv2_25: Optional[CWE] = Field(
        ...
        description="O | Item #00726 | Table 0217 - Visit Priority Code",
    )
    ...
    pv2_27: Optional[CWE] = Field(
        ...
        description="O | Item #00728 | Table 0112 - Discharge Disposition",
    )
    ...
    pv2_31: Optional[CWE] = Field(
        ...
        description="O | Item #00732 | Table 0219 - Recurring Service Code",
    )
    ...
    pv2_49: Optional[List[CWE]] = Field(
        ...
        description="O | Item #01842 | Table 0534 - Notify Clergy Code",
    )
