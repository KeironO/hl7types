...
class PCR(HL7Model):
    ...
    pcr_9 : CWE | None
        PCR.9 (opt) - Single Use Device (CWE) S7.12.3.9 | 0244 - Single Use Device

    pcr_10 : CWE | None
        PCR.10 (opt) - Indication For Product Use (CWE) S7.12.3.10 | 9999 - no table for CE

    pcr_11 : CWE | None
        PCR.11 (opt) - Product Problem (CWE) S7.12.3.11 | 0245 - Product Problem

    pcr_12 : list[str] | None
        PCR.12 (opt, rep) - Product Serial/Lot Number (ST) S7.12.3.12

    pcr_13 : CWE | None
        PCR.13 (opt) - Product Available For Inspection (CWE) S7.12.3.13 | 0246 - Product Available for Inspection
