...
class APR(HL7Model):
    """Appointment Preferences (S10.6.8).

    Attributes
    ----------
    apr_1 : list[SCV] | None
        APR.1 - Time Selection Criteria (SCV) O rep S10.6.8.1 | 0294 - Time Selection Criteria Parameter Class Codes

    apr_2 : list[SCV] | None
        APR.2 - Resource Selection Criteria (SCV) O rep S10.6.8.2 | 0294 - Time Selection Criteria Parameter Class Codes

    apr_3 : list[SCV] | None
        APR.3 - Location Selection Criteria (SCV) O rep S10.6.8.3 | 0294 - Time Selection Criteria Parameter Class Codes

    apr_4 : str | None
        APR.4 - Slot Spacing Criteria (NM) O S10.6.8.4

    apr_5 : list[SCV] | None
        APR.5 - Filler Override Criteria (SCV) O rep S10.6.8.5
    """
