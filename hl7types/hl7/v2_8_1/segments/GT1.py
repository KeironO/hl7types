...
class GT1(HL7Model):
    ...
    gt1_8 : str | None
        GT1.8 (opt) - Guarantor Date/Time Of Birth (DTM)

    gt1_9 : CWE | None
        GT1.9 (opt) - Guarantor Administrative Sex (CWE)

    gt1_10 : CWE | None
        GT1.10 (opt) - Guarantor Type (CWE)

    gt1_11 : CWE | None
        GT1.11 (opt) - Guarantor Relationship (CWE)
    ...
    gt1_20 : CWE | None
        GT1.20 (opt) - Guarantor Employment Status (CWE)
    ...
    gt1_23 : CWE | None
        GT1.23 (opt) - Guarantor Credit Rating Code (CWE)

    gt1_24 : str | None
        GT1.24 (opt) - Guarantor Death Date And Time (DTM)

    gt1_25 : str | None
        GT1.25 (opt) - Guarantor Death Flag (ID)

    gt1_26 : CWE | None
        GT1.26 (opt) - Guarantor Charge Adjustment Code (CWE)
    ...
    gt1_30 : CWE | None
        GT1.30 (opt) - Guarantor Marital Status Code (CWE)
    ...
    gt1_33 : CWE | None
        GT1.33 (opt) - Living Dependency (CWE)

    gt1_34 : list[CWE] | None
        GT1.34 (opt, rep) - Ambulatory Status (CWE)

    gt1_35 : list[CWE] | None
        GT1.35 (opt, rep) - Citizenship (CWE)

    gt1_36 : CWE | None
        GT1.36 (opt) - Primary Language (CWE)

    gt1_37 : CWE | None
        GT1.37 (opt) - Living Arrangement (CWE)

    gt1_38 : CWE | None
        GT1.38 (opt) - Publicity Code (CWE)

    gt1_39 : str | None
        GT1.39 (opt) - Protection Indicator (ID)

    gt1_40 : CWE | None
        GT1.40 (opt) - Student Indicator (CWE)

    gt1_41 : CWE | None
        GT1.41 (opt) - Religion (CWE)

    gt1_42 : list[XPN] | None
        GT1.42 (opt, rep) - Mother's Maiden Name (XPN)

    gt1_43 : CWE | None
        GT1.43 (opt) - Nationality (CWE)

    gt1_44 : list[CWE] | None
        GT1.44 (opt, rep) - Ethnic Group (CWE)
    ...
    gt1_47 : CWE | None
        GT1.47 (opt) - Contact Reason (CWE)

    gt1_48 : CWE | None
        GT1.48 (opt) - Contact Relationship (CWE)
    ...
    gt1_52 : CWE | None
        GT1.52 (opt) - Handicap (CWE)

    gt1_53 : CWE | None
        GT1.53 (opt) - Job Status (CWE)

    gt1_54 : FC | None
        GT1.54 (opt) - Guarantor Financial Class (FC)

    gt1_55 : list[CWE] | None
        GT1.55 (opt, rep) - Guarantor Race (CWE)

    gt1_56 : str | None
        GT1.56 (opt) - Guarantor Birth Place (ST)

    gt1_57 : CWE | None
        GT1.57 (opt) - VIP Indicator (CWE)
    """
