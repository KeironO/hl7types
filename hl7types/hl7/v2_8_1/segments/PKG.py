...
class PKG(HL7Model):
    ...
    pkg_8 : CWE | None
        PKG.8 - Global Trade Item Number (CWE) O S17.4.5.8
    """
    ...
    pkg_1: str = Field(
        ...
        title="Set Id - PKG",
        description="R | Item #02221 | LEN:4",
    )
    ...
    @field_validator("pkg_4", mode='before')
    @classmethod
    ...
    @field_validator("pkg_7", mode='before')
    @classmethod
