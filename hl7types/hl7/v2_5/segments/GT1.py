...
class GT1(HL7Model):
    ...
    gt1_33 : str | None
        GT1.33 (opt) - Living Dependency (IS) S3.4.5.17 | 0223 - Living Dependency

    gt1_34 : list[str] | None
        GT1.34 (opt, rep) - Ambulatory Status (IS) S3.4.3.15 | 0009 - Ambulatory Status

    gt1_35 : list[CE] | None
        GT1.35 (opt, rep) - Citizenship (CE) S3.4.2.26 | 0171 - Citizenship

    gt1_36 : CE | None
        GT1.36 (opt) - Primary Language (CE) S3.4.2.15 | 0296 - Primary Language

    gt1_37 : str | None
        GT1.37 (opt) - Living Arrangement (IS) S3.4.5.21 | 0220 - Living Arrangement

    gt1_38 : CE | None
        GT1.38 (opt) - Publicity Code (CE) S3.4.5.22 | 0215 - Publicity Code

    gt1_39 : str | None
        GT1.39 (opt) - Protection Indicator (ID) S3.4.5.23 | 0136 - Yes/no indicator

    gt1_40 : str | None
        GT1.40 (opt) - Student Indicator (IS) S3.4.5.24 | 0231 - Student Status
    ...
    gt1_44 : list[CE] | None
        GT1.44 (opt, rep) - Ethnic Group (CE) S3.4.2.22 | 0189 - Ethnic Group
    ...
    gt1_49 : str | None
        GT1.49 (opt) - Job Title (ST) S6.5.5.49
    ...
    gt1_52 : str | None
        GT1.52 (opt) - Handicap (IS) S3.4.5.36 | 0295 - Handicap
