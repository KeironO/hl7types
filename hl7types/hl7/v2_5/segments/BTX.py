...
class BTX(HL7Model):
    ...
    btx_13 : TS
        BTX.13 (req) - BP Date/Time of Status (TS)

    btx_14 : XCN | None
        BTX.14 (opt) - BP Administrator (XCN)

    btx_15 : XCN | None
        BTX.15 (opt) - BP Verifier (XCN)

    btx_16 : TS | None
        BTX.16 (opt) - BP Transfusion Start Date/Time of Status (TS)

    btx_17 : TS | None
        BTX.17 (opt) - BP Transfusion End Date/Time of Status (TS)
