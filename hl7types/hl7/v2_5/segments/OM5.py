...
class OM5(HL7Model):
    ...
    ----------
    om5_1 : str | None
        OM5.1 - Sequence Number - Test/Observation Master File (NM) O S8.8.8.1

    om5_2 : list[CE] | None
        OM5.2 - Test/Observations Included within an Ordered Test Battery (CE) O rep S8.8.12.2 | 9999 - no table for CE
