...
class IN2(BaseModel):
    ...
    in2_5 : list[str] | None
        IN2.5 (opt, rep) - Mail Claim Party (IS)
    ...
    in2_11 : CE | None
        IN2.11 (opt) - Dependent Of Military Recipient (CE)
    ...
    in2_14 : str | None
        IN2.14 (opt) - Military Service (IS)

    in2_15 : str | None
        IN2.15 (opt) - Military Rank/Grade (IS)

    in2_16 : str | None
        IN2.16 (opt) - Military Status (IS)
    ...
    in2_24 : list[str] | None
        IN2.24 (opt, rep) - Non-Covered Insurance Code (IS)
    ...
    in2_32 : list[str] | None
        IN2.32 (opt, rep) - Ambulatory Status (IS)

    in2_33 : list[CE] | None
        IN2.33 (opt, rep) - Citizenship (CE)
    ...
    in2_39 : CE | None
        IN2.39 (opt) - Religion (CE)

    in2_40 : list[XPN] | None
        IN2.40 (opt, rep) - Mother's Maiden Name (XPN)

    in2_41 : CE | None
        IN2.41 (opt) - Nationality (CE)

    in2_42 : list[CE] | None
        IN2.42 (opt, rep) - Ethnic Group (CE)

    in2_43 : list[CE] | None
        IN2.43 (opt, rep) - Marital Status (CE)
    ...
    in2_62 : CE | None
        IN2.62 (opt) - Guarantor's Relationship To Insured (CE)
    ...
    in2_71 : list[CE] | None
        IN2.71 (opt, rep) - Race (CE)

    in2_72 : CE | None
        IN2.72 (opt) - CMS Patient_s Relationship to Insured (CE)
    """
