...
class IN2(HL7Model):
    ...
    in2_15 : str | None
        IN2.15 (opt) - Military Rank/Grade (IS) S3.4.10.20 | 0141 - Military Rank/Grade
    ...
    in2_31 : str | None
        IN2.31 (opt) - Living Dependency (IS) S3.4.5.17 | 0223 - Living Dependency

    in2_32 : list[str] | None
        IN2.32 (opt, rep) - Ambulatory Status (IS) S3.4.3.15 | 0009 - Ambulatory Status

    in2_33 : list[CE] | None
        IN2.33 (opt, rep) - Citizenship (CE) S3.4.2.26 | 0171 - Citizenship

    in2_34 : CE | None
        IN2.34 (opt) - Primary Language (CE) S3.4.2.15 | 0296 - Primary Language

    in2_35 : str | None
        IN2.35 (opt) - Living Arrangement (IS) S3.4.5.21 | 0220 - Living Arrangement

    in2_36 : CE | None
        IN2.36 (opt) - Publicity Code (CE) S3.4.5.22 | 0215 - Publicity Code

    in2_37 : str | None
        IN2.37 (opt) - Protection Indicator (ID) S3.4.5.23 | 0136 - Yes/no indicator

    in2_38 : str | None
        IN2.38 (opt) - Student Indicator (IS) S3.4.5.24 | 0231 - Student Status

    in2_39 : CE | None
        IN2.39 (opt) - Religion (CE) S3.4.2.17 | 0006 - Religion

    in2_40 : list[XPN] | None
        IN2.40 (opt, rep) - Mother's Maiden Name (XPN) S3.4.2.6

    in2_41 : CE | None
        IN2.41 (opt) - Nationality (CE) S3.4.2.28 | 0212 - Nationality

    in2_42 : list[CE] | None
        IN2.42 (opt, rep) - Ethnic Group (CE) S3.4.2.22 | 0189 - Ethnic Group

    in2_43 : list[CE] | None
        IN2.43 (opt, rep) - Marital Status (CE) S3.4.2.16 | 0002 - Marital Status
    ...
    in2_46 : str | None
        IN2.46 (opt) - Job Title (ST) S6.5.5.49

    in2_47 : JCC | None
        IN2.47 (opt) - Job Code/Class (JCC) S6.5.5.50

    in2_48 : str | None
        IN2.48 (opt) - Job Status (IS) S3.4.5.34 | 0311 - Job Status
    ...
    in2_71 : list[CE] | None
        IN2.71 (opt, rep) - Race (CE) S3.4.2.10 | 0005 - Race

    in2_72 : CE | None
        IN2.72 (opt) - CMS Patient_s Relationship to Insured (CE) S6.5.7.72 | 0344 - Patient's Relationship to Insured
    """
    ...
    in2_72: Optional[CE] = Field(
        ...
        validation_alias=AliasChoices(
            "in2_72",
            "cms_patient_s_relationship_to_insured",
            "IN2.72",
        ),
        serialization_alias="IN2.72",
        title="CMS Patient_s Relationship to Insured",
