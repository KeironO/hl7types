...
class IN2(HL7Model):
    ...
    in2_15 : str | None
        IN2.15 - Military Rank/Grade (IS) O S3.4.10.20 | 0141 - Military Rank/Grade
    ...
    in2_31 : str | None
        IN2.31 - Living Dependency (IS) O S3.4.5.17 | 0223 - Living Dependency

    in2_32 : list[str] | None
        IN2.32 - Ambulatory Status (IS) O rep S3.4.3.15 | 0009 - Ambulatory Status

    in2_33 : list[CE] | None
        IN2.33 - Citizenship (CE) O rep S3.4.2.26 | 0171 - Citizenship

    in2_34 : CE | None
        IN2.34 - Primary Language (CE) O S3.4.2.15 | 0296 - Primary Language

    in2_35 : str | None
        IN2.35 - Living Arrangement (IS) O S3.4.5.21 | 0220 - Living Arrangement

    in2_36 : CE | None
        IN2.36 - Publicity Code (CE) O S3.4.5.22 | 0215 - Publicity Code

    in2_37 : str | None
        IN2.37 - Protection Indicator (ID) O S3.4.5.23 | 0136 - Yes/no indicator

    in2_38 : str | None
        IN2.38 - Student Indicator (IS) O S3.4.5.24 | 0231 - Student Status

    in2_39 : CE | None
        IN2.39 - Religion (CE) O S3.4.2.17 | 0006 - Religion

    in2_40 : list[XPN] | None
        IN2.40 - Mother's Maiden Name (XPN) O rep S3.4.2.6

    in2_41 : CE | None
        IN2.41 - Nationality (CE) O S3.4.2.28 | 0212 - Nationality

    in2_42 : list[CE] | None
        IN2.42 - Ethnic Group (CE) O rep S3.4.2.22 | 0189 - Ethnic Group

    in2_43 : list[CE] | None
        IN2.43 - Marital Status (CE) O rep S3.4.2.16 | 0002 - Marital Status
    ...
    in2_46 : str | None
        IN2.46 - Job Title (ST) O S6.5.5.49

    in2_47 : JCC | None
        IN2.47 - Job Code/Class (JCC) O S6.5.5.50

    in2_48 : str | None
        IN2.48 - Job Status (IS) O S3.4.5.34 | 0311 - Job Status
    ...
    in2_71 : list[CE] | None
        IN2.71 - Race (CE) O rep S3.4.2.10 | 0005 - Race

    in2_72 : CE | None
        IN2.72 - CMS Patient_s Relationship to Insured (CE) O S6.5.7.72 | 0344 - Patient's Relationship to Insured
    """
