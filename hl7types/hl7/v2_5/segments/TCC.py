...
class TCC(HL7Model):
    ...
    ----------
    tcc_1 : CE
        TCC.1 - Universal Service Identifier (CE) R S4.5.3.4

    tcc_2 : EI
        TCC.2 - Test Application Identifier (EI) R S13.4.9.2

    tcc_3 : SPS | None
        TCC.3 - Specimen Source (SPS) O S4.5.3.15
    ...
    tcc_7 : SN | None
        TCC.7 - Endogenous Content of Pre-Dilution Diluent (SN) O S13.4.9.7
    ...
    tcc_10 : str | None
        TCC.10 - Automatic Repeat Allowed (ID) O S13.4.9.10 | 0136 - Yes/no indicator
