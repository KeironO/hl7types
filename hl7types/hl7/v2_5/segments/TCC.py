...
class TCC(HL7Model):
    ...
    ----------
    tcc_1 : CE
        TCC.1 (req) - Universal Service Identifier (CE) S4.5.3.4

    tcc_2 : EI
        TCC.2 (req) - Test Application Identifier (EI) S13.4.9.2

    tcc_3 : SPS | None
        TCC.3 (opt) - Specimen Source (SPS) S4.5.3.15
    ...
    tcc_7 : SN | None
        TCC.7 (opt) - Endogenous Content of Pre-Dilution Diluent (SN) S13.4.9.7
    ...
    tcc_10 : str | None
        TCC.10 (opt) - Automatic Repeat Allowed (ID) S13.4.9.10 | 0136 - Yes/no indicator
