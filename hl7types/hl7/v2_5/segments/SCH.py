...
class SCH(HL7Model):
    ...
    sch_4 : EI | None
        SCH.4 (opt) - Placer Group Number (EI) S4.5.1.4

    sch_5 : CE | None
        SCH.5 (opt) - Schedule ID (CE) S10.6.1.5

    sch_6 : CE
        SCH.6 (req) - Event Reason (CE) S10.6.2.6

    sch_7 : CE | None
        SCH.7 (opt) - Appointment Reason (CE) S10.6.1.7 | 0276 - Appointment reason codes

    sch_8 : CE | None
        SCH.8 (opt) - Appointment Type (CE) S10.6.1.8 | 0277 - Appointment Type Codes

    sch_9 : str | None
        SCH.9 (opt) - Appointment Duration (NM) S10.6.1.9

    sch_10 : CE | None
        SCH.10 (opt) - Appointment Duration Units (CE) S10.6.1.10
    ...
    sch_25 : CE | None
        SCH.25 (opt) - Filler Status Code (CE) S10.6.2.25 | 0278 - Filler status codes

    sch_26 : list[EI] | None
        SCH.26 (opt, rep) - Placer Order Number (EI) S4.5.1.2

    sch_27 : list[EI] | None
        SCH.27 (opt, rep) - Filler Order Number (EI) S4.5.1.3
    """
