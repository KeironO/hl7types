...
class SCH(HL7Model):
    ...
    sch_4 : EI | None
        SCH.4 - Placer Group Number (EI) O S4.5.1.4

    sch_5 : CE | None
        SCH.5 - Schedule ID (CE) O S10.6.1.5

    sch_6 : CE
        SCH.6 - Event Reason (CE) R S10.6.2.6

    sch_7 : CE | None
        SCH.7 - Appointment Reason (CE) O S10.6.1.7 | 0276 - Appointment reason codes

    sch_8 : CE | None
        SCH.8 - Appointment Type (CE) O S10.6.1.8 | 0277 - Appointment Type Codes

    sch_9 : str | None
        SCH.9 - Appointment Duration (NM) O S10.6.1.9

    sch_10 : CE | None
        SCH.10 - Appointment Duration Units (CE) O S10.6.1.10
    ...
    sch_25 : CE | None
        SCH.25 - Filler Status Code (CE) O S10.6.2.25 | 0278 - Filler status codes

    sch_26 : list[EI] | None
        SCH.26 - Placer Order Number (EI) C rep S4.5.1.2

    sch_27 : list[EI] | None
        SCH.27 - Filler Order Number (EI) C rep S4.5.1.3
    """
