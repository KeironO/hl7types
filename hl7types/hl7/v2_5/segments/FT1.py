...
class FT1(HL7Model):
    ...
    ft1_14 : CE | None
        FT1.14 - Insurance Plan ID (CE) O S6.5.1.14 | 0072 - Insurance Plan ID
    ...
    ft1_23 : EI | None
        FT1.23 - Filler Order Number (EI) O S4.5.1.3

    ft1_24 : list[XCN] | None
        FT1.24 - Entered By Code (XCN) O rep S6.5.1.24

    ft1_25 : CE | None
        FT1.25 - Procedure Code (CE) O S4.5.3.44 | 0088 - Procedure Code

    ft1_26 : list[CE] | None
        FT1.26 - Procedure Code Modifier (CE) O rep S4.5.3.45 | 0340 - Procedure Code Modifier

    ft1_27 : CE | None
        FT1.27 - Advanced Beneficiary Notice Code (CE) O S4.5.1.20 | 0339 - Advanced Beneficiary Notice Code
    ...
    ft1_29 : CNE | None
        FT1.29 - NDC Code (CNE) O S6.5.1.29 | 0549 - NDC Codes
