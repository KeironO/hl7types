...
class OBR(HL7Model):
    ...
    obr_2 : EI | None
        OBR.2 (opt) - Placer Order Number (EI) S4.5.1.2

    obr_3 : EI | None
        OBR.3 (opt) - Filler Order Number (EI) S4.5.1.3

    obr_4 : CE
        OBR.4 (req) - Universal Service Identifier (CE) S4.5.3.4

    obr_5 : str | None
        OBR.5 (opt) - Priority _ OBR (ID) S4.5.3.5
    ...
    obr_15 : SPS | None
        OBR.15 (opt) - Specimen Source (SPS) S4.5.3.15
    ...
    obr_27 : list[TQ] | None
        OBR.27 (opt, rep) - Quantity/Timing (TQ) S4.5.1.7
    ...
    obr_46 : list[CE] | None
        OBR.46 (opt, rep) - Placer Supplemental Service Information (CE) S4.5.3.46 | 0411 - Supplemental Service Information Values

    obr_47 : list[CE] | None
        OBR.47 (opt, rep) - Filler Supplemental Service Information (CE) S4.5.3.47 | 0411 - Supplemental Service Information Values
