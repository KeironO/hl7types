...
class OBR(HL7Model):
    ...
    obr_2 : EI | None
        OBR.2 - Placer Order Number (EI) C S4.5.1.2

    obr_3 : EI | None
        OBR.3 - Filler Order Number (EI) C S4.5.1.3

    obr_4 : CE
        OBR.4 - Universal Service Identifier (CE) R S4.5.3.4

    obr_5 : str | None
        OBR.5 - Priority _ OBR (ID) O S4.5.3.5

    obr_6 : TS | None
        OBR.6 - Requested Date/Time (TS) O S4.5.3.6

    obr_7 : TS | None
        OBR.7 - Observation Date/Time (TS) C S4.5.3.7

    obr_8 : TS | None
        OBR.8 - Observation End Date/Time (TS) O S4.5.3.8
    ...
    obr_12 : CE | None
        OBR.12 - Danger Code (CE) O S4.5.3.12

    obr_13 : str | None
        OBR.13 - Relevant Clinical Information (ST) O S4.5.3.13

    obr_14 : TS | None
        OBR.14 - Specimen Received Date/Time (TS) O S4.5.3.14

    obr_15 : SPS | None
        OBR.15 - Specimen Source (SPS) O S4.5.3.15
    ...
    obr_22 : TS | None
        OBR.22 - Results Rpt/Status Chng - Date/Time (TS) C S4.5.3.22
    ...
    obr_27 : list[TQ] | None
        OBR.27 - Quantity/Timing (TQ) O rep S4.5.1.7
    ...
    obr_31 : list[CE] | None
        OBR.31 - Reason for Study (CE) O rep S4.5.3.31
    ...
    obr_36 : TS | None
        OBR.36 - Scheduled Date/Time (TS) O S4.5.3.36

    obr_37 : str | None
        OBR.37 - Number of Sample Containers * (NM) O S4.5.3.37

    obr_38 : list[CE] | None
        OBR.38 - Transport Logistics of Collected Sample (CE) O rep S4.5.3.38

    obr_39 : list[CE] | None
        OBR.39 - Collector's Comment * (CE) O rep S4.5.3.39

    obr_40 : CE | None
        OBR.40 - Transport Arrangement Responsibility (CE) O S4.5.3.40
    ...
    obr_43 : list[CE] | None
        OBR.43 - Planned Patient Transport Comment (CE) O rep S4.5.3.43

    obr_44 : CE | None
        OBR.44 - Procedure Code (CE) O S4.5.3.44 | 0088 - Procedure Code

    obr_45 : list[CE] | None
        OBR.45 - Procedure Code Modifier (CE) O rep S4.5.3.45 | 0340 - Procedure Code Modifier

    obr_46 : list[CE] | None
        OBR.46 - Placer Supplemental Service Information (CE) O rep S4.5.3.46 | 0411 - Supplemental Service Information Values

    obr_47 : list[CE] | None
        OBR.47 - Filler Supplemental Service Information (CE) O rep S4.5.3.47 | 0411 - Supplemental Service Information Values
