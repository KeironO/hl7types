...
class AIG(HL7Model):
    ...
    aig_2 : str | None
        AIG.2 - Segment Action Code (ID) C S8.9.3.2 | 0206 - Segment action code
    ...
    aig_5 : list[CE] | None
        AIG.5 - Resource Group (CE) O rep S10.6.5.5
    ...
    aig_8 : TS | None
        AIG.8 - Start Date/Time (TS) C S10.6.4.4

    aig_9 : str | None
        AIG.9 - Start Date/Time Offset (NM) C S10.6.4.5

    aig_10 : CE | None
        AIG.10 - Start Date/Time Offset Units (CE) C S10.6.4.6

    aig_11 : str | None
        AIG.11 - Duration (NM) O S10.6.4.7

    aig_12 : CE | None
        AIG.12 - Duration Units (CE) O S10.6.4.8

    aig_13 : str | None
        AIG.13 - Allow Substitution Code (IS) C S10.6.4.9 | 0279 - Allow Substitution Codes

    aig_14 : CE | None
        AIG.14 - Filler Status Code (CE) C S10.6.2.25 | 0278 - Filler status codes
    """
