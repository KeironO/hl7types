...
class DG1(HL7Model):
    ...
    dg1_8 : CE | None
        DG1.8 (opt) - Diagnostic Related Group (CE) S6.5.2.8 | 0055 - Diagnosis related group

    dg1_9 : str | None
        DG1.9 (opt) - DRG Approval Indicator (ID) S6.5.2.9 | 0136 - Yes/no indicator

    dg1_10 : str | None
        DG1.10 (opt) - DRG Grouper Review Code (IS) S6.5.2.10 | 0056 - DRG grouper review code

    dg1_11 : CE | None
        DG1.11 (opt) - Outlier Type (CE) S6.5.2.11 | 0083 - Outlier Type

    dg1_12 : str | None
        DG1.12 (opt) - Outlier Days (NM) S6.5.2.12

    dg1_13 : CP | None
        DG1.13 (opt) - Outlier Cost (CP) S6.5.2.13
