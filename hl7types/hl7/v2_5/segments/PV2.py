...
class PV2(HL7Model):
    ...
    pv2_43 : str | None
        PV2.43 (opt) - Living Will Code (IS) S3.4.4.43 | 0315 - Living Will Code

    pv2_44 : str | None
        PV2.44 (opt) - Organ Donor Code (IS) S3.4.4.44 | 0316 - Organ Donor Code

    pv2_45 : list[CE] | None
        PV2.45 (opt, rep) - Advance Directive Code (CE) S3.4.4.45 | 0435 - Advance Directive Code
    ...
    pv2_48 : TS | None
        PV2.48 (opt) - Expected Pre-admission Testing Date/Time (TS) S3.4.4.48
