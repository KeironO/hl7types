...
class OM1(HL7Model):
    ...
    ----------
    om1_1 : str
        OM1.1 - Sequence Number - Test/Observation Master File (NM) R S8.8.8.1

    om1_2 : CE
        OM1.2 - Producer's Service/Test/Observation ID (CE) R S8.8.8.2 | 9999 - no table for CE
    ...
    om1_5 : CE
        OM1.5 - Producer ID (CE) R S8.8.8.5 | 9999 - no table for CE

    om1_6 : str | None
        OM1.6 - Observation Description (TX) O S8.8.8.6

    om1_7 : CE | None
        OM1.7 - Other Service/Test/Observation IDs for the Observation (CE) O S8.8.8.7 | 9999 - no table for CE

    om1_8 : list[str]
        OM1.8 - Other Names (ST) R rep S8.8.8.8

    om1_9 : str | None
        OM1.9 - Preferred Report Name for the Observation (ST) O S8.8.8.9

    om1_10 : str | None
        OM1.10 - Preferred Short Name or Mnemonic for Observation (ST) O S8.8.8.10
    ...
    om1_13 : list[CE] | None
        OM1.13 - Identity of Instrument Used to Perform this Study (CE) O rep S8.8.8.13 | 9999 - no table for CE

    om1_14 : list[CE] | None
        OM1.14 - Coded Representation of Method (CE) O rep S8.8.8.14 | 9999 - no table for CE

    om1_15 : str | None
        OM1.15 - Portable Device Indicator (ID) O S8.8.8.15 | 0136 - Yes/no indicator

    om1_16 : list[CE] | None
        OM1.16 - Observation Producing Department/Section (CE) O rep S8.8.8.16 | 9999 - no table for CE

    om1_17 : XTN | None
        OM1.17 - Telephone Number of Section (XTN) O S8.8.8.17

    om1_18 : str
        OM1.18 - Nature of Service/Test/Observation (IS) R S8.8.8.18 | 0174 - Nature of Service/Test/Observation

    om1_19 : CE | None
        OM1.19 - Report Subheader (CE) O S8.8.8.19 | 9999 - no table for CE

    om1_20 : str | None
        OM1.20 - Report Display Order (ST) O S8.8.8.20

    om1_21 : TS | None
        OM1.21 - Date/Time Stamp for any change in Definition for the Observation (TS) O S8.8.8.21

    om1_22 : TS | None
        OM1.22 - Effective Date/Time of Change (TS) O S8.8.8.22
    ...
    om1_27 : list[CE] | None
        OM1.27 - Outside Site(s) Where Observation may be Performed (CE) O rep S8.8.8.27 | 9999 - no table for CE
    ...
    om1_31 : CE | None
        OM1.31 - Observations Required to Interpret the Observation (CE) O S8.8.8.31 | 9999 - no table for CE

    om1_32 : str | None
        OM1.32 - Interpretation of Observations (TX) O S8.8.8.32

    om1_33 : CE | None
        OM1.33 - Contraindications to Observations (CE) O S8.8.8.33 | 9999 - no table for CE

    om1_34 : list[CE] | None
        OM1.34 - Reflex Tests/Observations (CE) O rep S8.8.8.34 | 9999 - no table for CE

    om1_35 : str | None
        OM1.35 - Rules that Trigger Reflex Testing (TX) O S8.8.8.35

    om1_36 : CE | None
        OM1.36 - Fixed Canned Message (CE) O S8.8.8.36 | 9999 - no table for CE

    om1_37 : str | None
        OM1.37 - Patient Preparation (TX) O S8.8.8.37

    om1_38 : CE | None
        OM1.38 - Procedure Medication (CE) O S8.8.8.38 | 9999 - no table for CE
    ...
    om1_42 : CE | None
        OM1.42 - Kind of Quantity Observed (CE) O S8.8.8.42 | 0254 - Kind of quantity

    om1_43 : CE | None
        OM1.43 - Point Versus Interval (CE) O S8.8.8.43 | 0255 - Duration categories

    om1_44 : str | None
        OM1.44 - Challenge Information (TX) O S8.8.8.44

    om1_45 : CE | None
        OM1.45 - Relationship Modifier (CE) O S8.8.8.45 | 0258 - Relationship modifier

    om1_46 : CE | None
        OM1.46 - Target Anatomic Site Of Test (CE) O S8.8.8.46 | 9999 - no table for CE

    om1_47 : CE | None
        OM1.47 - Modality Of Imaging Measurement (CE) O S8.8.8.47 | 0259 - Modality
    """
