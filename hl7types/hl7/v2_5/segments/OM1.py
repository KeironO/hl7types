...
class OM1(HL7Model):
    ...
    ----------
    om1_1 : str
        OM1.1 (req) - Sequence Number - Test/Observation Master File (NM) S8.8.8.1
    ...
    om1_22 : TS | None
        OM1.22 (opt) - Effective Date/Time of Change (TS) S8.8.8.22
    ...
    om1_44 : str | None
        OM1.44 (opt) - Challenge Information (TX) S8.8.8.44
