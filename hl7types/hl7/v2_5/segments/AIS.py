...
class AIS(HL7Model):
    ...
    ais_2 : str | None
        AIS.2 - Segment Action Code (ID) C S8.9.3.2 | 0206 - Segment action code

    ais_3 : CE
        AIS.3 - Universal Service Identifier (CE) R S4.5.3.4

    ais_4 : TS | None
        AIS.4 - Start Date/Time (TS) C S10.6.4.4

    ais_5 : str | None
        AIS.5 - Start Date/Time Offset (NM) C S10.6.4.5

    ais_6 : CE | None
        AIS.6 - Start Date/Time Offset Units (CE) C S10.6.4.6

    ais_7 : str | None
        AIS.7 - Duration (NM) O S10.6.4.7

    ais_8 : CE | None
        AIS.8 - Duration Units (CE) O S10.6.4.8

    ais_9 : str | None
        AIS.9 - Allow Substitution Code (IS) C S10.6.4.9 | 0279 - Allow Substitution Codes

    ais_10 : CE | None
        AIS.10 - Filler Status Code (CE) C S10.6.2.25 | 0278 - Filler status codes

    ais_11 : list[CE] | None
        AIS.11 - Placer Supplemental Service Information (CE) O rep S4.5.3.46 | 0411 - Supplemental Service Information Values

    ais_12 : list[CE] | None
        AIS.12 - Filler Supplemental Service Information (CE) O rep S4.5.3.47 | 0411 - Supplemental Service Information Values
    """
