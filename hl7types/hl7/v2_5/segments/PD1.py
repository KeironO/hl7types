...
class PD1(HL7Model):
    ...
    ----------
    pd1_1 : list[str] | None
        PD1.1 (opt, rep) - Living Dependency (IS) S3.4.5.17 | 0223 - Living Dependency

    pd1_2 : str | None
        PD1.2 (opt) - Living Arrangement (IS) S3.4.5.21 | 0220 - Living Arrangement
    ...
    pd1_5 : str | None
        PD1.5 (opt) - Student Indicator (IS) S3.4.5.24 | 0231 - Student Status

    pd1_6 : str | None
        PD1.6 (opt) - Handicap (IS) S3.4.5.36 | 0295 - Handicap

    pd1_7 : str | None
        PD1.7 (opt) - Living Will Code (IS) S3.4.4.43 | 0315 - Living Will Code

    pd1_8 : str | None
        PD1.8 (opt) - Organ Donor Code (IS) S3.4.4.44 | 0316 - Organ Donor Code
    ...
    pd1_11 : CE | None
        PD1.11 (opt) - Publicity Code (CE) S3.4.5.22 | 0215 - Publicity Code

    pd1_12 : str | None
        PD1.12 (opt) - Protection Indicator (ID) S3.4.5.23 | 0136 - Yes/no indicator
