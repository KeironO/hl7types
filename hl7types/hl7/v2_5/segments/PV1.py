...
class PV1(HL7Model):
    ...
    pv1_15 : list[str] | None
        PV1.15 (opt, rep) - Ambulatory Status (IS) S3.4.3.15 | 0009 - Ambulatory Status
    ...
    pv1_18 : str | None
        PV1.18 (opt) - Patient Type (IS) S3.4.3.18 | 0018 - Patient Type
    ...
    pv1_40 : str | None
        PV1.40 (opt) - Bed Status (IS) S3.4.3.40 | 0116 - Bed Status
