...
class TCD(HL7Model):
    ...
    ----------
    tcd_1 : CE
        TCD.1 (req) - Universal Service Identifier (CE) S4.5.3.4
    ...
    tcd_5 : SN | None
        TCD.5 (opt) - Endogenous Content of Pre-Dilution Diluent (SN) S13.4.9.7

    tcd_6 : str | None
        TCD.6 (opt) - Automatic Repeat Allowed (ID) S13.4.9.10 | 0136 - Yes/no indicator
