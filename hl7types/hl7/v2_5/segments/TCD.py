...
class TCD(HL7Model):
    ...
    ----------
    tcd_1 : CE
        TCD.1 - Universal Service Identifier (CE) R S4.5.3.4
    ...
    tcd_5 : SN | None
        TCD.5 - Endogenous Content of Pre-Dilution Diluent (SN) O S13.4.9.7

    tcd_6 : str | None
        TCD.6 - Automatic Repeat Allowed (ID) O S13.4.9.10 | 0136 - Yes/no indicator
