...
class ARQ(HL7Model):
    ...
    arq_4 : EI | None
        ARQ.4 - Placer Group Number (EI) O S4.5.1.4

    arq_5 : CE | None
        ARQ.5 - Schedule ID (CE) O S10.6.1.5

    arq_6 : CE | None
        ARQ.6 - Request Event Reason (CE) O S10.6.1.6

    arq_7 : CE | None
        ARQ.7 - Appointment Reason (CE) O S10.6.1.7 | 0276 - Appointment reason codes

    arq_8 : CE | None
        ARQ.8 - Appointment Type (CE) O S10.6.1.8 | 0277 - Appointment Type Codes

    arq_9 : str | None
        ARQ.9 - Appointment Duration (NM) O S10.6.1.9

    arq_10 : CE | None
        ARQ.10 - Appointment Duration Units (CE) O S10.6.1.10
    ...
    arq_24 : list[EI] | None
        ARQ.24 - Placer Order Number (EI) C rep S4.5.1.2

    arq_25 : list[EI] | None
        ARQ.25 - Filler Order Number (EI) C rep S4.5.1.3
    """
