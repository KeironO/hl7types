...
class OM2(HL7Model):
    ...
    ----------
    om2_1 : str | None
        OM2.1 - Sequence Number - Test/Observation Master File (NM) O S8.8.8.1

    om2_2 : CE | None
        OM2.2 - Units of Measure (CE) O S8.8.9.2 | 9999 - no table for CE

    om2_3 : list[str] | None
        OM2.3 - Range of Decimal Precision (NM) O rep S8.8.9.3

    om2_4 : CE | None
        OM2.4 - Corresponding SI Units of Measure (CE) O S8.8.9.4 | 9999 - no table for CE

    om2_5 : str | None
        OM2.5 - SI Conversion Factor (TX) O S8.8.9.5

    om2_6 : list[RFR] | None
        OM2.6 - Reference (Normal) Range - Ordinal and Continuous Observations (RFR) O rep S8.8.9.6
