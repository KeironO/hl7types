...
class CDM(HL7Model):
    ...
    ----------
    cdm_1 : CE
        CDM.1 - Primary Key Value - CDM (CE) R S8.8.14.24 | 0132 - Transaction Code

    cdm_2 : list[CE] | None
        CDM.2 - Charge Code Alias (CE) O rep S8.10.2.2
    ...
    cdm_6 : list[CE] | None
        CDM.6 - Exploding Charges (CE) O rep S8.10.2.6

    cdm_7 : list[CE] | None
        CDM.7 - Procedure Code (CE) O rep S4.5.3.44 | 0088 - Procedure Code

    cdm_8 : str | None
        CDM.8 - Active/Inactive Flag (ID) O S8.9.5.6 | 0183 - Active/Inactive
