...
class PRC(HL7Model):
    ...
    prc_3 : list[CE] | None
        PRC.3 - Department (CE) O rep S8.10.3.3 | 0184 - Department

    prc_4 : list[str] | None
        PRC.4 - Valid Patient Classes (IS) O rep S8.9.5.5 | 0004 - Patient Class
    ...
    prc_16 : str | None
        PRC.16 - Active/Inactive Flag (ID) O S8.9.5.6 | 0183 - Active/Inactive
