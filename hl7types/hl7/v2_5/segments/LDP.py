...
class LDP(HL7Model):
    ...
    ldp_2 : CE
        LDP.2 - Location Department (CE) R S8.9.5.2 | 0264 - Location Department
    ...
    ldp_5 : list[str] | None
        LDP.5 - Valid Patient Classes (IS) O rep S8.9.5.5 | 0004 - Patient Class

    ldp_6 : str | None
        LDP.6 - Active/Inactive Flag (ID) O S8.9.5.6 | 0183 - Active/Inactive
