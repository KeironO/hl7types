...
class LDP(HL7Model):
    ...
    ldp_2 : CE
        LDP.2 (req) - Location Department (CE) S8.9.5.2 | 0264 - Location Department
    ...
    ldp_5 : list[str] | None
        LDP.5 (opt, rep) - Valid Patient Classes (IS) S8.9.5.5 | 0004 - Patient Class

    ldp_6 : str | None
        LDP.6 (opt) - Active/Inactive Flag (ID) S8.9.5.6 | 0183 - Active/Inactive
