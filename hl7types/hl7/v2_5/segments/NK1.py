...
class NK1(HL7Model):
    ...
    nk1_7 : CE | None
        NK1.7 (opt) - Contact Role (CE) S3.4.5.7 | 0131 - Contact Role
    ...
    nk1_14 : CE | None
        NK1.14 (opt) - Marital Status (CE) S3.4.2.16 | 0002 - Marital Status

    nk1_15 : str | None
        NK1.15 (opt) - Administrative Sex (IS) S3.4.2.8 | 0001 - Administrative Sex

    nk1_16 : TS | None
        NK1.16 (opt) - Date/Time of Birth (TS) S3.4.2.7

    nk1_17 : list[str] | None
        NK1.17 (opt, rep) - Living Dependency (IS) S3.4.5.17 | 0223 - Living Dependency

    nk1_18 : list[str] | None
        NK1.18 (opt, rep) - Ambulatory Status (IS) S3.4.3.15 | 0009 - Ambulatory Status

    nk1_19 : list[CE] | None
        NK1.19 (opt, rep) - Citizenship (CE) S3.4.2.26 | 0171 - Citizenship

    nk1_20 : CE | None
        NK1.20 (opt) - Primary Language (CE) S3.4.2.15 | 0296 - Primary Language

    nk1_21 : str | None
        NK1.21 (opt) - Living Arrangement (IS) S3.4.5.21 | 0220 - Living Arrangement

    nk1_22 : CE | None
        NK1.22 (opt) - Publicity Code (CE) S3.4.5.22 | 0215 - Publicity Code

    nk1_23 : str | None
        NK1.23 (opt) - Protection Indicator (ID) S3.4.5.23 | 0136 - Yes/no indicator

    nk1_24 : str | None
        NK1.24 (opt) - Student Indicator (IS) S3.4.5.24 | 0231 - Student Status
    ...
    nk1_28 : list[CE] | None
        NK1.28 (opt, rep) - Ethnic Group (CE) S3.4.2.22 | 0189 - Ethnic Group
    ...
    nk1_35 : list[CE] | None
        NK1.35 (opt, rep) - Race (CE) S3.4.2.10 | 0005 - Race

    nk1_36 : str | None
        NK1.36 (opt) - Handicap (IS) S3.4.5.36 | 0295 - Handicap
