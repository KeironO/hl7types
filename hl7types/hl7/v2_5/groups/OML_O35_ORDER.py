...
from .OML_O35_TIIMING import OML_O35_TIIMING

_BLG = BLG
_CTI = CTI
_FT1 = FT1
_OML_O35_OBSERVATION_REQUEST = OML_O35_OBSERVATION_REQUEST
_OML_O35_TIIMING = OML_O35_TIIMING
_ORC = ORC
...
class OML_O35_ORDER(BaseModel):
    ...
    Attributes:
        ORC (ORC): required
        TIIMING (Optional[List[OML_O35_TIIMING]]): optional
    ...
    TIIMING: list[_OML_O35_TIIMING] | None = Field(
        default=None,
        title="TIIMING",
        description="Optional, repeating",
    )

    OBSERVATION_REQUEST: _OML_O35_OBSERVATION_REQUEST | None = Field(
        default=None,
