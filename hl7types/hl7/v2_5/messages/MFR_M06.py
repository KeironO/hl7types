...
from ..groups.MFR_M06_MF_QUERY import MFR_M06_MF_QUERY

_DSC = DSC
_ERR = ERR
_MFI = MFI
_MFR_M06_MF_QUERY = MFR_M06_MF_QUERY
_MSA = MSA
_MSH = MSH
_QAK = QAK
_QRD = QRD
...
class MFR_M06(HL7Model):
    """MFN/MFK - Clinical study with phases and schedules master file (S8.4.4).
    ...
    Attributes:
        ...
        MF_QUERY (List[MFR_M06_MF_QUERY]): required
