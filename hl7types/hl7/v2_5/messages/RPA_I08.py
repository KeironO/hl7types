...
from ..groups.RPA_I08_AUTHORIZATION_1 import RPA_I08_AUTHORIZATION_1
...
_PID = PID
_RF1 = RF1
_RPA_I08_AUTHORIZATION_1 = RPA_I08_AUTHORIZATION_1
...
class RPA_I08(HL7Model):
    ...
    Attributes:
        ...
        AUTHORIZATION_1 (Optional[RPA_I08_AUTHORIZATION_1]): optional
    ...
    AUTHORIZATION_1: Optional[_RPA_I08_AUTHORIZATION_1] = Field(
        default=None,
        title="AUTHORIZATION_1",
        description="Optional",
    )
