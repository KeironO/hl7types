...
_QAK = QAK
_QPD = QPD
_RSP_K21_QUERY_RESPONSE = RSP_K21_QUERY_RESPONSE
_SFT = SFT


class RSP_K21(HL7Model):
    """RSP - Get person demographics response (S3.3.56).
    ...
    QUERY_RESPONSE: Optional[List[_RSP_K21_QUERY_RESPONSE]] = Field(
        default=None,
