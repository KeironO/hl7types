...
_NTE = NTE
_PPG_PCG_OBRRXO_SUPPGRP = PPG_PCG_OBRRXO_SUPPGRP
...
class PPG_PCG_ORDER_DETAIL(BaseModel):
    ...
    Attributes:
        OBRRXO_SUPPGRP (PPG_PCG_OBRRXO_SUPPGRP): required
    ...
    ORDER_OBSERVATION: list[_PPG_PCG_ORDER_OBSERVATION] | None = Field(
        default=None,
