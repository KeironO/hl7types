...
class RXA(HL7Model):
    ...
    ----------
    rxa_1 : str
        RXA.1 (req) - Give Sub-ID Counter (NM) S4.14.7.1
    ...
    rxa_9 : list[CE] | None
        RXA.9 (opt, rep) - Administration Notes (CE) S4.14.7.9
    ...
    rxa_16 : list[TS] | None
        RXA.16 (opt, rep) - Substance Expiration Date (TS) S4.14.7.16

    rxa_17 : list[CE] | None
        RXA.17 (opt, rep) - Substance Manufacturer Name (CE) S4.14.7.17 | 0227 - Manufacturers of vaccines (code=MVX)

    rxa_18 : list[CE] | None
        RXA.18 (opt, rep) - Substance/Treatment Refusal Reason (CE) S4.14.7.18

    rxa_19 : list[CE] | None
        RXA.19 (opt, rep) - Indication (CE) S4.14.7.19
