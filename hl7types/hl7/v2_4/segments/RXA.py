...
class RXA(HL7Model):
    ...
    ----------
    rxa_1 : str
        RXA.1 - Give Sub-ID Counter (NM) R S4.14.7.1
    ...
    rxa_9 : list[CE] | None
        RXA.9 - Administration Notes (CE) O rep S4.14.7.9
    ...
    rxa_16 : list[TS] | None
        RXA.16 - Substance Expiration Date (TS) O rep S4.14.7.16

    rxa_17 : list[CE] | None
        RXA.17 - Substance Manufacturer Name (CE) O rep S4.14.7.17 | 0227 - Manufacturers of vaccines (code=MVX)

    rxa_18 : list[CE] | None
        RXA.18 - Substance/Treatment Refusal Reason (CE) O rep S4.14.7.18

    rxa_19 : list[CE] | None
        RXA.19 - Indication (CE) O rep S4.14.7.19
