...
class SPR(HL7Model):
    ...
    ----------
    spr_1 : str | None
        SPR.1 (opt) - Query Tag (ST) S5.10.5.8.1

    spr_2 : str
        SPR.2 (req) - Query/Response Format Code (ID) S5.10.5.8.2 | 0106 - Query/response format code

    spr_3 : CE
        SPR.3 (req) - Stored Procedure Name (CE) S5.10.5.5.3

    spr_4 : list[QIP] | None
        SPR.4 (opt, rep) - Input Parameter List (QIP) S5.10.5.5.4
    """
