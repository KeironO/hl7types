...
class SPR(HL7Model):
    ...
    ----------
    spr_1 : str | None
        SPR.1 - Query Tag (ST) O S5.10.5.8.1

    spr_2 : str
        SPR.2 - Query/Response Format Code (ID) R S5.10.5.8.2 | 0106 - Query/response format code

    spr_3 : CE
        SPR.3 - Stored Procedure Name (CE) R S5.10.5.5.3

    spr_4 : list[QIP] | None
        SPR.4 - Input Parameter List (QIP) O rep S5.10.5.5.4
    """
