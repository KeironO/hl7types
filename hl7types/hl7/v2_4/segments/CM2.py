...
class CM2(HL7Model):
    ...
    cm2_2 : CE
        CM2.2 - Scheduled Time Point (CE) R S8.11.4.2 | 9999 - for unknown CE data elements

    cm2_3 : str | None
        CM2.3 - Description of Time Point (ST) O S8.11.4.3

    cm2_4 : list[CE]
        CM2.4 - Events Scheduled This Time Point (CE) R rep S8.11.4.4 | 9999 - for unknown CE data elements
    """
    ...
    cm2_2: CE = Field(
        ...
        description=(
            "R | Item #01025 | Table 9999 - for unknown CE data elements"
        ),
    )
    ...
    cm2_3: Optional[str] = Field(
        ...
        description="O | Item #01026 | LEN:300",
    )
    ...
    cm2_4: List[CE] = Field(
        ...
        description=(
            "R | Item #01027 | Table 9999 - for unknown CE data elements"
        ),
    )
