...
class RXD(HL7Model):
    ...
    ----------
    rxd_1 : str
        RXD.1 - Dispense Sub-ID Counter (NM) R S4.14.6.2
    ...
    rxd_7 : str
        RXD.7 - Prescription Number (ST) R S4.14.5.7

    rxd_8 : str | None
        RXD.8 - Number of Refills Remaining (NM) C S4.14.5.8
    ...
    rxd_11 : str | None
        RXD.11 - Substitution Status (ID) O S4.14.6.10 | 0167 - Substitution status

    rxd_12 : CQ | None
        RXD.12 - Total Daily Dose (CQ) O S4.14.5.12

    rxd_13 : LA2 | None
        RXD.13 - Dispense-To Location (LA2) C S4.14.6.11

    rxd_14 : str | None
        RXD.14 - Needs Human Review (ID) O S4.14.6.12 | 0136 - Yes/no indicator

    rxd_15 : list[CE] | None
        RXD.15 - Pharmacy/Treatment Supplier's Special Dispensing Instructions (CE) O rep S4.14.5.15
    ...
    rxd_19 : list[TS] | None
        RXD.19 - Substance Expiration Date (TS) O rep S4.14.7.16

    rxd_20 : list[CE] | None
        RXD.20 - Substance Manufacturer Name (CE) O rep S4.14.7.17 | 0227 - Manufacturers of vaccines (code=MVX)

    rxd_21 : list[CE] | None
        RXD.21 - Indication (CE) O rep S4.14.7.19

    rxd_22 : str | None
        RXD.22 - Dispense Package Size (NM) O S4.14.5.22

    rxd_23 : CE | None
        RXD.23 - Dispense Package Size Unit (CE) O S4.14.5.23

    rxd_24 : str | None
        RXD.24 - Dispense Package Method (ID) O S4.14.5.24 | 0321 - Dispense method

    rxd_25 : list[CE] | None
        RXD.25 - Supplementary Code (CE) O rep S4.14.5.25
