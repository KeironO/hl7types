...
class AIS(HL7Model):
    ...
    ais_2 : str | None
        AIS.2 - Segment Action Code (ID) C S10.6.7.2 | 0206 - Segment action code

    ais_3 : CE
        AIS.3 - Universal Service Identifier (CE) R S13.4.10.1

    ais_4 : TS | None
        AIS.4 - Start Date/Time (TS) C S13.4.12.3

    ais_5 : str | None
        AIS.5 - Start Date/Time Offset (NM) C S10.6.7.7

    ais_6 : CE | None
        AIS.6 - Start Date/Time Offset Units (CE) C S10.6.7.8

    ais_7 : str | None
        AIS.7 - Duration (NM) O S10.6.7.9

    ais_8 : CE | None
        AIS.8 - Duration Units (CE) O S10.6.7.10

    ais_9 : str | None
        AIS.9 - Allow Substitution Code (IS) C S10.6.7.11 | 0279 - Allow substitution codes

    ais_10 : CE | None
        AIS.10 - Filler Status Code (CE) C S10.6.7.12 | 0278 - Filler status codes

    ais_11 : list[CE] | None
        AIS.11 - Placer Supplemental Service Information (CE) O rep S10.6.4.11 | 0411 - Supplemental service information values

    ais_12 : list[CE] | None
        AIS.12 - Filler Supplemental Service Information (CE) O rep S10.6.4.12 | 0411 - Supplemental service information values
    """
