...
class GT1(HL7Model):
    ...
    gt1_32 : str | None
        GT1.32 - Employment Stop Date (DT) O S6.5.7.45

    gt1_33 : str | None
        GT1.33 - Living Dependency (IS) O S6.5.7.31 | 0223 - Living dependency

    gt1_34 : list[str] | None
        GT1.34 - Ambulatory Status (IS) O rep S6.5.7.32 | 0009 - Ambulatory status

    gt1_35 : list[CE] | None
        GT1.35 - Citizenship (CE) O rep S6.5.7.33 | 0171 - Citizenship

    gt1_36 : CE | None
        GT1.36 - Primary Language (CE) O S6.5.7.34 | 0296 - Primary language

    gt1_37 : str | None
        GT1.37 - Living Arrangement (IS) O S6.5.7.35 | 0220 - Living arrangement

    gt1_38 : CE | None
        GT1.38 - Publicity Code (CE) O S6.5.7.36 | 0215 - Publicity code

    gt1_39 : str | None
        GT1.39 - Protection Indicator (ID) O S6.5.7.37 | 0136 - Yes/no indicator

    gt1_40 : str | None
        GT1.40 - Student Indicator (IS) O S6.5.7.38 | 0231 - Student status

    gt1_41 : CE | None
        GT1.41 - Religion (CE) O S6.5.7.39 | 0006 - Religion

    gt1_42 : list[XPN] | None
        GT1.42 - Mother's Maiden Name (XPN) O rep S6.5.7.40

    gt1_43 : CE | None
        GT1.43 - Nationality (CE) O S6.5.7.41 | 0212 - Nationality

    gt1_44 : list[CE] | None
        GT1.44 - Ethnic Group (CE) O rep S15.4.6.28 | 0189 - Ethnic group

    gt1_45 : list[XPN] | None
        GT1.45 - Contact Person's Name (XPN) O rep S6.5.5.45

    gt1_46 : list[XTN] | None
        GT1.46 - Contact Person's Telephone Number (XTN) O rep S6.5.5.46

    gt1_47 : CE | None
        GT1.47 - Contact Reason (CE) O S6.5.5.47 | 0222 - Contact reason

    gt1_48 : str | None
        GT1.48 - Contact Relationship (IS) O S6.5.5.48 | 0063 - Relationship

    gt1_49 : str | None
        GT1.49 - Job Title (ST) O S15.4.6.18

    gt1_50 : JCC | None
        GT1.50 - Job Code/Class (JCC) O S15.4.6.19 | 0327 - Job code/class

    gt1_51 : list[XON] | None
        GT1.51 - Guarantor Employer's Organization Name (XON) O rep S6.5.5.51

    gt1_52 : str | None
        GT1.52 - Handicap (IS) O S6.5.6.48 | 0295 - Handicap

    gt1_53 : str | None
        GT1.53 - Job Status (IS) O S6.5.7.48 | 0311 - Job status

    gt1_54 : FC | None
        GT1.54 - Guarantor Financial Class (FC) O S6.5.5.54 | 0064 - Financial class
