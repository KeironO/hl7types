...
class GOL(HL7Model):
    ...
    ----------
    gol_1 : str
        GOL.1 (req) - Action Code (ID) S12.4.4.1 | 0287 - Problem/goal action code

    gol_2 : TS
        GOL.2 (req) - Action Date/Time (TS) S12.4.2.2

    gol_3 : CE
        GOL.3 (req) - Goal ID (CE) S12.4.1.3

    gol_4 : EI
        GOL.4 (req) - Goal Instance ID (EI) S12.4.1.4

    gol_5 : EI | None
        GOL.5 (opt) - Episode of Care ID (EI) S12.4.2.5

    gol_6 : str | None
        GOL.6 (opt) - Goal List Priority (NM) S12.4.1.6

    gol_7 : TS | None
        GOL.7 (opt) - Goal Established Date/Time (TS) S12.4.1.7

    gol_8 : TS | None
        GOL.8 (opt) - Expected Goal Achieve Date/Time (TS) S12.4.1.8

    gol_9 : CE | None
        GOL.9 (opt) - Goal Classification (CE) S12.4.1.9

    gol_10 : CE | None
        GOL.10 (opt) - Goal Management Discipline (CE) S12.4.1.10

    gol_11 : CE | None
        GOL.11 (opt) - Current Goal Review Status (CE) S12.4.1.11

    gol_12 : TS | None
        GOL.12 (opt) - Current Goal Review Date/Time (TS) S12.4.1.12

    gol_13 : TS | None
        GOL.13 (opt) - Next Goal Review Date/Time (TS) S12.4.1.13

    gol_14 : TS | None
        GOL.14 (opt) - Previous Goal Review Date/Time (TS) S12.4.1.14

    gol_15 : TQ | None
        GOL.15 (opt) - Goal Review Interval (TQ) S12.4.1.15

    gol_16 : CE | None
        GOL.16 (opt) - Goal Evaluation (CE) S12.4.1.16

    gol_17 : list[str] | None
        GOL.17 (opt, rep) - Goal Evaluation Comment (ST) S12.4.1.17

    gol_18 : CE | None
        GOL.18 (opt) - Goal Life Cycle Status (CE) S12.4.1.18

    gol_19 : TS | None
        GOL.19 (opt) - Goal Life Cycle Status Date/Time (TS) S12.4.1.19

    gol_20 : list[CE] | None
        GOL.20 (opt, rep) - Goal Target Type (CE) S12.4.1.20
