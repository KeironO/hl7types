...
class GOL(HL7Model):
    ...
    ----------
    gol_1 : str
        GOL.1 - Action Code (ID) R S12.4.4.1 | 0287 - Problem/goal action code

    gol_2 : TS
        GOL.2 - Action Date/Time (TS) R S12.4.2.2

    gol_3 : CE
        GOL.3 - Goal ID (CE) R S12.4.1.3

    gol_4 : EI
        GOL.4 - Goal Instance ID (EI) R S12.4.1.4

    gol_5 : EI | None
        GOL.5 - Episode of Care ID (EI) O S12.4.2.5

    gol_6 : str | None
        GOL.6 - Goal List Priority (NM) O S12.4.1.6

    gol_7 : TS | None
        GOL.7 - Goal Established Date/Time (TS) O S12.4.1.7

    gol_8 : TS | None
        GOL.8 - Expected Goal Achieve Date/Time (TS) O S12.4.1.8

    gol_9 : CE | None
        GOL.9 - Goal Classification (CE) O S12.4.1.9

    gol_10 : CE | None
        GOL.10 - Goal Management Discipline (CE) O S12.4.1.10

    gol_11 : CE | None
        GOL.11 - Current Goal Review Status (CE) O S12.4.1.11

    gol_12 : TS | None
        GOL.12 - Current Goal Review Date/Time (TS) O S12.4.1.12

    gol_13 : TS | None
        GOL.13 - Next Goal Review Date/Time (TS) O S12.4.1.13

    gol_14 : TS | None
        GOL.14 - Previous Goal Review Date/Time (TS) O S12.4.1.14

    gol_15 : TQ | None
        GOL.15 - Goal Review Interval (TQ) O S12.4.1.15

    gol_16 : CE | None
        GOL.16 - Goal Evaluation (CE) O S12.4.1.16

    gol_17 : list[str] | None
        GOL.17 - Goal Evaluation Comment (ST) O rep S12.4.1.17

    gol_18 : CE | None
        GOL.18 - Goal Life Cycle Status (CE) O S12.4.1.18

    gol_19 : TS | None
        GOL.19 - Goal Life Cycle Status Date/Time (TS) O S12.4.1.19

    gol_20 : list[CE] | None
        GOL.20 - Goal Target Type (CE) O rep S12.4.1.20
