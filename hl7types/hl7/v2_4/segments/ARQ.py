...
class ARQ(HL7Model):
    ...
    ----------
    arq_1 : EI
        ARQ.1 - Placer Appointment ID (EI) R S10.6.2.1

    arq_2 : EI | None
        ARQ.2 - Filler Appointment ID (EI) C S10.6.2.2

    arq_3 : str | None
        ARQ.3 - Occurrence Number (NM) C S10.6.2.3

    arq_4 : EI | None
        ARQ.4 - Placer Group Number (EI) O S10.6.2.4

    arq_5 : CE | None
        ARQ.5 - Schedule ID (CE) O S10.6.2.5

    arq_6 : CE | None
        ARQ.6 - Request Event Reason (CE) O S10.6.1.6

    arq_7 : CE | None
        ARQ.7 - Appointment Reason (CE) O S10.6.2.7 | 0276 - Appointment reason codes

    arq_8 : CE | None
        ARQ.8 - Appointment Type (CE) O S10.6.2.8 | 0277 - Appointment type codes

    arq_9 : str | None
        ARQ.9 - Appointment Duration (NM) O S10.6.2.9

    arq_10 : CE | None
        ARQ.10 - Appointment Duration Units (CE) O S10.6.2.10
    ...
    arq_15 : list[XCN]
        ARQ.15 - Placer Contact Person (XCN) R rep S10.6.2.12

    arq_16 : list[XTN] | None
        ARQ.16 - Placer Contact Phone Number (XTN) O rep S10.6.2.13

    arq_17 : list[XAD] | None
        ARQ.17 - Placer Contact Address (XAD) O rep S10.6.2.14

    arq_18 : PL | None
        ARQ.18 - Placer Contact Location (PL) O S10.6.2.15

    arq_19 : list[XCN]
        ARQ.19 - Entered By Person (XCN) R rep S10.6.2.20

    arq_20 : list[XTN] | None
        ARQ.20 - Entered By Phone Number (XTN) O rep S10.6.2.21

    arq_21 : PL | None
        ARQ.21 - Entered by Location (PL) O S10.6.2.22

    arq_22 : EI | None
        ARQ.22 - Parent Placer Appointment ID (EI) O S10.6.2.23

    arq_23 : EI | None
        ARQ.23 - Parent Filler Appointment ID (EI) O S10.6.2.24

    arq_24 : list[EI] | None
        ARQ.24 - Placer Order Number (EI) C rep S10.6.2.26

    arq_25 : list[EI] | None
        ARQ.25 - Filler Order Number (EI) C rep S10.6.2.27
    """
