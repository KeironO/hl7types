...
class CSP(HL7Model):
    ...
    ----------
    csp_1 : CE
        CSP.1 (req) - Study Phase Identifier (CE) S8.11.3.2

    csp_2 : TS
        CSP.2 (req) - Date/time Study Phase Began (TS) S7.8.2.2

    csp_3 : TS | None
        CSP.3 (opt) - Date/time Study Phase Ended (TS) S7.8.2.3

    csp_4 : CE | None
        CSP.4 (opt) - Study Phase Evaluability (CE) S7.8.2.4
    """
