...
class CSP(HL7Model):
    ...
    ----------
    csp_1 : CE
        CSP.1 - Study Phase Identifier (CE) R S8.11.3.2

    csp_2 : TS
        CSP.2 - Date/time Study Phase Began (TS) R S7.8.2.2

    csp_3 : TS | None
        CSP.3 - Date/time Study Phase Ended (TS) O S7.8.2.3

    csp_4 : CE | None
        CSP.4 - Study Phase Evaluability (CE) C S7.8.2.4
    """
