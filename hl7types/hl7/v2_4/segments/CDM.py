...
class CDM(HL7Model):
    ...
    ----------
    cdm_1 : CE
        CDM.1 - Primary Key Value - CDM (CE) R S8.10.2.1 | 0132 - Transaction code

    cdm_2 : list[CE] | None
        CDM.2 - Charge Code Alias (CE) O rep S8.10.2.2 | 9999 - for unknown CE data elements
    ...
    cdm_5 : str | None
        CDM.5 - Description Override Indicator (IS) O S8.10.2.5 | 0268 - Override

    cdm_6 : list[CE] | None
        CDM.6 - Exploding Charges (CE) O rep S8.10.2.6 | 9999 - for unknown CE data elements

    cdm_7 : list[CE] | None
        CDM.7 - Procedure Code (CE) O rep S8.10.2.7 | 0088 - Procedure Code

    cdm_8 : str | None
        CDM.8 - Active/Inactive Flag (ID) O S15.4.6.7 | 0183 - Active/inactive

    cdm_9 : list[CE] | None
        CDM.9 - Inventory Number (CE) O rep S8.10.2.9 | 0463 - Inventory number

    cdm_10 : str | None
        CDM.10 - Resource Load (NM) O S8.10.2.10

    cdm_11 : list[CK] | None
        CDM.11 - Contract Number (CK) O rep S8.10.2.11
    ...
    cdm_2: Optional[List[CE]] = Field(
        ...
        description=(
            "O | Item #00983 | Table 9999 - for unknown CE data elements"
        ),
    )
    ...
    cdm_6: Optional[List[CE]] = Field(
        ...
        description=(
            "O | Item #00987 | Table 9999 - for unknown CE data elements"
        ),
    )
