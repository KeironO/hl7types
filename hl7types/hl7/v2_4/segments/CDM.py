...
class CDM(HL7Model):
    ...
    cdm_2 : list[CE] | None
        CDM.2 (opt, rep) - Charge Code Alias (CE) S8.10.2.2 | 9999 - for unknown CE data elements
    ...
    cdm_6 : list[CE] | None
        CDM.6 (opt, rep) - Exploding Charges (CE) S8.10.2.6 | 9999 - for unknown CE data elements

    cdm_7 : list[CE] | None
        CDM.7 (opt, rep) - Procedure Code (CE) S8.10.2.7 | 0088 - Procedure Code

    cdm_8 : str | None
        CDM.8 (opt) - Active/Inactive Flag (ID) S15.4.6.7 | 0183 - Active/inactive
    ...
    cdm_11 : list[CK] | None
        CDM.11 (opt, rep) - Contract Number (CK) S8.10.2.11
    ...
    cdm_2: Optional[List[CE]] = Field(
        ...
        description="Item #983 | Table HL79999",
    )
    ...
    cdm_6: Optional[List[CE]] = Field(
        ...
        description="Item #987 | Table HL79999",
    )
