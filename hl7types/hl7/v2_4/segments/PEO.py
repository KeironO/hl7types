...
class PEO(HL7Model):
    ...
    ----------
    peo_1 : list[CE] | None
        PEO.1 - Event Identifiers Used (CE) O rep S7.12.2.1

    peo_2 : list[CE] | None
        PEO.2 - Event Symptom/Diagnosis Code (CE) O rep S7.12.2.2

    peo_3 : TS
        PEO.3 - Event Onset Date/Time (TS) R S7.12.2.3

    peo_4 : TS | None
        PEO.4 - Event Exacerbation Date/Time (TS) O S7.12.2.4

    peo_5 : TS | None
        PEO.5 - Event Improved Date/Time (TS) O S7.12.2.5

    peo_6 : TS | None
        PEO.6 - Event Ended Data/Time (TS) O S7.12.2.6
    ...
    peo_14 : list[str] | None
        PEO.14 - Event From Original Reporter (FT) O rep S7.12.2.14
    ...
    peo_18 : list[CE] | None
        PEO.18 - Cause Of Death (CE) O rep S7.12.2.18
    ...
    peo_24 : TS | None
        PEO.24 - Primary Observer Aware Date/Time (TS) O S7.12.2.24
