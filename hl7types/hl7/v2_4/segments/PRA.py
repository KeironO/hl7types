...
class PRA(HL7Model):
    ...
    ----------
    pra_1 : CE | None
        PRA.1 (opt) - Primary Key Value - PRA (CE) S15.4.5.1 | 9999 - for unknown CE data elements

    pra_2 : list[CE] | None
        PRA.2 (opt, rep) - Practitioner Group (CE) S15.4.5.2 | 0358 - Practitioner group

    pra_3 : list[str] | None
        PRA.3 (opt, rep) - Practitioner Category (IS) S15.4.5.3 | 0186 - Practitioner category

    pra_4 : str | None
        PRA.4 (opt) - Provider Billing (ID) S15.4.5.4 | 0187 - Provider billing

    pra_5 : list[SPD] | None
        PRA.5 (opt, rep) - Specialty (SPD) S15.4.5.5 | 0337 - Certification status

    pra_6 : list[PLN] | None
        PRA.6 (opt, rep) - Practitioner ID Numbers (PLN) S15.4.5.6 | 0338 - Practitioner ID number type

    pra_7 : list[PIP] | None
        PRA.7 (opt, rep) - Privileges (PIP) S15.4.5.7

    pra_8 : str | None
        PRA.8 (opt) - Date Entered Practice (DT) S15.4.5.8

    pra_9 : CE | None
        PRA.9 (opt) - Institution (CE) S15.4.5.9

    pra_10 : str | None
        PRA.10 (opt) - Date Left Practice (DT) S15.4.5.10

    pra_11 : list[CE] | None
        PRA.11 (opt, rep) - Government Reimbursement Billing Eligibility (CE) S15.4.5.11 | 0401 - Government reimbursement program

    pra_12 : str | None
        PRA.12 (opt) - Set ID - PRA (SI) S15.4.5.12
    """
