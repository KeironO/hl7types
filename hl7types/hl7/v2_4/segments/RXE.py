...
class RXE(HL7Model):
    ...
    ----------
    rxe_1 : TQ
        RXE.1 - Quantity/Timing (TQ) R S7.4.1.27

    rxe_2 : CE
        RXE.2 - Give Code (CE) R S4.14.6.4 | 0292 - Vaccines administered

    rxe_3 : str
        RXE.3 - Give Amount - Minimum (NM) R S4.14.6.5

    rxe_4 : str | None
        RXE.4 - Give Amount - Maximum (NM) O S4.14.6.6

    rxe_5 : CE
        RXE.5 - Give Units (CE) R S4.14.6.7

    rxe_6 : CE | None
        RXE.6 - Give Dosage Form (CE) O S4.14.6.8

    rxe_7 : list[CE] | None
        RXE.7 - Provider's Administration Instructions (CE) O rep S4

    rxe_8 : LA1 | None
        RXE.8 - Deliver-To Location (LA1) C S4.14.4.8

    rxe_9 : str | None
        RXE.9 - Substitution Status (ID) O S4.14.6.10 | 0167 - Substitution status
    ...
    rxe_12 : str | None
        RXE.12 - Number of Refills (NM) O S4.14.4.12

    rxe_13 : list[XCN] | None
        RXE.13 - Ordering Provider's DEA Number (XCN) C rep S4

    rxe_14 : list[XCN] | None
        RXE.14 - Pharmacist/Treatment Supplier's Verifier ID (XCN) O rep S4.14.1.15

    rxe_15 : str | None
        RXE.15 - Prescription Number (ST) C S4.14.5.7

    rxe_16 : str | None
        RXE.16 - Number of Refills Remaining (NM) C S4.14.5.8
    ...
    rxe_19 : CQ | None
        RXE.19 - Total Daily Dose (CQ) C S4.14.5.12

    rxe_20 : str | None
        RXE.20 - Needs Human Review (ID) O S4.14.6.12 | 0136 - Yes/no indicator

    rxe_21 : list[CE] | None
        RXE.21 - Pharmacy/Treatment Supplier's Special Dispensing Instructions (CE) O rep S4.14.5.15

    rxe_22 : str | None
        RXE.22 - Give Per (Time Unit) (ST) C S4.14.6.14

    rxe_23 : str | None
        RXE.23 - Give Rate Amount (ST) O S4.14.6.15

    rxe_24 : CE | None
        RXE.24 - Give Rate Units (CE) O S4.14.6.16

    rxe_25 : str | None
        RXE.25 - Give Strength (NM) O S4.14.6.17

    rxe_26 : CE | None
        RXE.26 - Give Strength Units (CE) O S4.14.6.18

    rxe_27 : list[CE] | None
        RXE.27 - Give Indication (CE) O rep S4.14.4.27

    rxe_28 : str | None
        RXE.28 - Dispense Package Size (NM) O S4.14.5.22

    rxe_29 : CE | None
        RXE.29 - Dispense Package Size Unit (CE) O S4.14.5.23

    rxe_30 : str | None
        RXE.30 - Dispense Package Method (ID) O S4.14.5.24 | 0321 - Dispense method

    rxe_31 : list[CE] | None
        RXE.31 - Supplementary Code (CE) O rep S4.14.5.25
    """
