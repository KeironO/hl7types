...
class OM3(HL7Model):
    ...
    ----------
    om3_1 : str | None
        OM3.1 (opt) - Sequence Number - Test/ Observation Master File (NM) S8.8.9.1

    om3_2 : CE | None
        OM3.2 (opt) - Preferred Coding System (CE) S8.8.5.2 | 9999 - for unknown CE data elements

    om3_3 : CE | None
        OM3.3 (opt) - Valid Coded "Answers" (CE) S8.8.5.3 | 9999 - for unknown CE data elements

    om3_4 : list[CE] | None
        OM3.4 (opt, rep) - Normal Text/Codes for Categorical Observations (CE) S8.8.5.4 | 9999 - for unknown CE data elements

    om3_5 : CE | None
        OM3.5 (opt) - Abnormal Text/Codes for Categorical Observations (CE) S8.8.5.5 | 9999 - for unknown CE data elements

    om3_6 : CE | None
        OM3.6 (opt) - Critical Text/Codes for Categorical Observations (CE) S8.8.5.6 | 9999 - for unknown CE data elements

    om3_7 : str | None
        OM3.7 (opt) - Value Type (ID) S8.8.5.7 | 0125 - Value type
    """
