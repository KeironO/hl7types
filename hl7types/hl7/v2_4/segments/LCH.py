...
class LCH(HL7Model):
    ...
    lch_2 : str | None
        LCH.2 (opt) - Segment Action Code (ID) S10.6.7.2 | 0206 - Segment action code

    lch_3 : EI | None
        LCH.3 (opt) - Segment Unique Key (EI) S8.9.4.3

    lch_4 : CE
        LCH.4 (req) - Location Characteristic ID (CE) S8.9.3.4 | 0324 - Location characteristic ID

    lch_5 : CE
        LCH.5 (req) - Location Characteristic Value-LCH (CE) S8.9.3.5 | 0136 - Yes/no indicator
    """
