...
class LCH(HL7Model):
    ...
    lch_2 : str | None
        LCH.2 - Segment Action Code (ID) O S10.6.7.2 | 0206 - Segment action code

    lch_3 : EI | None
        LCH.3 - Segment Unique Key (EI) O S8.9.4.3

    lch_4 : CE
        LCH.4 - Location Characteristic ID (CE) R S8.9.3.4 | 0324 - Location characteristic ID

    lch_5 : CE
        LCH.5 - Location Characteristic Value-LCH (CE) R S8.9.3.5 | 0136 - Yes/no indicator
    """
