...
class IAM(HL7Model):
    ...
    iam_2 : CE | None
        IAM.2 (opt) - Allergen Type Code (CE) S3.4.7.2 | 0127 - Allergen type

    iam_3 : CE
        IAM.3 (req) - Allergen Code/Mnemonic/Description (CE) S3.4.7.3

    iam_4 : CE | None
        IAM.4 (opt) - Allergy Severity Code (CE) S3.4.7.4 | 0128 - Allergy severity

    iam_5 : list[str] | None
        IAM.5 (opt, rep) - Allergy Reaction Code (ST) S3.4.7.5

    iam_6 : CNE
        IAM.6 (req) - Allergy Action Code (CNE) S3.4.7.6 | 0323 - Action code

    iam_7 : EI
        IAM.7 (req) - Allergy Unique Identifier (EI) S3.4.7.7
