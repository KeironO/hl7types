...
class UB2(HL7Model):
    ...
    ub2_6 : list[UVC] | None
        UB2.6 (opt, rep) - Value Amount & Code (UVC) S6.5.11.6 | 0153 - Value code

    ub2_7 : list[OCD] | None
        UB2.7 (opt, rep) - Occurrence Code & Date (32-35) (OCD) S6.5.11.7 | 0350 - Occurrence code

    ub2_8 : list[OSP] | None
        UB2.8 (opt, rep) - Occurrence Span Code/Dates (36) (OSP) S6.5.11.8 | 0351 - Occurrence span
