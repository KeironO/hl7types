...
class TXA(HL7Model):
    ...
    ----------
    txa_1 : str
        TXA.1 - Set ID- TXA (SI) R S9.6.1.1

    txa_2 : str
        TXA.2 - Document Type (IS) R S9.6.1.2 | 0270 - Document type

    txa_3 : str | None
        TXA.3 - Document Content Presentation (ID) C S9.6.1.3 | 0191 - Type of referenced data

    txa_4 : TS | None
        TXA.4 - Activity Date/Time (TS) O S9.6.1.4

    txa_5 : list[XCN] | None
        TXA.5 - Primary Activity Provider Code/Name (XCN) C rep S9.6.1.5

    txa_6 : TS | None
        TXA.6 - Origination Date/Time (TS) O S9.6.1.6

    txa_7 : TS | None
        TXA.7 - Transcription Date/Time (TS) C S9.6.1.7

    txa_8 : list[TS] | None
        TXA.8 - Edit Date/Time (TS) O rep S9.6.1.8

    txa_9 : list[XCN] | None
        TXA.9 - Originator Code/Name (XCN) O rep S9.6.1.9

    txa_10 : list[XCN] | None
        TXA.10 - Assigned Document Authenticator (XCN) O rep S9.6.1.10

    txa_11 : list[XCN] | None
        TXA.11 - Transcriptionist Code/Name (XCN) C rep S9.6.1.11

    txa_12 : EI
        TXA.12 - Unique Document Number (EI) R S9.6.1.12

    txa_13 : EI | None
        TXA.13 - Parent Document Number (EI) C S9.6.1.13

    txa_14 : list[EI] | None
        TXA.14 - Placer Order Number (EI) O rep S10.6.2.26

    txa_15 : EI | None
        TXA.15 - Filler Order Number (EI) O S10.6.2.27

    txa_16 : str | None
        TXA.16 - Unique Document File Name (ST) O S9.6.1.16

    txa_17 : str
        TXA.17 - Document Completion Status (ID) R S9.6.1.17 | 0271 - Document completion status

    txa_18 : str | None
        TXA.18 - Document Confidentiality Status (ID) O S9.6.1.18 | 0272 - Document confidentiality status

    txa_19 : str | None
        TXA.19 - Document Availability Status (ID) O S9.6.1.19 | 0273 - Document availability status

    txa_20 : str | None
        TXA.20 - Document Storage Status (ID) O S9.6.1.20 | 0275 - Document storage status

    txa_21 : str | None
        TXA.21 - Document Change Reason (ST) C S9.6.1.21

    txa_22 : list[PPN] | None
        TXA.22 - Authentication Person, Time Stamp (PPN) C rep S9.6.1.22

    txa_23 : list[XCN] | None
        TXA.23 - Distributed Copies (Code and Name of Recipients) (XCN) O rep S9.6.1.23
    """
