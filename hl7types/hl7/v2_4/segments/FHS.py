...
class FHS(HL7Model):
    ...
    ----------
    fhs_1 : str
        FHS.1 - File Field Separator (ST) R S2.16.6.1

    fhs_2 : str
        FHS.2 - File Encoding Characters (ST) R S2.16.6.2

    fhs_3 : str | None
        FHS.3 - File Sending Application (ST) O S2.16.6.3

    fhs_4 : str | None
        FHS.4 - File Sending Facility (ST) O S2.16.6.4

    fhs_5 : str | None
        FHS.5 - File Receiving Application (ST) O S2.16.6.5

    fhs_6 : str | None
        FHS.6 - File Receiving Facility (ST) O S2.16.6.6

    fhs_7 : TS | None
        FHS.7 - File Creation Date/Time (TS) O S2.16.6.7

    fhs_8 : str | None
        FHS.8 - File Security (ST) O S2.16.6.8

    fhs_9 : str | None
        FHS.9 - File Name/ID (ST) O S2.16.6.9

    fhs_10 : str | None
        FHS.10 - File Header Comment (ST) O S2.16.6.10

    fhs_11 : str | None
        FHS.11 - File Control ID (ST) O S2.16.6.11

    fhs_12 : str | None
        FHS.12 - Reference File Control ID (ST) O S2.16.6.12
    """
