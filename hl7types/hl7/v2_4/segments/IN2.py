...
class IN2(HL7Model):
    ...
    in2_4 : str | None
        IN2.4 (opt) - Employer Information Data (IS) S6.5.7.4 | 0139 - Employer information data

    in2_5 : list[str] | None
        IN2.5 (opt, rep) - Mail Claim Party (IS) S6.5.7.5 | 0137 - Mail claim party
    ...
    in2_11 : CE | None
        IN2.11 (opt) - Dependent Of Military Recipient (CE) S6.5.7.11 | 0342 - Military recipient
    ...
    in2_14 : str | None
        IN2.14 (opt) - Military Service (IS) S6.5.7.14 | 0140 - Military service

    in2_15 : str | None
        IN2.15 (opt) - Military Rank/Grade (IS) S6.5.7.15 | 0141 - Military rank/grade

    in2_16 : str | None
        IN2.16 (opt) - Military Status (IS) S6.5.7.16 | 0142 - Military status
    ...
    in2_24 : list[str] | None
        IN2.24 (opt, rep) - Non-Covered Insurance Code (IS) S6.5.7.24 | 0143 - Non-covered insurance code
    ...
    in2_27 : str | None
        IN2.27 (opt) - Eligibility Source (IS) S6.5.7.27 | 0144 - Eligibility source

    in2_28 : list[RMC] | None
        IN2.28 (opt, rep) - Room Coverage Type/Amount (RMC) S6.5.7.28 | 0145 - Room type

    in2_29 : list[PTA] | None
        IN2.29 (opt, rep) - Policy Type/Amount (PTA) S6.5.7.29 | 0147 - Policy type

    in2_30 : DDI | None
        IN2.30 (opt) - Daily Deductible (DDI) S6.5.7.30

    in2_31 : str | None
        IN2.31 (opt) - Living Dependency (IS) S6.5.7.31 | 0223 - Living dependency

    in2_32 : list[str] | None
        IN2.32 (opt, rep) - Ambulatory Status (IS) S6.5.7.32 | 0009 - Ambulatory status

    in2_33 : list[CE] | None
        IN2.33 (opt, rep) - Citizenship (CE) S6.5.7.33 | 0171 - Citizenship

    in2_34 : CE | None
        IN2.34 (opt) - Primary Language (CE) S6.5.7.34 | 0296 - Primary language

    in2_35 : str | None
        IN2.35 (opt) - Living Arrangement (IS) S6.5.7.35 | 0220 - Living arrangement

    in2_36 : CE | None
        IN2.36 (opt) - Publicity Code (CE) S6.5.7.36 | 0215 - Publicity code

    in2_37 : str | None
        IN2.37 (opt) - Protection Indicator (ID) S6.5.7.37 | 0136 - Yes/no indicator

    in2_38 : str | None
        IN2.38 (opt) - Student Indicator (IS) S6.5.7.38 | 0231 - Student status

    in2_39 : CE | None
        IN2.39 (opt) - Religion (CE) S6.5.7.39 | 0006 - Religion

    in2_40 : list[XPN] | None
        IN2.40 (opt, rep) - Mother's Maiden Name (XPN) S6.5.7.40

    in2_41 : CE | None
        IN2.41 (opt) - Nationality (CE) S6.5.7.41 | 0212 - Nationality

    in2_42 : list[CE] | None
        IN2.42 (opt, rep) - Ethnic Group (CE) S15.4.6.28 | 0189 - Ethnic group

    in2_43 : list[CE] | None
        IN2.43 (opt, rep) - Marital Status (CE) S15.4.6.17 | 0002 - Marital status

    in2_44 : str | None
        IN2.44 (opt) - Insured's Employment Start Date (DT) S6.5.7.44

    in2_45 : str | None
        IN2.45 (opt) - Employment Stop Date (DT) S6.5.7.45

    in2_46 : str | None
        IN2.46 (opt) - Job Title (ST) S15.4.6.18

    in2_47 : JCC | None
        IN2.47 (opt) - Job Code/Class (JCC) S15.4.6.19 | 0327 - Job code/class

    in2_48 : str | None
        IN2.48 (opt) - Job Status (IS) S6.5.7.48 | 0311 - Job status
    ...
    in2_51 : str | None
        IN2.51 (opt) - Employer Contact Reason (IS) S6.5.7.51 | 0222 - Contact reason
    ...
    in2_54 : list[str] | None
        IN2.54 (opt, rep) - Insured's Contact Person Reason (IS) S6.5.7.54 | 0222 - Contact reason
    ...
    in2_57 : str | None
        IN2.57 (opt) - Insurance Co. Contact Reason (IS) S6.5.7.57 | 0232 - Insurance company contact reason

    in2_58 : XTN | None
        IN2.58 (opt) - Insurance Co Contact Phone Number (XTN) S6.5.7.58

    in2_59 : str | None
        IN2.59 (opt) - Policy Scope (IS) S6.5.7.59 | 0312 - Policy scope

    in2_60 : str | None
        IN2.60 (opt) - Policy Source (IS) S6.5.7.60 | 0313 - Policy source

    in2_61 : CX | None
        IN2.61 (opt) - Patient Member Number (CX) S6.5.7.61

    in2_62 : CE | None
        IN2.62 (opt) - Guarantor's Relationship To Insured (CE) S6.5.7.62 | 0063 - Relationship
    ...
    in2_65 : CE | None
        IN2.65 (opt) - Military Handicapped Program (CE) S6.5.7.65 | 0343 - Military handicapped program code
    ...
    in2_71 : list[CE] | None
        IN2.71 (opt, rep) - Race (CE) S15.4.6.27 | 0005 - Race

    in2_72 : CE | None
        IN2.72 (opt) - HCFA Patient's Relationship to Insured (CE) S6.5.7.72 | 0344 - Patient's relationship to insured
    """
