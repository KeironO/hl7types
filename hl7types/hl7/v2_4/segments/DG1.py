...
class DG1(HL7Model):
    ...
    dg1_8 : CE | None
        DG1.8 - Diagnostic Related Group (CE) O S6.5.3.1 | 0055 - Diagnosis related group

    dg1_9 : str | None
        DG1.9 - DRG Approval Indicator (ID) O S6.5.3.3 | 0136 - Yes/no indicator

    dg1_10 : str | None
        DG1.10 - DRG Grouper Review Code (IS) O S6.5.3.4 | 0056 - DRG grouper review code

    dg1_11 : CE | None
        DG1.11 - Outlier Type (CE) O S6.5.3.5 | 0083 - Outlier type

    dg1_12 : str | None
        DG1.12 - Outlier Days (NM) O S6.5.3.6
    ...
    dg1_18 : str | None
        DG1.18 - Confidential Indicator (ID) O S6.5.3.10 | 0136 - Yes/no indicator
