...
class FT1(HL7Model):
    ...
    ft1_4 : TS
        FT1.4 (req) - Transaction Date (TS) S6.5.1.4
    ...
    ft1_14 : CE | None
        FT1.14 (opt) - Insurance Plan ID (CE) S6.5.6.2 | 0072 - Insurance plan ID

    ft1_15 : CP | None
        FT1.15 (opt) - Insurance Amount (CP) S6.5.1.15

    ft1_16 : PL | None
        FT1.16 (opt) - Assigned Patient Location (PL) S6.5.1.16

    ft1_17 : str | None
        FT1.17 (opt) - Fee Schedule (IS) S6.5.1.17 | 0024 - Fee schedule

    ft1_18 : str | None
        FT1.18 (opt) - Patient Type (IS) S6.5.1.18 | 0018 - Patient type
    ...
    ft1_23 : EI | None
        FT1.23 (opt) - Filler Order Number (EI) S10.6.2.27

    ft1_24 : list[XCN] | None
        FT1.24 (opt, rep) - Entered By Code (XCN) S6.5.1.24

    ft1_25 : CE | None
        FT1.25 (opt) - Procedure Code (CE) S8.10.2.7 | 0088 - Procedure Code

    ft1_26 : list[CE] | None
        FT1.26 (opt, rep) - Procedure Code Modifier (CE) S7.4.1.45 | 0340 - Procedure Code modifier
    """
