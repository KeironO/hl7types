...
class NK1(HL7Model):
    ...
    nk1_7 : CE | None
        NK1.7 - Contact Role (CE) O S11.6.4.1 | 0131 - Contact Role
    ...
    nk1_11 : JCC | None
        NK1.11 - Next of Kin / Associated Parties Job Code/Class (JCC) O S3.4.5.11 | 0327 - Job code/class
    ...
    nk1_14 : CE | None
        NK1.14 - Marital Status (CE) O S15.4.6.17 | 0002 - Marital status

    nk1_15 : str | None
        NK1.15 - Administrative Sex (IS) O S15.4.6.5 | 0001 - Administrative sex

    nk1_16 : TS | None
        NK1.16 - Date/Time Of Birth (TS) O S15.4.6.6

    nk1_17 : list[str] | None
        NK1.17 - Living Dependency (IS) O rep S6.5.7.31 | 0223 - Living dependency

    nk1_18 : list[str] | None
        NK1.18 - Ambulatory Status (IS) O rep S6.5.7.32 | 0009 - Ambulatory status

    nk1_19 : list[CE] | None
        NK1.19 - Citizenship (CE) O rep S6.5.7.33 | 0171 - Citizenship

    nk1_20 : CE | None
        NK1.20 - Primary Language (CE) O S6.5.7.34 | 0296 - Primary language

    nk1_21 : str | None
        NK1.21 - Living Arrangement (IS) O S6.5.7.35 | 0220 - Living arrangement

    nk1_22 : CE | None
        NK1.22 - Publicity Code (CE) O S6.5.7.36 | 0215 - Publicity code

    nk1_23 : str | None
        NK1.23 - Protection Indicator (ID) O S6.5.7.37 | 0136 - Yes/no indicator

    nk1_24 : str | None
        NK1.24 - Student Indicator (IS) O S6.5.7.38 | 0231 - Student status

    nk1_25 : CE | None
        NK1.25 - Religion (CE) O S6.5.7.39 | 0006 - Religion

    nk1_26 : list[XPN] | None
        NK1.26 - Mother's Maiden Name (XPN) O rep S6.5.7.40

    nk1_27 : CE | None
        NK1.27 - Nationality (CE) O S6.5.7.41 | 0212 - Nationality

    nk1_28 : list[CE] | None
        NK1.28 - Ethnic Group (CE) O rep S15.4.6.28 | 0189 - Ethnic group

    nk1_29 : list[CE] | None
        NK1.29 - Contact Reason (CE) O rep S6.5.5.47 | 0222 - Contact reason

    nk1_30 : list[XPN] | None
        NK1.30 - Contact Person's Name (XPN) O rep S6.5.5.45

    nk1_31 : list[XTN] | None
        NK1.31 - Contact Person's Telephone Number (XTN) O rep S6.5.5.46
    ...
    nk1_34 : str | None
        NK1.34 - Job Status (IS) O S6.5.7.48 | 0311 - Job status

    nk1_35 : list[CE] | None
        NK1.35 - Race (CE) O rep S15.4.6.27 | 0005 - Race

    nk1_36 : str | None
        NK1.36 - Handicap (IS) O S6.5.6.48 | 0295 - Handicap
