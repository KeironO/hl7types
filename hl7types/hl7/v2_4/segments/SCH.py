...
class SCH(HL7Model):
    ...
    ----------
    sch_1 : EI | None
        SCH.1 (opt) - Placer Appointment ID (EI) S10.6.2.1

    sch_2 : EI | None
        SCH.2 (opt) - Filler Appointment ID (EI) S10.6.2.2

    sch_3 : str | None
        SCH.3 (opt) - Occurrence Number (NM) S10.6.2.3

    sch_4 : EI | None
        SCH.4 (opt) - Placer Group Number (EI) S10.6.2.4

    sch_5 : CE | None
        SCH.5 (opt) - Schedule ID (CE) S10.6.2.5

    sch_6 : CE
        SCH.6 (req) - Event Reason (CE) S10.6.2.6

    sch_7 : CE | None
        SCH.7 (opt) - Appointment Reason (CE) S10.6.2.7 | 0276 - Appointment reason codes

    sch_8 : CE | None
        SCH.8 (opt) - Appointment Type (CE) S10.6.2.8 | 0277 - Appointment type codes

    sch_9 : str | None
        SCH.9 (opt) - Appointment Duration (NM) S10.6.2.9

    sch_10 : CE | None
        SCH.10 (opt) - Appointment Duration Units (CE) S10.6.2.10

    sch_11 : list[TQ]
        SCH.11 (req, rep) - Appointment Timing Quantity (TQ) S10.6.2.11

    sch_12 : list[XCN] | None
        SCH.12 (opt, rep) - Placer Contact Person (XCN) S10.6.2.12

    sch_13 : XTN | None
        SCH.13 (opt) - Placer Contact Phone Number (XTN) S10.6.2.13

    sch_14 : list[XAD] | None
        SCH.14 (opt, rep) - Placer Contact Address (XAD) S10.6.2.14

    sch_15 : PL | None
        SCH.15 (opt) - Placer Contact Location (PL) S10.6.2.15
    ...
    sch_20 : list[XCN]
        SCH.20 (req, rep) - Entered By Person (XCN) S10.6.2.20

    sch_21 : list[XTN] | None
        SCH.21 (opt, rep) - Entered By Phone Number (XTN) S10.6.2.21

    sch_22 : PL | None
        SCH.22 (opt) - Entered by Location (PL) S10.6.2.22

    sch_23 : EI | None
        SCH.23 (opt) - Parent Placer Appointment ID (EI) S10.6.2.23

    sch_24 : EI | None
        SCH.24 (opt) - Parent Filler Appointment ID (EI) S10.6.2.24

    sch_25 : CE | None
        SCH.25 (opt) - Filler Status Code (CE) S10.6.7.12 | 0278 - Filler status codes

    sch_26 : list[EI] | None
        SCH.26 (opt, rep) - Placer Order Number (EI) S10.6.2.26

    sch_27 : list[EI] | None
        SCH.27 (opt, rep) - Filler Order Number (EI) S10.6.2.27
    """
