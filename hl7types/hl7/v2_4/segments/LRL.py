...
class LRL(HL7Model):
    ...
    lrl_2 : str | None
        LRL.2 - Segment Action Code (ID) O S10.6.7.2 | 0206 - Segment action code

    lrl_3 : EI | None
        LRL.3 - Segment Unique Key (EI) O S8.9.4.3

    lrl_4 : CE
        LRL.4 - Location Relationship ID (CE) R S8.9.4.4 | 0325 - Location relationship ID
