...
class MFE(HL7Model):
    ...
    ----------
    mfe_1 : str
        MFE.1 - Record-Level Event Code (ID) R S8.5.3.1 | 0180 - Record-level event code

    mfe_2 : str | None
        MFE.2 - MFN Control ID (ST) C S8.5.3.2

    mfe_3 : TS | None
        MFE.3 - Effective Date/Time (TS) O S8.5.2.3

    mfe_4 : list[str]
        MFE.4 - Primary Key Value - MFE (*) R rep S8.5.2.4
