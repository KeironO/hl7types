...
class NST(HL7Model):
    ...
    nst_2 : str | None
        NST.2 - Source Identifier (ST) NA S14.4.3.2

    nst_3 : str | None
        NST.3 - Source Type (ID) NA S14.4.3.3 | 0332 - Source type

    nst_4 : TS | None
        NST.4 - Statistics Start (TS) NA S14.4.3.4

    nst_5 : TS | None
        NST.5 - Statistics End (TS) NA S14.4.3.5

    nst_6 : str | None
        NST.6 - Receive Character Count (NM) NA S14.4.3.6

    nst_7 : str | None
        NST.7 - Send Character Count (NM) NA S14.4.3.7

    nst_8 : str | None
        NST.8 - Messages Received (NM) NA S14.4.3.8

    nst_9 : str | None
        NST.9 - Messages Sent (NM) NA S14.4.3.9

    nst_10 : str | None
        NST.10 - Checksum Errors Received (NM) NA S14.4.3.10

    nst_11 : str | None
        NST.11 - Length Errors Received (NM) NA S14.4.3.11

    nst_12 : str | None
        NST.12 - Other Errors Received (NM) NA S14.4.3.12

    nst_13 : str | None
        NST.13 - Connect Timeouts (NM) NA S14.4.3.13

    nst_14 : str | None
        NST.14 - Receive Timeouts (NM) NA S14.4.3.14

    nst_15 : str | None
        NST.15 - Application control-level Errors (NM) NA S14.4.3.15
    """
    ...
    nst_3: Optional[str] = Field(
        ...
        title="Source Type",
        description="NA | Item #01175 | Table 0332 - Source type | LEN:3",
    )
