...
class MSH(HL7Model):
    """Message Header (S2.16.9).

    Attributes
    ----------
    msh_1 : str
        MSH.1 - Field Separator (ST) R S2.16.9.1

    msh_2 : str
        MSH.2 - Encoding Characters (ST) R S2.16.9.2

    msh_3 : HD | None
        MSH.3 - Sending Application (HD) O S2.16.9.3 | 0361 - Sending/receiving application

    msh_4 : HD | None
        MSH.4 - Sending Facility (HD) O S2.16.9.4 | 0362 - Sending/receiving facility

    msh_5 : HD | None
        MSH.5 - Receiving Application (HD) O S2.16.9.5 | 0361 - Sending/receiving application

    msh_6 : HD | None
        MSH.6 - Receiving Facility (HD) O S2.16.9.6 | 0362 - Sending/receiving facility

    msh_7 : TS
        MSH.7 - Date/Time Of Message (TS) R S2.16.9.7

    msh_8 : str | None
        MSH.8 - Security (ST) O S2.16.9.8

    msh_9 : MSG
        MSH.9 - Message Type (MSG) R S2.16.9.9 | 0076 - Message type

    msh_10 : str
        MSH.10 - Message Control ID (ST) R S2.16.9.10

    msh_11 : PT
        MSH.11 - Processing ID (PT) R S2.16.9.11

    msh_12 : VID
        MSH.12 - Version ID (VID) R S2.16.9.12 | 0104 - Version ID

    msh_13 : str | None
        MSH.13 - Sequence Number (NM) O S2.16.9.13

    msh_14 : str | None
        MSH.14 - Continuation Pointer (ST) O S2.16.9.14

    msh_15 : str | None
        MSH.15 - Accept Acknowledgment Type (ID) O S2.16.9.15 | 0155 - Accept/application acknowledgment conditions

    msh_16 : str | None
        MSH.16 - Application Acknowledgment Type (ID) O S2.16.9.16 | 0155 - Accept/application acknowledgment conditions

    msh_17 : str | None
        MSH.17 - Country Code (ID) O S2.16.9.17 | 0399 - Country code

    msh_18 : list[str] | None
        MSH.18 - Character Set (ID) O rep S2.16.9.18 | 0211 - Alternate character sets

    msh_19 : CE | None
        MSH.19 - Principal Language Of Message (CE) O S2.16.9.19

    msh_20 : str | None
        MSH.20 - Alternate Character Set Handling Scheme (ID) O S2.16.9.20 | 0356 - Alternate character set handling scheme

    msh_21 : list[str] | None
        MSH.21 - Conformance Statement ID (ID) O rep S2.16.9.21 | 0449 - Conformance statements
    """
    ...
    msh_3: Optional[HD] = Field(
        ...
        description=(
            "O | Item #00003 | Table 0361 - Sending/receiving application"
        ),
    )
    ...
    msh_4: Optional[HD] = Field(
        ...
        description="O | Item #00004 | Table 0362 - Sending/receiving facility",
    )
    ...
    msh_5: Optional[HD] = Field(
        ...
        description=(
            "O | Item #00005 | Table 0361 - Sending/receiving application"
        ),
    )
    ...
    msh_6: Optional[HD] = Field(
        ...
        description="O | Item #00006 | Table 0362 - Sending/receiving facility",
    )
    ...
    msh_12: VID = Field(
        ...
        title="Version ID",
        description="R | Item #00012 | Table 0104 - Version ID",
    )
    ...
    msh_21: Optional[List[str]] = Field(
        default=None,
        validation_alias=AliasChoices(
            "msh_21",
            "conformance_statement_id",
            "MSH.21",
        ),
        serialization_alias="MSH.21",
        title="Conformance Statement ID",
        description=(
            "O | Item #01598 | Table 0449 - Conformance statements | LEN:10"
        ),
    )
