...
class DRG(HL7Model):
    ...
    ----------
    drg_1 : CE | None
        DRG.1 - Diagnostic Related Group (CE) O S6.5.3.1 | 0055 - Diagnosis related group
    ...
    drg_5 : CE | None
        DRG.5 - Outlier Type (CE) O S6.5.3.5 | 0083 - Outlier type
    ...
    drg_10 : str | None
        DRG.10 - Confidential Indicator (ID) O S6.5.3.10 | 0136 - Yes/no indicator
