...
class URD(HL7Model):
    ...
    ----------
    urd_1 : TS | None
        URD.1 - R/U Date/Time (TS) O S5.10.5.6.1

    urd_2 : str | None
        URD.2 - Report Priority (ID) O S5.10.5.6.2 | 0109 - Report priority

    urd_3 : list[XCN]
        URD.3 - R/U Who Subject Definition (XCN) R rep S5.10.5.6.3

    urd_4 : list[CE] | None
        URD.4 - R/U What Subject Definition (CE) O rep S5.10.5.6.4 | 0048 - What subject filter

    urd_5 : list[CE] | None
        URD.5 - R/U What Department Code (CE) O rep S5.10.5.6.5

    urd_6 : list[str] | None
        URD.6 - R/U Display/Print Locations (ST) O rep S5.10.5.6.6

    urd_7 : str | None
        URD.7 - R/U Results Level (ID) O S5.10.5.6.7 | 0108 - Query results level
    """
