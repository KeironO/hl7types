...
class MA(HL7Model):
    ...
    ma_4 : str | None
        MA.4 (opt) - sample 1 from channel 4 (NM)

    ma_5 : str | None
        MA.5 (opt) - sample 1 from channel 5 (NM)

    ma_6 : str | None
        MA.6 (opt) - sample 1 from channel 6 (NM)
    """
    ...
    ma_4: Optional[str] = Field(
        ...
        validation_alias=AliasChoices(
            "ma_4",
            "sample_1_from_channel_4",
            "MA.4",
        ),
        serialization_alias="MA.4",
        title="sample 1 from channel 4",
    )
    ...
    ma_5: Optional[str] = Field(
        ...
        validation_alias=AliasChoices(
            "ma_5",
            "sample_1_from_channel_5",
            "MA.5",
        ),
        serialization_alias="MA.5",
        title="sample 1 from channel 5",
    )
    ...
    ma_6: Optional[str] = Field(
        ...
        validation_alias=AliasChoices(
            "ma_6",
            "sample_1_from_channel_6",
            "MA.6",
        ),
        serialization_alias="MA.6",
        title="sample 1 from channel 6",
    )
