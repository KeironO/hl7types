...
class CNE(HL7Model):
    """Coded with no exceptions (S2.9.8).

    Attributes
    ----------
    cne_1 : str | None
        CNE.1 (opt) - identifier (ST) (ST)

    cne_2 : str | None
        CNE.2 (opt) - text (ST)

    cne_3 : str | None
        CNE.3 (opt) - name of coding system (IS)

    cne_4 : str | None
        CNE.4 (opt) - alternate identifier (ST) (ST)

    cne_5 : str | None
        CNE.5 (opt) - alternate text (ST)

    cne_6 : str | None
        CNE.6 (opt) - name of alternate coding system (IS)
