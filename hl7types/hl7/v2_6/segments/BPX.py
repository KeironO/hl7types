...
class BPX(HL7Model):
    ...
    bpx_4 : str
        BPX.4 - BP Date/Time of Status (DTM) R S4.21.2.4

    bpx_5 : EI | None
        BPX.5 - BC Donation ID (EI) C S4.21.2.5

    bpx_6 : CNE | None
        BPX.6 - BC Component (CNE) C S4.21.2.6 | 9999 - no table for CE

    bpx_7 : CNE | None
        BPX.7 - BC Donation Type / Intended Use (CNE) O S4.21.2.7 | 9999 - no table for CE
    ...
    bpx_11 : CNE | None
        BPX.11 - BP Blood Group (CNE) O S4.21.2.11 | 9999 - no table for CE

    bpx_12 : list[CNE] | None
        BPX.12 - BC Special Testing (CNE) O rep S4.21.2.12 | 9999 - no table for CE

    bpx_13 : str | None
        BPX.13 - BP Expiration Date/Time (DTM) O S4.21.2.13
    ...
    bpx_16 : CWE | None
        BPX.16 - BP Units (CWE) O S4.21.2.16 | 9999 - no table for CE
    ...
    bpx_4: str = Field(
        ...
        description="R | Item #01717 | LEN:24",
    )
    ...
    bpx_13: Optional[str] = Field(
        ...
        description="O | Item #01726 | LEN:24",
    )
