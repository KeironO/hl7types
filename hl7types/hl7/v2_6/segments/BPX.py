...
class BPX(HL7Model):
    ...
    ----------
    bpx_1 : str
        BPX.1 (req) - Set ID - BPX (SI) S4.21.2.1
    ...
    bpx_4 : str
        BPX.4 (req) - BP Date/Time of Status (DTM) S4.21.2.4

    bpx_5 : EI | None
        BPX.5 (opt) - BC Donation ID (EI) S4.21.2.5

    bpx_6 : CNE | None
        BPX.6 (opt) - BC Component (CNE) S4.21.2.6 | 9999 - no table for CE

    bpx_7 : CNE | None
        BPX.7 (opt) - BC Donation Type / Intended Use (CNE) S4.21.2.7 | 9999 - no table for CE
    ...
    bpx_11 : CNE | None
        BPX.11 (opt) - BP Blood Group (CNE) S4.21.2.11 | 9999 - no table for CE

    bpx_12 : list[CNE] | None
        BPX.12 (opt, rep) - BC Special Testing (CNE) S4.21.2.12 | 9999 - no table for CE

    bpx_13 : str | None
        BPX.13 (opt) - BP Expiration Date/Time (DTM) S4.21.2.13
    ...
    bpx_16 : CWE | None
        BPX.16 (opt) - BP Units (CWE) S4.21.2.16 | 9999 - no table for CE
