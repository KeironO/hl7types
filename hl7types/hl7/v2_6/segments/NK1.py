...
class NK1(HL7Model):
    ...
    nk1_7 : CWE | None
        NK1.7 - Contact Role (CWE) O S11.6.4.1 | 0131 - Contact Role
    ...
    nk1_20 : CWE | None
        NK1.20 - Primary Language (CWE) O S3.4.2.15 | 0296 - Primary Language

    nk1_21 : str | None
        NK1.21 - Living Arrangement (IS) O S3.4.10.2 | 0220 - Living Arrangement

    nk1_22 : CWE | None
        NK1.22 - Publicity Code (CWE) O S3.4.10.11 | 0215 - Publicity Code
    ...
    nk1_25 : CWE | None
        NK1.25 - Religion (CWE) O S3.4.2.17 | 0006 - Religion

    nk1_26 : list[XPN] | None
        NK1.26 - Mother's Maiden Name (XPN) O rep S3.4.2.6

    nk1_27 : CWE | None
        NK1.27 - Nationality (CWE) O S3.4.2.28 | 0212 - Nationality
