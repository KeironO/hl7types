...
class CTD(HL7Model):
    ...
    ----------
    ctd_1 : list[CWE]
        CTD.1 - Contact Role (CWE) R rep S11.6.4.1 | 0131 - Contact Role
    ...
    ctd_6 : CWE | None
        CTD.6 - Preferred Method of Contact (CWE) O S11.6.3.6 | 0185 - Preferred method of contact

    ctd_7 : list[PLN] | None
        CTD.7 - Contact Identifiers (PLN) O rep S11.6.4.7 | 0338 - Practitioner ID number type
    """
