...
class CTD(HL7Model):
    ...
    ----------
    ctd_1 : list[CWE]
        CTD.1 (req, rep) - Contact Role (CWE) S11.6.4.1 | 0131 - Contact Role
    ...
    ctd_6 : CWE | None
        CTD.6 (opt) - Preferred Method of Contact (CWE) S11.6.3.6 | 0185 - Preferred method of contact

    ctd_7 : list[PLN] | None
        CTD.7 (opt, rep) - Contact Identifiers (PLN) S11.6.4.7 | 0338 - Practitioner ID number type
    """
