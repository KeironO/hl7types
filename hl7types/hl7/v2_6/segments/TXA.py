...
class TXA(HL7Model):
    ...
    txa_4 : str | None
        TXA.4 (opt) - Activity Date/Time (DTM) S9.6.1.4

    txa_5 : list[XCN] | None
        TXA.5 (opt, rep) - Primary Activity Provider Code/Name (XCN) S9.6.1.5

    txa_6 : str | None
        TXA.6 (opt) - Origination Date/Time (DTM) S9.6.1.6

    txa_7 : str | None
        TXA.7 (opt) - Transcription Date/Time (DTM) S9.6.1.7

    txa_8 : list[str] | None
        TXA.8 (opt, rep) - Edit Date/Time (DTM) S9.6.1.8
    ...
    txa_22 : list[PPN] | None
        TXA.22 (opt, rep) - Authentication Person, Time Stamp (set) (PPN) S9.6.1.22

    txa_23 : list[XCN] | None
        TXA.23 (opt, rep) - Distributed Copies (Code and Name of Recipient(s) ) (XCN) S9.6.1.23
    """
