...
class TXA(HL7Model):
    ...
    txa_4 : str | None
        TXA.4 - Activity Date/Time (DTM) O S9.6.1.4

    txa_5 : list[XCN] | None
        TXA.5 - Primary Activity Provider Code/Name (XCN) C rep S9.6.1.5

    txa_6 : str | None
        TXA.6 - Origination Date/Time (DTM) O S9.6.1.6

    txa_7 : str | None
        TXA.7 - Transcription Date/Time (DTM) C S9.6.1.7

    txa_8 : list[str] | None
        TXA.8 - Edit Date/Time (DTM) O rep S9.6.1.8
    ...
    txa_22 : list[PPN] | None
        TXA.22 - Authentication Person, Time Stamp (set) (PPN) C rep S9.6.1.22

    txa_23 : list[XCN] | None
        TXA.23 - Distributed Copies (Code and Name of Recipient(s) ) (XCN) O rep S9.6.1.23
    """
    ...
    txa_4: Optional[str] = Field(
        ...
        description="O | Item #00917 | LEN:24",
    )
    ...
    txa_6: Optional[str] = Field(
        ...
        description="O | Item #00919 | LEN:24",
    )
    ...
    txa_7: Optional[str] = Field(
        ...
        description="C | Item #00920 | LEN:24",
    )
    ...
    txa_8: Optional[List[str]] = Field(
        ...
        description="O | Item #00921 | LEN:24",
    )
