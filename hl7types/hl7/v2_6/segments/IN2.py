...
class IN2(HL7Model):
    ...
    in2_34 : CWE | None
        IN2.34 - Primary Language (CWE) O S3.4.2.15 | 0296 - Primary Language

    in2_35 : str | None
        IN2.35 - Living Arrangement (IS) O S3.4.10.2 | 0220 - Living Arrangement

    in2_36 : CWE | None
        IN2.36 - Publicity Code (CWE) O S3.4.10.11 | 0215 - Publicity Code
    ...
    in2_39 : CWE | None
        IN2.39 - Religion (CWE) O S3.4.2.17 | 0006 - Religion

    in2_40 : list[XPN] | None
        IN2.40 - Mother's Maiden Name (XPN) O rep S3.4.2.6

    in2_41 : CWE | None
        IN2.41 - Nationality (CWE) O S3.4.2.28 | 0212 - Nationality
