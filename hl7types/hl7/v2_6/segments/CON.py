...
class CON(HL7Model):
    ...
    con_3 : str | None
        CON.3 - Consent Form ID and Version (ST) O S9.9.4.3
    ...
    con_7 : list[str] | None
        CON.7 - Consent Background Information (FT) O rep S9.9.4.7

    con_8 : list[str] | None
        CON.8 - Subject-specific Consent Background Text (FT) O rep S9.9.4.8
    ...
    con_12 : str | None
        CON.12 - Consent Discussion Date/Time (DTM) O S9.9.4.12

    con_13 : str | None
        CON.13 - Consent Decision Date/Time (DTM) O S9.9.4.13

    con_14 : str | None
        CON.14 - Consent Effective Date/Time (DTM) O S9.9.4.14

    con_15 : str | None
        CON.15 - Consent End Date/Time (DTM) O S9.9.4.15
    ...
    con_18 : CWE | None
        CON.18 - Language Translated To (CWE) O S9.9.4.18 | 0296 - Primary Language
    ...
    con_25 : list[str]
        CON.25 - Relationship to Subject (IS) R rep S9.9.4.25 | 0548 - Signatory's Relationship to Subject
    """
    ...
    con_12: Optional[str] = Field(
        ...
        description="O | Item #01787 | LEN:24",
    )
    ...
    con_13: Optional[str] = Field(
        ...
        description="O | Item #01788 | LEN:24",
    )
    ...
    con_14: Optional[str] = Field(
        ...
        description="O | Item #01789 | LEN:24",
    )
    ...
    con_15: Optional[str] = Field(
        ...
        description="O | Item #01790 | LEN:24",
    )
