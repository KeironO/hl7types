...
class CON(HL7Model):
    ...
    con_3 : str | None
        CON.3 (opt) - Consent Form ID and Version (ST) S9.9.4.3
    ...
    con_7 : list[str] | None
        CON.7 (opt, rep) - Consent Background Information (FT) S9.9.4.7

    con_8 : list[str] | None
        CON.8 (opt, rep) - Subject-specific Consent Background Text (FT) S9.9.4.8
    ...
    con_12 : str | None
        CON.12 (opt) - Consent Discussion Date/Time (DTM) S9.9.4.12

    con_13 : str | None
        CON.13 (opt) - Consent Decision Date/Time (DTM) S9.9.4.13

    con_14 : str | None
        CON.14 (opt) - Consent Effective Date/Time (DTM) S9.9.4.14

    con_15 : str | None
        CON.15 (opt) - Consent End Date/Time (DTM) S9.9.4.15
    ...
    con_18 : CWE | None
        CON.18 (opt) - Language Translated To (CWE) S9.9.4.18 | 0296 - Primary Language
    ...
    con_25 : list[str]
        CON.25 (req, rep) - Relationship to Subject (IS) S9.9.4.25 | 0548 - Signatory's Relationship to Subject
    """
