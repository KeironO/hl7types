...
class PMT(HL7Model):
    ...
    pmt_2: str = Field(
        ...
        description="R | Item #02019 | LEN:26",
    )
    ...
    pmt_3: str = Field(
        ...
        description="R | Item #02020 | LEN:26",
    )
    ...
    pmt_5: str = Field(
        ...
        description="R | Item #02022 | LEN:26",
    )
    ...
    pmt_9: Optional[str] = Field(
        ...
        description="O | Item #02026 | LEN:4",
    )
    ...
    pmt_12: Optional[str] = Field(
        ...
        title="ESR-Code-Line",
        description="O | Item #02029 | LEN:100",
    )
