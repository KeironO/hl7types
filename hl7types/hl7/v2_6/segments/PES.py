...
class PES(HL7Model):
    ...
    ----------
    pes_1 : list[XON] | None
        PES.1 (opt, rep) - Sender Organization Name (XON) S7.12.1.1

    pes_2 : list[XCN] | None
        PES.2 (opt, rep) - Sender Individual Name (XCN) S7.12.1.2

    pes_3 : list[XAD] | None
        PES.3 (opt, rep) - Sender Address (XAD) S7.12.1.3

    pes_4 : list[XTN] | None
        PES.4 (opt, rep) - Sender Telephone (XTN) S7.12.1.4

    pes_5 : EI | None
        PES.5 (opt) - Sender Event Identifier (EI) S7.12.1.5

    pes_6 : str | None
        PES.6 (opt) - Sender Sequence Number (NM) S7.12.1.6

    pes_7 : list[str] | None
        PES.7 (opt, rep) - Sender Event Description (FT) S7.12.1.7

    pes_8 : str | None
        PES.8 (opt) - Sender Comment (FT) S7.12.1.8

    pes_9 : str | None
        PES.9 (opt) - Sender Aware Date/Time (DTM) S7.12.1.9

    pes_10 : str
        PES.10 (req) - Event Report Date (DTM) S7.12.1.10

    pes_11 : list[str] | None
        PES.11 (opt, rep) - Event Report Timing/Type (ID) S7.12.1.11 | 0234 - Report timing

    pes_12 : str | None
        PES.12 (opt) - Event Report Source (ID) S7.12.1.12 | 0235 - Report source

    pes_13 : list[str] | None
        PES.13 (opt, rep) - Event Reported To (ID) S7.12.1.13 | 0236 - Event Reported To
    """
