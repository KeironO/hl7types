...
class ADJ(HL7Model):
    ...
    adj_4 : str
        ADJ.4 - Adjustment Category (IS) R S16.4.7.4 | 0564 - Adjustment Category Code

    adj_5 : CP | None
        ADJ.5 - Adjustment Amount (CP) O S16.4.7.5
    ...
    adj_11 : str | None
        ADJ.11 - Adjustment Action (IS) O S16.4.7.11 | 0569 - Adjustment Action
    ...
    adj_4: str = Field(
        ...
        description=(
            "R | Item #02006 | Table 0564 - Adjustment Category Code | LEN:4"
        ),
    )
    ...
    adj_8: Optional[str] = Field(
        ...
        description="O | Item #02010 | LEN:250",
    )
    ...
    adj_9: Optional[str] = Field(
        ...
        description="O | Item #02011 | LEN:250",
    )
    ...
    adj_10: Optional[str] = Field(
        ...
        description="O | Item #02012 | LEN:250",
    )
    ...
    adj_11: Optional[str] = Field(
        ...
        description="O | Item #02013 | Table 0569 - Adjustment Action | LEN:4",
    )
    ...
    adj_14: str = Field(
        ...
        description="R | Item #02016 | LEN:26",
    )
