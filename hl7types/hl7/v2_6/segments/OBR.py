...
class OBR(HL7Model):
    ...
    obr_5 : str | None
        OBR.5 (opt) - Priority (ID) S4.5.3.5

    obr_6 : str | None
        OBR.6 (opt) - Requested Date/Time (DTM) S4.5.3.6
    ...
    obr_14 : str | None
        OBR.14 (opt) - Specimen Received Date/Time (DTM) S7.4.3.18

    obr_15 : SPS | None
        OBR.15 (opt) - Specimen Source (SPS) S13.4.9.3
