...
class IVT(HL7Model):
    ...
    ivt_8 : CWE | None
        IVT.8 - Order Packaging (CWE) O S17.4.7.8
    ...
    ivt_3: Optional[str] = Field(
        ...
        description="O | Item #02277 | LEN:999",
    )
    ...
    ivt_5: Optional[str] = Field(
        ...
        description="O | Item #02278 | LEN:999",
    )
    ...
    ivt_22: Optional[str] = Field(
        ...
        description="O | Item #02081 | LEN:4",
    )
    ...
    ivt_23: Optional[str] = Field(
        ...
        description="O | Item #02082 | LEN:4",
    )
    ...
    ivt_24: Optional[str] = Field(
        ...
        description="O | Item #02083 | LEN:8",
    )
    ...
    ivt_25: Optional[str] = Field(
        ...
        description="O | Item #02084 | LEN:8",
    )
