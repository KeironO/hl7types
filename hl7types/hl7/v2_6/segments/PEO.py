...
class PEO(HL7Model):
    ...
    peo_3: str = Field(
        ...
        description="R | Item #01075 | LEN:24",
    )
    ...
    peo_4: Optional[str] = Field(
        ...
        description="O | Item #01076 | LEN:24",
    )
    ...
    peo_5: Optional[str] = Field(
        ...
        description="O | Item #01077 | LEN:24",
    )
    ...
    peo_6: Optional[str] = Field(
        ...
        description="O | Item #01078 | LEN:24",
    )
    ...
    peo_24: Optional[str] = Field(
        ...
        description="O | Item #01096 | LEN:24",
    )
