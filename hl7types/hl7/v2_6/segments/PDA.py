...
class PDA(HL7Model):
    """Patient Death and Autopsy (S3.4.12).

    Attributes
    ----------
    pda_1 : list[CWE] | None
        PDA.1 - Death Cause Code (CWE) O rep S3.4.12.1
    ...
    pda_4 : str | None
        PDA.4 - Death Certificate Signed Date/Time (DTM) O S3.4.12.4
    ...
    pda_4: Optional[str] = Field(
        ...
        description="O | Item #01577 | LEN:24",
    )
