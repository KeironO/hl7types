...
class RQD(HL7Model):
    ...
    rqd_7 : str | None
        RQD.7 - Cost Center Account Number (IS) O S17.4.6.2 | 0319 - Department Cost Center

    rqd_8 : str | None
        RQD.8 - Item Natural Account Code (IS) O S17.4.2.19 | 0320 - Item Natural Account Code
