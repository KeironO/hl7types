...
class RCP(HL7Model):
    ...
    ----------
    rcp_1 : str | None
        RCP.1 - Query Priority (ID) O S5.10.4.1.3 | 0091 - Query priority

    rcp_2 : CQ | None
        RCP.2 - Quantity Limited Request (CQ) O S5.10.4.1.7 | 0126 - Quantity limited request
    ...
    rcp_4: Optional[str] = Field(
        ...
        description="C | Item #01441 | LEN:24",
    )
