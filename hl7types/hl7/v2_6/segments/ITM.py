...
class ITM(HL7Model):
    ...
    itm_19 : str | None
        ITM.19 - Item Natural Account Code (IS) O S17.4.2.19 | 0320 - Item Natural Account Code
    ...
    itm_2: Optional[str] = Field(
        ...
        description="O | Item #02274 | LEN:999",
    )
    ...
    itm_8: Optional[str] = Field(
        ...
        description="O | Item #02275 | LEN:999",
    )
    ...
    itm_9: Optional[str] = Field(
        ...
        description="O | Item #02192 | LEN:20",
    )
    ...
    itm_20: Optional[str] = Field(
        ...
        description="O | Item #02203 | LEN:6",
    )
