...
class ARV(HL7Model):
    ...
    ----------
    arv_1 : str | None
        ARV.1 - Set ID (SI) O S3.4.13.1

    arv_2 : CNE
        ARV.2 - Access Restriction Action Code (CNE) R S3.4.13.2 | 0206 - Segment action code

    arv_3 : CWE
        ARV.3 - Access Restriction Value (CWE) R S3.4.13.3 | 0717 - Access Restriction Value

    arv_4 : list[CWE] | None
        ARV.4 - Access Restriction Reason (CWE) O rep S3.4.13.4 | 0719 - Access Restriction Reason Code

    arv_5 : list[str] | None
        ARV.5 - Special Access Restriction Instructions (ST) O rep S3.4.13.5

    arv_6 : DR | None
        ARV.6 - Access Restriction Date Range (DR) O S3.4.13.6
    """
    ...
    arv_5: Optional[List[str]] = Field(
        ...
        description="O | Item #02147 | LEN:250",
    )
