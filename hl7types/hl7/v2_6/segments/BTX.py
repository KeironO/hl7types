...
class BTX(HL7Model):
    ...
    ----------
    btx_1 : str
        BTX.1 - Set ID - BTX (SI) R S4.21.3.1

    btx_2 : EI | None
        BTX.2 - BC Donation ID (EI) C S4.21.3.2

    btx_3 : CNE | None
        BTX.3 - BC Component (CNE) C S4.21.3.3 | 9999 - no table for CE

    btx_4 : CNE | None
        BTX.4 - BC Blood Group (CNE) C S4.21.3.4 | 9999 - no table for CE
    ...
    btx_10 : CWE | None
        BTX.10 - BP Units (CWE) O S4.21.3.10 | 9999 - no table for CE
    ...
    btx_13 : str
        BTX.13 - BP Date/Time of Status (DTM) R S4.21.3.13

    btx_14 : XCN | None
        BTX.14 - BP Transfusion Administrator (XCN) O S4.21.3.14

    btx_15 : XCN | None
        BTX.15 - BP Transfusion Verifier (XCN) O S4.21.3.15

    btx_16 : str | None
        BTX.16 - BP Transfusion Start Date/Time of Status (DTM) O S4.21.3.16

    btx_17 : str | None
        BTX.17 - BP Transfusion End Date/Time of Status (DTM) O S4.21.3.17
    ...
    btx_13: str = Field(
        ...
        description="R | Item #01747 | LEN:24",
    )
    ...
    btx_16: Optional[str] = Field(
        ...
        description="O | Item #01750 | LEN:24",
    )
    ...
    btx_17: Optional[str] = Field(
        ...
        description="O | Item #01751 | LEN:24",
    )
