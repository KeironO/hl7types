...
class OBX(HL7Model):
    ...
    obx_6 : CWE | None
        OBX.6 (opt) - Units (CWE) S7.4.2.6 | 9999 - no table for CE

    obx_7 : str | None
        OBX.7 (opt) - References Range (ST) S7.4.2.7

    obx_8 : list[str] | None
        OBX.8 (opt, rep) - Abnormal Flags (IS) S7.4.2.8 | 0078 - Abnormal flags
    ...
    obx_18 : list[EI] | None
        OBX.18 (opt, rep) - Equipment Instance Identifier (EI) S7.4.2.18
    ...
    obx_22 : CNE | None
        OBX.22 (opt) - Mood Code (CNE) S7.4.2.22 | 0725 - Mood Codes
