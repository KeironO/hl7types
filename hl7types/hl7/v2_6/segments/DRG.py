...
class DRG(HL7Model):
    ...
    drg_4 : str | None
        DRG.4 - DRG Grouper Review Code (IS) O S6.5.3.4 | 0056 - DRG grouper review code
    ...
    drg_17 : str | None
        DRG.17 - Status Patient (IS) O S6.5.3.17 | 0739 - Status Patient
    ...
    drg_20 : str | None
        DRG.20 - Status Financial Calculation (IS) O S6.5.3.20 | 0742 - DRG Status Financial Calculation
    ...
    drg_26 : str | None
        DRG.26 - Status Gender (IS) O S6.5.3.26 | 0749 - DRG Grouping Status

    drg_27 : str | None
        DRG.27 - Status Age (IS) O S6.5.3.27 | 0749 - DRG Grouping Status

    drg_28 : str | None
        DRG.28 - Status Length of Stay (IS) O S6.5.3.28 | 0749 - DRG Grouping Status

    drg_29 : str | None
        DRG.29 - Status Same Day Flag (IS) O S6.5.3.29 | 0749 - DRG Grouping Status

    drg_30 : str | None
        DRG.30 - Status Separation Mode (IS) O S6.5.3.30 | 0749 - DRG Grouping Status

    drg_31 : str | None
        DRG.31 - Status Weight at Birth (IS) O S6.5.3.31 | 0755 - Status Weight At Birth

    drg_32 : str | None
        DRG.32 - Status Respiration Minutes (IS) O S6.5.3.32 | 0757 - Status Respiration Minutes

    drg_33 : str | None
        DRG.33 - Status Admission (IS) O S6.5.3.33 | 0759 - Status Admission
    """
    ...
    drg_2: Optional[str] = Field(
        ...
        description="O | Item #00769 | LEN:24",
    )
    ...
    drg_15: Optional[str] = Field(
        ...
        description="O | Item #02159 | LEN:5",
    )
    ...
    drg_17: Optional[str] = Field(
        ...
        description="O | Item #02161 | Table 0739 - Status Patient | LEN:20",
    )
    ...
    drg_18: Optional[str] = Field(
        ...
        description="O | Item #02162 | LEN:100",
    )
    ...
    drg_19: Optional[str] = Field(
        ...
        description="O | Item #02282 | LEN:100",
    )

    drg_20: Optional[str] = Field(
        default=None,
        validation_alias=AliasChoices(
            "drg_20",
    ...
    drg_25: Optional[str] = Field(
        ...
        description="O | Item #02168 | LEN:5",
    )

    drg_26: Optional[str] = Field(
        default=None,
        validation_alias=AliasChoices(
            "drg_26",
            "status_gender",
        ...
        title="Status Gender",
        description=(
            "O | Item #02169 | Table 0749 - DRG Grouping Status | LEN:20"
        ),
    )

    drg_27: Optional[str] = Field(
        default=None,
        validation_alias=AliasChoices(
            "drg_27",
            "status_age",
        ...
        title="Status Age",
        description=(
            "O | Item #02170 | Table 0749 - DRG Grouping Status | LEN:20"
        ),
    )

    drg_28: Optional[str] = Field(
        default=None,
        validation_alias=AliasChoices(
            "drg_28",
        ...
        description=(
            "O | Item #02171 | Table 0749 - DRG Grouping Status | LEN:20"
        ),
    )

    drg_29: Optional[str] = Field(
        default=None,
        validation_alias=AliasChoices(
            "drg_29",
        ...
        description=(
            "O | Item #02172 | Table 0749 - DRG Grouping Status | LEN:20"
        ),
    )

    drg_30: Optional[str] = Field(
        default=None,
        validation_alias=AliasChoices(
            "drg_30",
        ...
        description=(
            "O | Item #02173 | Table 0749 - DRG Grouping Status | LEN:20"
        ),
    )

    drg_31: Optional[str] = Field(
        default=None,
        validation_alias=AliasChoices(
            "drg_31",
        ...
        description=(
            "O | Item #02174 | Table 0755 - Status Weight At Birth | LEN:20"
        ),
    )

    drg_32: Optional[str] = Field(
        default=None,
        validation_alias=AliasChoices(
            "drg_32",
        ...
        description=(
            "O | Item #02175 | Table 0757 - Status Respiration Minutes | LEN:20"
        ),
    )

    drg_33: Optional[str] = Field(
        default=None,
        validation_alias=AliasChoices(
            "drg_33",
            "status_admission",
        ...
        description="O | Item #02176 | Table 0759 - Status Admission | LEN:20",
    )
