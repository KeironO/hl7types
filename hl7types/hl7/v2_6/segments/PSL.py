...
class PSL(HL7Model):
    ...
    psl_17 : list[str] | None
        PSL.17 - Product/Service Clarification Code Type (IS) O rep S16.4.6.17 | 0561 - Product/Services Clarification Codes
    ...
    psl_20 : list[str] | None
        PSL.20 - Processing Consideration Code (IS) O rep S16.4.6.20 | 0562 - Processing Consideration Codes
    ...
    psl_9: Optional[str] = Field(
        ...
        description="O | Item #01963 | LEN:80",
    )
    ...
    psl_10: Optional[str] = Field(
        ...
        description="C | Item #01964 | LEN:24",
    )
    ...
    psl_11: Optional[str] = Field(
        ...
        description="O | Item #01965 | LEN:24",
    )
    ...
    psl_14: Optional[str] = Field(
        ...
        description="C | Item #01968 | LEN:10",
    )
    ...
    psl_18: Optional[List[str]] = Field(
        ...
        description="O | Item #01972 | LEN:40",
    )
    ...
    psl_21: str = Field(
        ...
        description=(
            "R | Item #01975 | Table 0532 - Expanded yes/no indicator | LEN:2"
        ),
    )
    ...
    psl_24: Optional[str] = Field(
        ...
        description="O | Item #01978 | LEN:5",
    )
    ...
    psl_27: Optional[str] = Field(
        ...
        description="O | Item #01981 | LEN:5",
    )
    ...
    psl_34: Optional[str] = Field(
        ...
        description="O | Item #01988 | LEN:6",
    )
    ...
    psl_36: Optional[str] = Field(
        ...
        description="O | Item #01990 | LEN:4",
    )
    ...
    psl_37: Optional[str] = Field(
        ...
        description="O | Item #01991 | LEN:4",
    )
    ...
    psl_39: Optional[str] = Field(
        ...
        description="O | Item #01993 | LEN:6",
    )
    ...
    psl_41: Optional[str] = Field(
        ...
        description="O | Item #01995 | LEN:4",
    )
    ...
    psl_42: Optional[str] = Field(
        ...
        description="O | Item #01996 | LEN:4",
    )
    ...
    psl_45: Optional[str] = Field(
        ...
        title="VAT-Rate",
        description="O | Item #01999 | LEN:3",
    )
    ...
    psl_48: Optional[str] = Field(
        ...
        title="Comment",
        description="O | Item #02002 | LEN:255",
    )
