...
class RF1(HL7Model):
    ...
    ----------
    rf1_1 : CWE | None
        RF1.1 - Referral Status (CWE) O S11.6.1.1 | 0283 - Referral status

    rf1_2 : CWE | None
        RF1.2 - Referral Priority (CWE) O S11.6.1.2 | 0280 - Referral priority

    rf1_3 : CWE | None
        RF1.3 - Referral Type (CWE) O S11.6.1.3 | 0281 - Referral type

    rf1_4 : list[CWE] | None
        RF1.4 - Referral Disposition (CWE) O rep S11.6.1.4 | 0282 - Referral disposition

    rf1_5 : CWE | None
        RF1.5 - Referral Category (CWE) O S11.6.1.5 | 0284 - Referral category

    rf1_6 : EI
        RF1.6 - Originating Referral Identifier (EI) R S11.6.1.6

    rf1_7 : str | None
        RF1.7 - Effective Date (DTM) O S11.6.1.7

    rf1_8 : str | None
        RF1.8 - Expiration Date (DTM) O S11.6.1.8

    rf1_9 : str | None
        RF1.9 - Process Date (DTM) O S11.6.1.9

    rf1_10 : list[CWE] | None
        RF1.10 - Referral Reason (CWE) O rep S11.6.1.10 | 0336 - Referral reason

    rf1_11 : list[EI] | None
        RF1.11 - External Referral Identifier (EI) O rep S11.6.1.11

    rf1_12 : CWE | None
        RF1.12 - Referral Documentation Completion Status (CWE) O S11.6.1.12 | 0865 - Referral Documentation Completion Status
    """
    ...
    rf1_7: Optional[str] = Field(
        ...
        description="O | Item #01143 | LEN:24",
    )
    ...
    rf1_8: Optional[str] = Field(
        ...
        description="O | Item #01144 | LEN:24",
    )
