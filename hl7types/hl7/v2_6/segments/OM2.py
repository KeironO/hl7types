...
class OM2(BaseModel):
    ...
    om2_6: list[RFR] | None = Field(
        ...
        title=("Reference (Normal) Range for Ordinal and Continuous Observations"),
        description="Item #631",
    )

    om2_7: list[RFR] | None = Field(
        default=None,
        validation_alias=AliasChoices(
            "om2_7",
