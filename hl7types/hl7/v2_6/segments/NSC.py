...
class NSC(HL7Model):
    ...
    ----------
    nsc_1 : str
        NSC.1 - Application Change Type (IS) R S14.4.2.1 | 0409 - Application change type
    ...
    nsc_4 : HD | None
        NSC.4 - Current Application (HD) O S14.4.2.4

    nsc_5 : HD | None
        NSC.5 - Current Facility (HD) O S14.4.2.5
    ...
    nsc_8 : HD | None
        NSC.8 - New Application (HD) O S14.4.2.8

    nsc_9 : HD | None
        NSC.9 - New Facility (HD) O S14.4.2.9
    """
    ...
    nsc_1: str = Field(
        ...
        description=(
            "R | Item #01188 | Table 0409 - Application change type | LEN:4"
        ),
    )
    ...
    nsc_2: Optional[str] = Field(
        ...
        title="Current CPU",
        description="O | Item #01189 | LEN:30",
    )
    ...
    nsc_3: Optional[str] = Field(
        ...
        description="O | Item #01190 | LEN:30",
    )
    ...
    nsc_6: Optional[str] = Field(
        ...
        title="New CPU",
        description="O | Item #01193 | LEN:30",
    )
    ...
    nsc_7: Optional[str] = Field(
        ...
        description="O | Item #01194 | LEN:30",
    )
