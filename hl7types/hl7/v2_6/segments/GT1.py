...
class GT1(HL7Model):
    ...
    gt1_33 : str | None
        GT1.33 (opt) - Living Dependency (IS) S3.4.10.1 | 0223 - Living Dependency

    gt1_34 : list[str] | None
        GT1.34 (opt, rep) - Ambulatory Status (IS) S3.4.3.15 | 0009 - Ambulatory Status

    gt1_35 : list[CWE] | None
        GT1.35 (opt, rep) - Citizenship (CWE) S15.4.8.30 | 0171 - Citizenship

    gt1_36 : CWE | None
        GT1.36 (opt) - Primary Language (CWE) S3.4.2.15 | 0296 - Primary Language

    gt1_37 : str | None
        GT1.37 (opt) - Living Arrangement (IS) S3.4.10.2 | 0220 - Living Arrangement

    gt1_38 : CWE | None
        GT1.38 (opt) - Publicity Code (CWE) S3.4.10.11 | 0215 - Publicity Code

    gt1_39 : str | None
        GT1.39 (opt) - Protection Indicator (ID) S3.4.10.12 | 0136 - Yes/no indicator

    gt1_40 : str | None
        GT1.40 (opt) - Student Indicator (IS) S3.4.10.5 | 0231 - Student Status

    gt1_41 : CWE | None
        GT1.41 (opt) - Religion (CWE) S3.4.2.17 | 0006 - Religion

    gt1_42 : list[XPN] | None
        GT1.42 (opt, rep) - Mother's Maiden Name (XPN) S3.4.2.6

    gt1_43 : CWE | None
        GT1.43 (opt) - Nationality (CWE) S3.4.2.28 | 0212 - Nationality
    ...
    gt1_50 : JCC | None
        GT1.50 (opt) - Job Code/Class (JCC) S15.4.8.19

    gt1_51 : list[XON] | None
        GT1.51 (opt, rep) - Guarantor Employer's Organization Name (XON) S6.5.5.51

    gt1_52 : str | None
        GT1.52 (opt) - Handicap (IS) S3.4.10.6 | 0295 - Handicap

    gt1_53 : str | None
        GT1.53 (opt) - Job Status (IS) S3.4.5.34 | 0311 - Job Status
    ...
    gt1_57 : str | None
        GT1.57 (opt) - VIP Indicator (IS) S3.4.3.16 | 0099 - VIP Indicator
    """
