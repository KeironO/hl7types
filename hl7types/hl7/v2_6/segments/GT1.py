...
class GT1(HL7Model):
    ...
    gt1_33 : str | None
        GT1.33 - Living Dependency (IS) O S3.4.10.1 | 0223 - Living Dependency
    ...
    gt1_36 : CWE | None
        GT1.36 - Primary Language (CWE) O S3.4.2.15 | 0296 - Primary Language

    gt1_37 : str | None
        GT1.37 - Living Arrangement (IS) O S3.4.10.2 | 0220 - Living Arrangement

    gt1_38 : CWE | None
        GT1.38 - Publicity Code (CWE) O S3.4.10.11 | 0215 - Publicity Code

    gt1_39 : str | None
        GT1.39 - Protection Indicator (ID) O S3.4.10.12 | 0136 - Yes/no indicator

    gt1_40 : str | None
        GT1.40 - Student Indicator (IS) O S3.4.10.5 | 0231 - Student Status

    gt1_41 : CWE | None
        GT1.41 - Religion (CWE) O S3.4.2.17 | 0006 - Religion

    gt1_42 : list[XPN] | None
        GT1.42 - Mother's Maiden Name (XPN) O rep S3.4.2.6

    gt1_43 : CWE | None
        GT1.43 - Nationality (CWE) O S3.4.2.28 | 0212 - Nationality
    ...
    gt1_8: Optional[str] = Field(
        ...
        description="O | Item #00412 | LEN:24",
    )
    ...
    gt1_24: Optional[str] = Field(
        ...
        description="O | Item #00775 | LEN:24",
    )
