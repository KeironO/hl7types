...
_all_ = {
    ...
    'EIP', 'ELD', 'ERL', 'FC', 'FN', 'HD', 'ICD', 'JCC', 'LA1', 'LA2', 'MA',
    'MO', 'MOC', 'MOP', 'MSG', 'NA', 'NDL', 'NR', 'OCD', 'OSD', 'OSP', 'PIP',
    'PL', 'PLN', 'PPN', 'PRL', 'PT', 'PTA', 'QIP', 'QSC', 'RCD', 'RFR', 'RI',
    'RMC', 'RP', 'RPT', 'SAD', 'SCV', 'SN', 'SPD', 'SPS', 'SRT', 'TQ', 'UVC',
    'VH', 'VID', 'VR', 'WVI', 'WVS', 'XAD', 'XCN', 'XON', 'XPN', 'XTN',
    'varies'
}  # type: ignore
