...
from ..groups.ADT_A31_INSURANCE import ADT_A31_INSURANCE

_ACC = ACC
_ADT_A31_INSURANCE = ADT_A31_INSURANCE
_AL1 = AL1
_DG1 = DG1
_EVN = EVN
_GT1 = GT1
...
class ADT_A31(BaseModel):
    ...
    Attributes:
        ...
        INSURANCE (Optional[List[ADT_A31_INSURANCE]]): optional
    ...
    INSURANCE: Optional[List[_ADT_A31_INSURANCE]] = Field(
        default=None,
        title="INSURANCE",
        description="Optional, repeating",
    )
